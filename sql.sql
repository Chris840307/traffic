...
6=select count(billno) as result from billbase where (RecordDate >to_date('2008/01/01', 'yyyy/mm/dd') and RecordDate< to_date('2008/12/31', 'yyyy/mm/dd')) and recordstateid <> -1
