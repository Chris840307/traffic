<%@ Page Language="VB" AutoEventWireup="false" CodeFile="getRewardList_Should_Unit_Set.aspx.vb"  Inherits="ScoreList_getRewardList_Should_Unit_Set" %>
            ...
            <table style="width: 300px" border="1" >
                ...
                <tr>
                    <td align="center" style="height: 35px">
                        <input name="tbDate1" type="text" MaxLength="3" onkeyup="value=value.replace(/[^\d]/g,'')" style="width: 70px" />
                        年 &nbsp;<input name="tbDate2" type="text" MaxLength="2" onkeyup="value=value.replace(/[^\d]/g,'')" style="width: 70px" />月</td>
                </tr>
                <tr style="background-color:#FFCC33">
                    <td style="height: 25px" align="center">
                        統計單位</td>
...
<script language="JavaScript">
	...
	function OpenRewardList(){
	    ...
	    if (error==0){
	        ...
	        window.open("getRewardList_Unit.aspx?AnalyzeMoney="+AnalyzeMoney+"&Date1="+Date1+"&Date2="+Date2+"&sUnitID="+sUnitID+"&AnalyzeType="+AnalyzeType,"getRewardList_Unit2","width=800,height=600,left=0,top=0,scrollbars=yes,menubar=yes,resizable=yes,fullscreen=no,status=no,toolbar=no");
	        window.close();
	    }else{
	        alert(errorString);
	    }	
	...
	function OpenRewardList_Excel(){
	    ...
	    if (form1.tbDate1.value==""){
	        error=error+1;
		    errorString=errorString+"\n"+error+"：統計年份未輸入!!";
	    }
	    if (CheckFlag2<1 || CheckFlag2>12){
	        error=error+1;
		    errorString=errorString+"\n"+error+"：統計月份輸入錯誤!!";
	    }
	    ...
	    if (error==0){
	        ...
	        var AnalyzeType=form1.AnalyzeType.value;
	        window.open("getRewardList_Unit_Excel.aspx?AnalyzeMoney="+AnalyzeMoney+"&Date1="+Date1+"&Date2="+Date2+"&sUnitID="+sUnitID+"&AnalyzeType="+AnalyzeType,"getRewardList_Unit_Excel2","width=800,height=600,left=0,top=0,scrollbars=yes,menubar=yes,resizable=yes,fullscreen=no,status=no,toolbar=no");
	        window.close();
	    }else{
	        alert(errorString);
	    }	    
...
var error=0;
	    ...
	    if (error==0){
	        ...
	        var sUnitID=UnitName;
	        var AnalyzeType=form1.AnalyzeType.value;
	        window.open("getRewardList_Balance_Director_Excel.aspx?AnalyzeMoney="+AnalyzeMoney+"&Date1="+Date1+"&Date2="+Date2+"&sUnitID="+sUnitID+"&AnalyzeType="+AnalyzeType,"getRewardList_Unit_Excel2","width=800,height=600,left=0,top=0,scrollbars=yes,menubar=yes,resizable=yes,fullscreen=no,status=no,toolbar=no");
	        //window.close();
	    }else{
	        alert(errorString);
	    }	    
...
var error=0;
	    ...
	    if (error==0){
	        ...
	        var sUnitID=UnitName;
	        var AnalyzeType=form1.AnalyzeType.value;
	        window.open("getRewardList_Balance_Common_Excel.aspx?AnalyzeMoney="+AnalyzeMoney+"&Date1="+Date1+"&Date2="+Date2+"&sUnitID="+sUnitID+"&AnalyzeType="+AnalyzeType,"getRewardList_Unit_Excel2","width=800,height=600,left=0,top=0,scrollbars=yes,menubar=yes,resizable=yes,fullscreen=no,status=no,toolbar=no");
	        //window.close();
	    }else{
	        alert(errorString);
	    }	    
...
var error=0;
	    ...
	    if (error==0){
	        ...
	        window.open("getRewardList_Balance_Item_Excel.aspx?AnalyzeMoney="+AnalyzeMoney+"&Date1="+Date1+"&Date2="+Date2+"&sUnitID="+sUnitID+"&AnalyzeType="+AnalyzeType,"getRewardList_Unit_Excel2","width=800,height=600,left=0,top=0,scrollbars=yes,menubar=yes,resizable=yes,fullscreen=no,status=no,toolbar=no");
	        //window.close();
	    }else{
	        alert(errorString);
	    }	    
