...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim fname = Year(Now) & fMnoth & fDay & "_共同人員結餘.xls"
...
<body>
    ...
    <table width="680" border="0" cellpadding="6" cellspacing="0" align="center">
        <td align="center" colspan="6"><%=Request("Date1")%>年<%=Request("Date2")%>月  共同人員結餘款</td>
    </table>
	...
	<td style="width: 20%" align="right">結餘</td>
	    ...
	    dim TheAnaDate1 as String=""
            ...
            SHOULDGETMONEY = 0
            REALGETMONEY = 0
            Dim strUnit = "Select UNITID,LOGINID,CHNAME,SHOULDGETMONEY,REALGETMONEY from REWARDMONTHDATA where UNITID IN (" & request("sUnitID") & ") AND DIRECTORTOGETHER='0' AND SHOULDGETMONEY-REALGETMONEY>0 AND YEARMONTH between TO_DATE('" & TheAnaDate1 & " 0:0:0','YYYY/MM/DD/HH24/MI/SS') and TO_DATE('" & TheAnaDate2 & " 23:59:59','YYYY/MM/DD/HH24/MI/SS')"
