...
<script language="JavaScript">
	...
	function OpenRewardList_Excel(){
	    ...
	    if (error==0){
            ...
            window.open("../CommonPercent/getRewardList_Total.aspx?AnalyzeMoney="+AnalyzeMoney+"&Year1="+Year1+"&Month1="+Month1+"&DateType="+DateType+"&sCountyOrNpa="+sCountyOrNpa,"getRewardList_Totala","width=800,height=600,left=10,top=10,scrollbars=yes,menubar=yes,resizable=yes,fullscreen=no,status=no,toolbar=no");
	        //window.close();
	    }else{
	        alert(errorString);
	    }	
