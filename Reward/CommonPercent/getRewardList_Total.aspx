...
<%
    ...
    If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
        ...
        strPointT6 = strPointT6 & " and a." & theDateType & " between TO_DATE('" & TheAnaDate1 & " 0:0:0','YYYY/MM/DD/HH24/MI/SS')"
        strPointT6 = strPointT6 & " and TO_DATE('" & TheAnaDate2 & " 23:59:59','YYYY/MM/DD/HH24/MI/SS')" & strPointT6Plus
    ...
    End If
    'Response.Write(getPointTotal)
    
    '產生報表----------------------------------------------------------------    
    Response.Write("<table width=""1035"" border=""1"" cellpadding=""3"" cellspacing=""0"">")
    Response.Write("<tr>")
    Response.Write("<td style=""height:30px"" align=""center"" colspan=""8""><span class=""style4"">")
    Response.Write(getTUnit & "各單位" & Trim(Request("Year1")) & "年" & Trim(Request("Month1")) & "月份處理道路交通安全人員獎勵金發放一覽表")
    Response.Write("</span></td>")
    Response.Write("</tr>")
    Response.Write("<tr>")
    Response.Write("<td style=""width: 200px; height:70px"" ALIGN=""center""></td>")
    Response.Write("<td style=""width: 105px"" ALIGN=""center""><span class=""style2"">" & Trim(Request("Year1")) & "年" & Trim(Request("Month1")) & "月份舉發違規配分點數</span></td>")
    Response.Write("<td style=""width: 105px"" ALIGN=""center""><span class=""style2"">" & Trim(Request("Year1")) & "年" & Trim(Request("Month1")) & "月份獎勵金</span><span class=""style3"">應領</span><span class=""style2"">總計金額</span></td>")
    Response.Write("<td style=""width: 105px"" ALIGN=""center""><span class=""style2"">直接執行人員72%合計金額</span></td>")
    Response.Write("<td style=""width: 105px"" ALIGN=""center""><span class=""style2"">共同作業人員28%合計金額</span></td>")
    Response.Write("<td style=""width: 105px"" ALIGN=""center""><span class=""style2"">" & Trim(Request("Year1")) & "年" & Trim(Request("Month1")) & "月份獎勵金</span><span class=""style3"">實領</span><span class=""style2"">金額</span></td>")
    Response.Write("<td style=""width: 105px"" ALIGN=""center""><span class=""style2"">" & Trim(Request("Year1")) & "年" & Trim(Request("Month1")) & "月份獎勵金</span><span class=""style3"">結餘</span><span class=""style2"">金額</span></td>")
    Response.Write("<td style=""width: 205px"" ALIGN=""center""><span class=""style2"">備考</span></td>")
    Response.Write("</tr>")
    '局本部
    Response.Write("<tr>")
    Response.Write("<td style=""height:30px""><span class=""style1"">局本部</span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1"">")
    Response.Write(Format(Decimal.Round(getMoneyTotal * 0.28 * ShareGroup1), "##,##0"))
    Response.Write("</span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1"">")
    Response.Write(Format(Decimal.Round(getMoneyTotal * 0.28 * ShareGroup1), "##,##0"))
    ...
    Dim UnitReward, UnitScore As Decimal
    ...
    If rdUnit.HasRows Then
        While rdUnit.Read()
            ...
            If rdPer.HasRows Then
                While rdPer.Read()
                    ...
                    If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
                        ...
                        strPoint6 = strPoint6 & " and a." & theDateType & " between TO_DATE('" & TheAnaDate1 & " 0:0:0','YYYY/MM/DD/HH24/MI/SS')"
                        strPoint6 = strPoint6 & " and TO_DATE('" & TheAnaDate2 & " 23:59:59','YYYY/MM/DD/HH24/MI/SS')" & strPointT6Plus
                    ...
                    End If
                    'A1點數
                    Dim strPoint3 As String = "select b.A1Score,b.BillType1Score,a.BillMemID1,a.BillMemID2,a.BillMemID3,a.BillMemID4 from BILLBASEVIEWReward a"
                    ...
                    'A2點數
                    Dim strPoint4 As String = "select b.A2Score,b.BillType1Score,a.BillMemID1,a.BillMemID2,a.BillMemID3,a.BillMemID4 from BILLBASEVIEWReward a"
                    ...
                    'A3點數
                    Dim strPoint5 As String = "select b.A3Score,b.BillType1Score,a.BillMemID1,a.BillMemID2,a.BillMemID3,a.BillMemID4 from BILLBASEVIEWReward a"
            ...
            UnitMoney = Decimal.Truncate((UnitScore * PointMoney) - (UnitScore * PointMoney * 0.28 * ShareGroup1))
            AllMoneyTotal = AllMoneyTotal + UnitMoney
            Money72Total = Money72Total + Decimal.Round(Decimal.Truncate(UnitScore * PointMoney) * 0.72)
            Money28Total = Money28Total + Decimal.Round(Decimal.Truncate(UnitScore * PointMoney) * 0.28 * (1 - ShareGroup1))
            Response.Write("<td><span class=""style1"">" & Format(UnitMoney, "##,##0") & "</span></td>")
            Response.Write("<td><span class=""style1"">" & Format(Decimal.Round(Decimal.Truncate(UnitScore * PointMoney) * 0.72), "##,##0") & "</span></td>")
            Response.Write("<td><span class=""style1"">" & Format(Decimal.Round(Decimal.Truncate(UnitScore * PointMoney) * 0.28 * (1 - ShareGroup1)), "##,##0") & "</span></td>")
            Response.Write("<td><span class=""style1""></span></td>")
            Response.Write("<td><span class=""style1""></span></td>")
            Response.Write("<td><span class=""style1""></span></td>")
            Response.Write("</tr>")
    ...
    If rdSubUnit.HasRows Then
        While rdSubUnit.Read()
                    ...
                    If rdPer1.HasRows Then
                        While rdPer1.Read()
                            ...
                            If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
                                ...
                                '拖吊點數
                                Dim strPoint6 As String = "select b.other1,a.BillMemID1,a.BillMemID2,a.BillMemID3,a.BillMemID4 from BILLBASEVIEWReward a"
                                ...
                                strPoint6 = strPoint6 & " and a.CarAddID=8 and a.RecordStateID=0 and (a.TrafficAccidentType is null or a.TrafficAccidentType='')"
                                strPoint6 = strPoint6 & " and a." & theDateType & " between TO_DATE('" & TheAnaDate1 & " 0:0:0','YYYY/MM/DD/HH24/MI/SS')"
                                strPoint6 = strPoint6 & " and TO_DATE('" & TheAnaDate2 & " 23:59:59','YYYY/MM/DD/HH24/MI/SS')"
                                Dim CmdPoint6 As New Data.OracleClient.OracleCommand(strPoint6, conn)
                                Dim rdPoint6 As Data.OracleClient.OracleDataReader = CmdPoint6.ExecuteReader()
                                If rdPoint6.HasRows Then
                                    While rdPoint6.Read()
            ...
            UnitMoney = Decimal.Truncate((SubUnitScore * PointMoney) - (SubUnitScore * PointMoney * 0.28 * ShareGroup1))
            AllMoneyTotal = AllMoneyTotal + UnitMoney
            Money72Total = Money72Total + Decimal.Round(Decimal.Truncate(SubUnitScore * PointMoney) * 0.72)
            Money28Total = Money28Total + Decimal.Round(Decimal.Truncate(SubUnitScore * PointMoney) * 0.28 * (1 - ShareGroup1))
            Response.Write("<td><span class=""style1"">" & Format(UnitMoney, "##,##0") & "</span></td>")
            Response.Write("<td><span class=""style1"">" & Format(Decimal.Round(Decimal.Truncate(SubUnitScore * PointMoney) * 0.72), "##,##0") & "</span></td>")
            Response.Write("<td><span class=""style1"">" & Format(Decimal.Round(Decimal.Truncate(SubUnitScore * PointMoney) * 0.28 * (1 - ShareGroup1)), "##,##0") & "</span></td>")
            Response.Write("<td><span class=""style1""></span></td>")
            Response.Write("<td><span class=""style1""></span></td>")
            Response.Write("<td><span class=""style1""></span></td>")
            Response.Write("</tr>")
    ...
    '各分局總點數
    Response.Write("<tr>")
    Response.Write("<td style=""height:30px""><span class=""style2"">各分局總點數</span></td>")
    Response.Write("<td><span class=""style1"">" & SubUnitScoreTotal & "</span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    ...
    '全警局局總點數(+交通、保安隊)
    Response.Write("<tr>")
    Response.Write("<td style=""height:30px""><span class=""style2"">全警察局總點數</span></td>")
    ...
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1"">" & AllMoneyTotal & "</span></td>")
    Response.Write("<td><span class=""style1"">" & Money72Total & "</span></td>")
    Response.Write("<td><span class=""style1"">" & Money28Total & "</span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("<td><span class=""style1""></span></td>")
    Response.Write("</tr>")
