...
<body>
    <form id="form1" runat="server">
        <%
            ...
            Dim strPointT6Plus As String = ""
            Dim strPointT6Plus2 As String = ""
            ...
            Dim PersonMoney, PersonPay, BillCnt, BillCntTotal, AllCnt, AllPoint, AllMoneyTotal As Decimal
            Dim PersonTotal As Integer = 0
            Dim MaxMoney As Integer = 0
            Dim MinMoney As Integer = 999999
            Dim A1ScoreTmp, A2ScoreTmp, A3ScoreTmp As Decimal
            Dim OverFlag, MemIDList, strInsert, strMemID1, strCreditID, strDel As String
            ...
            If Trim(Request("sMemID")) = "" Then
                ...
                If rdU.HasRows Then
                    While rdU.Read()
                        ...
                        Response.Write("<td align=""center"" colspan=""5""><span class=""style1""><strong>")
                        '統計單位
                        ...
                        Response.Write("<td style=""width: 20%"">姓名</td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">舉發件數</td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">點數</td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">金額</td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">核章</td>")
                        Response.Write("</tr></table><hr size=""3"" />")
                        Response.Write("<table width=""680"" border=""0"" cellpadding=""3"" cellspacing=""0"" align=""center"">")
        
                        Dim strUnitPerson As String
                        If sys_City = "雲林縣" Or sys_City = "宜蘭縣" Or sys_City = "嘉義縣" Then
                            strUnitPerson = "select distinct(LoginID) from MemberData where UnitID='" & Trim(rdU("UnitID")) & "' order by LoginId"
                        Else
                            strUnitPerson = "select MemberID,LoginID,CHName,Money from MemberData where UnitID='" & Trim(rdU("UnitID")) & "' order by LoginId"
                        End If
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
                                    ...
                                    strPoint1 = strPoint1 & " where (a.BillMemID1 in (" & MemIDList & ") or a.BillMemID2 In (" & MemIDList & ") or a.BillMemID3 In (" & MemIDList & ") or a.BillMemID4 In (" & MemIDList & "))"
                                        ...
                                        While rdPoint1.Read()
                                            ...
                                            Else
                                                ...
                                                ElseIf rdPoint1("BillMemID1") IsNot DBNull.Value And rdPoint1("BillMemID2") IsNot DBNull.Value And rdPoint1("BillMemID3") Is DBNull.Value And rdPoint1("BillMemID4") Is DBNull.Value Then
                                                    If InStr(MemIDList, Trim(rdPoint1("BillMemID1"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint1("BillType1Score") / 2)
                                                        BillCnt = BillCnt + 0.5
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint1("BillMemID2"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint1("BillType1Score") / 2)
                                                        BillCnt = BillCnt + 0.5
                                                    End If
                                                ElseIf rdPoint1("BillMemID1") IsNot DBNull.Value And rdPoint1("BillMemID2") IsNot DBNull.Value And rdPoint1("BillMemID3") IsNot DBNull.Value And rdPoint1("BillMemID4") Is DBNull.Value Then
                                                    ...
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint1("BillMemID3"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint1("BillType1Score") * 0.33)
                                                        BillCnt = BillCnt + 0.33
                                                    End If
                                                ElseIf rdPoint1("BillMemID1") IsNot DBNull.Value And rdPoint1("BillMemID2") IsNot DBNull.Value And rdPoint1("BillMemID3") IsNot DBNull.Value And rdPoint1("BillMemID4") IsNot DBNull.Value Then
                                                    ...
                                                    If InStr(MemIDList, Trim(rdPoint1("BillMemID3"))) > 0 Then
                                                        ...
                                                        BillCnt = BillCnt + 0.25
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint1("BillMemID4"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint1("BillType1Score") / 4)
                                                        BillCnt = BillCnt + 0.25
                                                    End If
                                                End If
                                    ...
                                    strPoint2 = strPoint2 & " where (a.BillMemID1 in (" & MemIDList & ") or a.BillMemID2 in (" & MemIDList & ") or a.BillMemID3 in (" & MemIDList & ") or a.BillMemID4 in (" & MemIDList & "))"
                                        ...
                                        While rdPoint2.Read()
                                            ...
                                            Else
                                                ...
                                                ElseIf rdPoint2("BillMemID1") IsNot DBNull.Value And rdPoint2("BillMemID2") IsNot DBNull.Value And rdPoint2("BillMemID3") Is DBNull.Value And rdPoint2("BillMemID4") Is DBNull.Value Then
                                                    If InStr(MemIDList, Trim(rdPoint2("BillMemID1"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint2("BillType2Score") / 2)
                                                        BillCnt = BillCnt + 0.5
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint2("BillMemID2"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint2("BillType2Score") / 2)
                                                        BillCnt = BillCnt + 0.5
                                                    End If
                                                ElseIf rdPoint2("BillMemID1") IsNot DBNull.Value And rdPoint2("BillMemID2") IsNot DBNull.Value And rdPoint2("BillMemID3") IsNot DBNull.Value And rdPoint2("BillMemID4") Is DBNull.Value Then
                                                    ...
                                                    If InStr(MemIDList, Trim(rdPoint2("BillMemID2"))) > 0 Then
                                                        ...
                                                        BillCnt = BillCnt + 0.33
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint2("BillMemID3"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint2("BillType2Score") * 0.33)
                                                        BillCnt = BillCnt + 0.33
                                                    End If
                                                ElseIf rdPoint2("BillMemID1") IsNot DBNull.Value And rdPoint2("BillMemID2") IsNot DBNull.Value And rdPoint2("BillMemID3") IsNot DBNull.Value And rdPoint2("BillMemID4") IsNot DBNull.Value Then
                                                    ...
                                                    If InStr(MemIDList, Trim(rdPoint2("BillMemID3"))) > 0 Then
                                                        ...
                                                        BillCnt = BillCnt + 0.25
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint2("BillMemID4"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint2("BillType2Score") / 4)
                                                        BillCnt = BillCnt + 0.25
                                                    End If
                                                End If
                                    ...
                                    strPoint6 = strPoint6 & " where (a.BillMemID1 in (" & MemIDList & ") or a.BillMemID2 in (" & MemIDList & ") or a.BillMemID3 in (" & MemIDList & ") or a.BillMemID4 in (" & MemIDList & "))"
                                        ...
                                        While rdPoint6.Read()
                                            ...
                                            Else
                                                ...
                                                ElseIf rdPoint6("BillMemID1") IsNot DBNull.Value And rdPoint6("BillMemID2") IsNot DBNull.Value And rdPoint6("BillMemID3") Is DBNull.Value And rdPoint6("BillMemID4") Is DBNull.Value Then
                                                    If InStr(MemIDList, Trim(rdPoint6("BillMemID1"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint6("Other1") / 2)
                                                        BillCnt = BillCnt + 0.5
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint6("BillMemID2"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint6("Other1") / 2)
                                                        BillCnt = BillCnt + 0.5
                                                    End If
                                                ElseIf rdPoint6("BillMemID1") IsNot DBNull.Value And rdPoint6("BillMemID2") IsNot DBNull.Value And rdPoint6("BillMemID3") IsNot DBNull.Value And rdPoint6("BillMemID4") Is DBNull.Value Then
                                                    ...
                                                    If InStr(MemIDList, Trim(rdPoint6("BillMemID2"))) > 0 Then
                                                        ...
                                                        BillCnt = BillCnt + 0.33
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint6("BillMemID3"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint6("Other1") * 0.33)
                                                        BillCnt = BillCnt + 0.33
                                                    End If
                                                ...
                                                ElseIf rdPoint6("BillMemID1") IsNot DBNull.Value And rdPoint6("BillMemID2") IsNot DBNull.Value And rdPoint6("BillMemID3") IsNot DBNull.Value And rdPoint6("BillMemID4") IsNot DBNull.Value Then
                                                    ...
                                                    If InStr(MemIDList, Trim(rdPoint6("BillMemID3"))) > 0 Then
                                                        ...
                                                        BillCnt = BillCnt + 0.25
                                                    End If
                                                    If InStr(MemIDList, Trim(rdPoint6("BillMemID4"))) > 0 Then
                                                        PersonPoint = PersonPoint + CDec(rdPoint6("Other1") / 4)
                                                        BillCnt = BillCnt + 0.25
                                                    End If
                                                End If
                                ...
                                strPoint3 = strPoint3 & " where (a.BillMemID1 in (" & MemIDList & ") or a.BillMemID2 in (" & MemIDList & ") or a.BillMemID3 in (" & MemIDList & ") or a.BillMemID4 in (" & MemIDList & "))"
                                    ...
                                    While rdPoint3.Read()
                                        ...
                                        Else
                                            ...
                                            ElseIf rdPoint3("BillMemID1") IsNot DBNull.Value And rdPoint3("BillMemID2") IsNot DBNull.Value And rdPoint3("BillMemID3") Is DBNull.Value And rdPoint3("BillMemID4") Is DBNull.Value Then
                                                If InStr(MemIDList, Trim(rdPoint3("BillMemID1"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A1ScoreTmp / 2)
                                                    BillCnt = BillCnt + 0.5
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint3("BillMemID2"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A1ScoreTmp / 2)
                                                    BillCnt = BillCnt + 0.5
                                                End If
                                            ...
                                            ElseIf rdPoint3("BillMemID1") IsNot DBNull.Value And rdPoint3("BillMemID2") IsNot DBNull.Value And rdPoint3("BillMemID3") IsNot DBNull.Value And rdPoint3("BillMemID4") Is DBNull.Value Then
                                                ...
                                                If InStr(MemIDList, Trim(rdPoint3("BillMemID2"))) > 0 Then
                                                    ...
                                                    BillCnt = BillCnt + 0.33
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint3("BillMemID3"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A1ScoreTmp * 0.33)
                                                    BillCnt = BillCnt + 0.33
                                                End If
                                            ElseIf rdPoint3("BillMemID1") IsNot DBNull.Value And rdPoint3("BillMemID2") IsNot DBNull.Value And rdPoint3("BillMemID3") IsNot DBNull.Value And rdPoint3("BillMemID4") IsNot DBNull.Value Then
                                                ...
                                                If InStr(MemIDList, Trim(rdPoint3("BillMemID3"))) > 0 Then
                                                    ...
                                                    BillCnt = BillCnt + 0.25
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint3("BillMemID4"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A1ScoreTmp / 4)
                                                    BillCnt = BillCnt + 0.25
                                                End If
                                            End If
                                ...
                                strPoint4 = strPoint4 & " where (a.BillMemID1 in (" & MemIDList & ") or a.BillMemID2 in (" & MemIDList & ") or a.BillMemID3 in (" & MemIDList & ") or a.BillMemID4 in (" & MemIDList & "))"
                                    ...
                                    While rdPoint4.Read()
                                        ...
                                        Else
                                            ...
                                            ElseIf rdPoint4("BillMemID1") IsNot DBNull.Value And rdPoint4("BillMemID2") IsNot DBNull.Value And rdPoint4("BillMemID3") Is DBNull.Value And rdPoint4("BillMemID4") Is DBNull.Value Then
                                                If InStr(MemIDList, Trim(rdPoint4("BillMemID1"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A2ScoreTmp / 2)
                                                    BillCnt = BillCnt + 0.5
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint4("BillMemID2"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A2ScoreTmp / 2)
                                                    BillCnt = BillCnt + 0.5
                                                End If
                                            ElseIf rdPoint4("BillMemID1") IsNot DBNull.Value And rdPoint4("BillMemID2") IsNot DBNull.Value And rdPoint4("BillMemID3") IsNot DBNull.Value And rdPoint4("BillMemID4") Is DBNull.Value Then
                                                ...
                                                If InStr(MemIDList, Trim(rdPoint4("BillMemID2"))) > 0 Then
                                                    ...
                                                    BillCnt = BillCnt + 0.33
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint4("BillMemID3"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A2ScoreTmp * 0.33)
                                                    BillCnt = BillCnt + 0.33
                                                End If
                                            ElseIf rdPoint4("BillMemID1") IsNot DBNull.Value And rdPoint4("BillMemID2") IsNot DBNull.Value And rdPoint4("BillMemID3") IsNot DBNull.Value And rdPoint4("BillMemID4") IsNot DBNull.Value Then
                                                ...
                                                If InStr(MemIDList, Trim(rdPoint4("BillMemID3"))) > 0 Then
                                                    ...
                                                    BillCnt = BillCnt + 0.25
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint4("BillMemID4"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A2ScoreTmp / 4)
                                                    BillCnt = BillCnt + 0.25
                                                End If
                                ...
                                strPoint5 = strPoint5 & " where (a.BillMemID1 in (" & MemIDList & ") or a.BillMemID2 in (" & MemIDList & ") or a.BillMemID3 in (" & MemIDList & ") or a.BillMemID4 in (" & MemIDList & "))"
                                    ...
                                    While rdPoint5.Read()
                                        ...
                                        Else
                                            ...
                                            ElseIf rdPoint5("BillMemID1") IsNot DBNull.Value And rdPoint5("BillMemID2") IsNot DBNull.Value And rdPoint5("BillMemID3") Is DBNull.Value And rdPoint5("BillMemID4") Is DBNull.Value Then
                                                If InStr(MemIDList, Trim(rdPoint5("BillMemID1"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A3ScoreTmp / 2)
                                                    BillCnt = BillCnt + 0.5
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint5("BillMemID2"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A3ScoreTmp / 2)
                                                    BillCnt = BillCnt + 0.5
                                                End If
                                            ElseIf rdPoint5("BillMemID1") IsNot DBNull.Value And rdPoint5("BillMemID2") IsNot DBNull.Value And rdPoint5("BillMemID3") IsNot DBNull.Value And rdPoint5("BillMemID4") Is DBNull.Value Then
                                                ...
                                                If InStr(MemIDList, Trim(rdPoint5("BillMemID2"))) > 0 Then
                                                    ...
                                                    BillCnt = BillCnt + 0.33
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint5("BillMemID3"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A3ScoreTmp * 0.33)
                                                    BillCnt = BillCnt + 0.33
                                                End If
                                            ElseIf rdPoint5("BillMemID1") IsNot DBNull.Value And rdPoint5("BillMemID2") IsNot DBNull.Value And rdPoint5("BillMemID3") IsNot DBNull.Value And rdPoint5("BillMemID4") IsNot DBNull.Value Then
                                                ...
                                                If InStr(MemIDList, Trim(rdPoint5("BillMemID3"))) > 0 Then
                                                    ...
                                                    BillCnt = BillCnt + 0.25
                                                End If
                                                If InStr(MemIDList, Trim(rdPoint5("BillMemID4"))) > 0 Then
                                                    PersonPoint = PersonPoint + CDec(A3ScoreTmp / 4)
                                                    BillCnt = BillCnt + 0.25
                                                End If
                                            End If
                                ...
                                Dim strPer, MemChName As String
                                Dim MemMoney As Decimal
                                If sys_City = "雲林縣" Or sys_City = "宜蘭縣" Or sys_City = "嘉義縣" Then
                                    strPer = "select Money,ChName,MemberID,CreditID from MemberData where RecordStateID=0 and LoginID='" & Trim(rdUnitPerson("LoginID")) & "' and UnitID='"&Trim(rdU("UnitID"))&"' order by RecordDate Desc"
                                Else
                                    strPer = "select Money,ChName,MemberID,CreditID from MemberData where MemberID=" & Trim(rdUnitPerson("MemberID"))
                                End If
                                ...
                                If BillCnt > 0 Then
                                    ...
                                    End If
                                    Response.Write("<tr>")
                                    Response.Write("<td style=""width: 20%"">" & Trim(rdUnitPerson("LoginID")) & "&nbsp; " & MemChName & "</td>")
                                    Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(BillCnt, "##,##0.00") & "</td>")
                                    Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(PersonPoint, "##,##0.00") & "</td>")
                                    Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(PersonMoney, "##,##0") & "</td>")
                                    Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & OverFlag & "</td>")
                                    Response.Write("</tr>")
                                End If
                            End While
                        End If
                        ...
                        Response.Write("</table><hr size=""3"" />")
                        Response.Write("<table width=""680"" border=""0"" cellpadding=""3"" cellspacing=""0"" align=""center""><tr>")
                        Response.Write("<td style=""width: 20%""></td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(BillCntTotal, "##,##0.00") & "</td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(PointTotal, "##,##0.00") & "</td>")
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(MoneyTotal, "##,##0") & "</td>")
                                                            
                        AllMoneyTotal = AllMoneyTotal + MoneyTotal
                        AllCnt = AllCnt + BillCntTotal
                        AllPoint = AllPoint + PointTotal

                        Response.Write("<td style=""width: 20%"" align=""center""></td>")
                        Response.Write("</tr></table><br /><br /><br /><br /><br />")
                        Response.Write("<table width=""680"" border=""0"" cellpadding=""3"" cellspacing=""0"" align=""center"">")
                        Response.Write("<tr><td style=""width: 25%""><span class=""style1""><strong>製表</strong></span></td>")
                        Response.Write("<td style=""width: 25%""><span class=""style1""><strong>組長</strong></span></td>")
                        Response.Write("<td style=""width: 25%""><span class=""style1""><strong>副隊長</strong></span></td>")
                        Response.Write("<td style=""width: 25%""><span class=""style1""><strong>隊長</strong></span></td>")
                ...
                Response.Write("</tr>")
                Response.Write("<tr>")
                Response.Write("<td style=""width: 20%"">總合計</td>")
                Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(AllCnt, "##,##0.00") & "</td>")
                Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(AllPoint, "##,##0.00") & "</td>")
                Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(AllMoneyTotal, "##,##0") & "</td>")
                Response.Write("</tr></table>")
            ...
            Else
                ...
                Response.Write("<td style=""width: 20%"" ALIGN=""right"">點數</td>")
                Response.Write("<td style=""width: 20%"" ALIGN=""right"">金額</td>")
                Response.Write("<td style=""width: 20%"" ALIGN=""center"">核章</td>")
                Response.Write("</tr></table><hr size=""3"" />")
                Response.Write("<table width=""680"" border=""0"" cellpadding=""3"" cellspacing=""0"" align=""center"">")
                BillCntTotal = 0
                
                Dim strUnitPerson, LoginIDTmp, ChNameTmp As String
                Dim MemMoney As Decimal
                MemIDList = ""
                strUnitPerson = "select MemberID,LoginID,CHName,Money,CreditID from MemberData where UnitID=" & Trim(Request("sUnitID")) & " and MemberID=" & Trim(Request("sMemID")) & " order by CHName"
                Dim CmdUnitPerson As New Data.OracleClient.OracleCommand(strUnitPerson, conn)
                Dim rdUnitPerson As Data.OracleClient.OracleDataReader = CmdUnitPerson.ExecuteReader()
                If rdUnitPerson.HasRows Then
                    While rdUnitPerson.Read()
                ...
                If MemIDList <> "" Then
                    Response.Write("<tr>")
                    Response.Write("<td style=""width: 20%"">" & LoginIDTmp & "&nbsp; " & ChNameTmp & "</td>")
                    OverFlag = ""
                    PersonPoint = 0
                    A1ScoreTmp = 0
                    A2ScoreTmp = 0
                    ...
                    If PersonMoney > 0 Then
                        ...
                        strInsert = strInsert & ",'" & ChNameTmp & "'," & strMemID1 & ",'" & strCreditID & "'," & Decimal.Truncate(PointMoney * PersonPoint)
                        strInsert = strInsert & "," & PersonMoney & ",sysdate," & UserID
                        strInsert = strInsert & ")"
                ...
                End If
                Response.Write("<td style=""width: 20%"" align=""right"">" & Format(PersonMoney, "##,##0") & "</td>")
                Response.Write("<td style=""width: 20%"" align=""center"">" & OverFlag & "</td>")
                Response.Write("</tr>")
