        ...
        While rdMem.Read()
            ...
            If rdLaw.HasRows Then
                While rdLaw.Read()
                    ...
                    strDeatil = strDeatil & "<td width=""10%"" align=""right"">" & Format(ReportValueCnt, "##,##0.00") & "</td>"
                    strDeatil = strDeatil & "<td width=""10%"" align=""right"">" & Format(StopValueCnt, "##,##0.00") & "</td>"
            ...
            If (ReportTotalCnt + StopTotalCnt) <> 0 Then
                ...
                Response.Write("<table width=""680"" border=""0"" cellpadding=""1"" cellspacing=""0"" align=""center"">")
                Response.Write("<tr>")
                Response.Write("<td width=""10%"">總舉發件數</td>")
                Response.Write("<td width=""60%""></td>")
                Response.Write("<td width=""10%"" align=""right"">" & Format(ReportTotalCnt, "##,##0.00") & "</td>")
                Response.Write("<td width=""10%"" align=""right"">" & Format(StopTotalCnt, "##,##0.00") & "</td>")
