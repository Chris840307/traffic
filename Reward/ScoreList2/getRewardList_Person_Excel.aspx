...
Dim CmdPointT6 As New Data.OracleClient.OracleCommand(strPointT6, conn)
            ...
            Dim PersonMoney, PersonPay, BillCnt, BillCntTotal, AllMoneyTotal, AllCnt, AllPoint As Decimal
            ...
            If Trim(Request("sMemID")) = "" Then
                ...
                If rdU.HasRows Then
                    While rdU.Read()
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                If BillCnt > 0 Then
                                    ...
                                    End If
                                    Response.Write("<tr>")
                                    Response.Write("<td style=""height: 50px"">" & Trim(rdUnitPerson("LoginID")) & "&nbsp; " & MemChName & "</td>")
                                    Response.Write("<td ALIGN=""right"">" & Format(BillCnt, "##,##0.00") & "</td>")
                                    Response.Write("<td ALIGN=""right"">" & Format(PersonPoint, "##,##0.00") & "</td>")
                                
                                    Response.Write("<td ALIGN=""right"">" & Format(PersonMoney, "##,##0") & "</td>")
                        ...
                        Response.Write("<td ALIGN=""right"">" & Format(MoneyTotal, "##,##0") & "</td>")
            ...
            Else
                ...
                Response.Write("</tr><tr>")
                Response.Write("<td style=""width: 300px"">姓名</td>")
                Response.Write("<td style=""width: 80px"">舉發件數</td>")
                Response.Write("<td style=""width: 80px"">點數</td>")
                Response.Write("<td style=""width: 80px"">金額</td>")
                Response.Write("<td style=""width: 80px"">核章</td>")
                Response.Write("</tr>")
                BillCntTotal = 0
                ...
                If MemIDList <> "" Then
                    Response.Write("<tr>")
                    Response.Write("<td style=""height: 50px"">" & LoginIDTmp & "&nbsp; " & ChNameTmp & "</td>")
                    OverFlag = ""
                    PersonPoint = 0
                    A1ScoreTmp = 0
                    A2ScoreTmp = 0
