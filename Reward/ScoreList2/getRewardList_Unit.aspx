...
<body>
    ...
    <table width="680" border="0" cellpadding="3" cellspacing="0" align="center">
        <tr>
        <td align="center" colspan="3"><span class="style1"><strong>支&nbsp; 領&nbsp; 獎 &nbsp;勵&nbsp; 金&nbsp; 核&nbsp; 發&nbsp; 清&nbsp;冊</strong></span></td>
        </tr>
        <tr>
    ...
    <table width="680" border="0" cellpadding="3" cellspacing="0" align="center">
        <%
            ...
            End If
            'Response.Write(Trim(Request("AnalyzeMoney")))
            ...
            Dim UnitFlag, strPointT6Plus2, strPointT6Plus As String
            ...
            If rdUnit.HasRows Then
                While rdUnit.Read()
                    ...
                    Response.Write("<td style=""width: 20%"" align=""right"">" & Format(UnitPoint, "##,##0.00") & "</td>")
                    Response.Write("<td style=""width: 20%"" align=""right"">" & Format(UnitMoney, "##,##0") & "</td>")
    ...
    <table width="680" border="0" cellpadding="3" cellspacing="0" align="center">
        ...
        <td style="width: 20%" align="right"><%=Format(PointTotal, "##,##0.00")%></td>
        <td style="width: 20%" align="right"><%=Format(MoneyTotal, "##,##0")%></td>
