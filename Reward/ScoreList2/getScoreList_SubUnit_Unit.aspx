                    ...
                    If rdPer.HasRows Then
                        While rdPer.Read()
                            ...
                            If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
                                ...
                                strScoreA = "select b.Other1,a.BillMemID1,a.BillMemID2,a.BillMemID3,a.BillMemID4 from BillBaseViewReward a " & strPointT6Plus2
                                ...
                                If rdScoreB.HasRows Then
                                    While rdScoreB.Read()
                                        If rdScoreB("Other1") Is DBNull.Value Then
                                            StopValueScore = StopValueScore + 0
                                            StopTotalCnt = StopTotalCnt + 0
                                            TotalScore = TotalScore
                                            StopValueCnt = StopValueCnt
