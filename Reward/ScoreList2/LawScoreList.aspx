    ...
    <center>
        ...
        <br />
            ...
            if AnalyzeUnitID=TrafficUnitID then
             ...
             %>/>僅統計分局及其管轄派出所<br />
            <hr id="HR3" />
             <input type="button" value="獎勵金發放一覽表" onclick="getRewardList_Total();" style="width: 300px; height: 30px; font-size: 11pt;" />&nbsp;
            <hr id="HR1" />
...
//宣告ajax物件，ie與其他瀏覽器宣告類別不同，故須做判斷處理
    ...
    function getRewardList_Unit(){
        ...
        window.open("getRewardList_Unit_Set.aspx?AnalyzeType="+AnalyzeType+"&AnalyzeMoney="+AnalyzeMoney,"getRewardList_Unit","width=420,height=400,left=250,top=100,scrollbars=no,menubar=no,resizable=no,fullscreen=no,status=no,toolbar=no");
    }
    //個人清冊
