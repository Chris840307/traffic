    ...
    <form id="form1" runat="server">
        <%
            ...
            If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
                ...
                '拖吊點數
                Dim strPointT6 As String = "select sum(b.Other1) as cnt from BillBaseViewReward a" & strPointT6Plus2
            ...
            Dim OverFlag, MemIDList, strDel, strInsert, strMemID1, strCreditID, LoginIDTmp As String
            ...
            If rdU.HasRows Then
                While rdU.Read()
                    ...
                    Response.Write("<td style=""width: 20%;height:30pt"">姓名</td>")
                    ...
                    Else
                        strUnitPerson = "select MemberID,LoginID,CHName,Money from MemberData where UnitID in (select UnitID from UnitInfo where UnitID='" & Trim(rdU("UnitID")) & "' or (UnitTypeID='" & Trim(rdU("UnitID")) & "' and ShowOrder=2)) order by LoginId"
                    End If
                    ...
                    If rdUnitPerson.HasRows Then
                        While rdUnitPerson.Read()
                            ...
                            If sys_City = "雲林縣" Or sys_City = "台東縣" Or sys_City = "宜蘭縣" Then
                                ...
                                '拖吊點數
                                Dim strPoint6 As String = "select b.Other1,a.BillMemID1,a.BillMemID2,a.BillMemID3,a.BillMemID4 from BillBaseViewReward a" & strPointT6Plus2
                            ...
                            MemMoney = 0
                            If sys_City = "雲林縣" Or sys_City = "宜蘭縣" Or sys_City = "嘉義縣" Then
                                strPer = "select Money,ChName,LoginID,MemberID,CreditID from MemberData where RecordStateID=0 and LoginID='" & Trim(rdUnitPerson("LoginID")) & "' order by Recorddate desc"
                            Else
                                strPer = "select Money,ChName,LoginID,MemberID,CreditID from MemberData where MemberID=" & Trim(rdUnitPerson("MemberID"))
                            End If
                            ...
                            If MemMoney = "0" Then
                                MoneyTotal = MoneyTotal + Decimal.Truncate(PointMoney * PersonPoint)
                                PersonMoney = Decimal.Truncate(PointMoney * PersonPoint)
                            Else
                                PersonPay = Decimal.Truncate(MemMoney * getPayPercent)
                                If Decimal.Truncate(PointMoney * PersonPoint) > PersonPay Then
                                    OverFlag = "＊"
                            ...
                            If BillCnt > 0 Then
                                ...
                                End If
                                Response.Write("<tr>")
                                Response.Write("<td style=""width: 20%;height:30pt"">" & Trim(rdUnitPerson("LoginID")) & "&nbsp; " & MemChName & "</td>")
