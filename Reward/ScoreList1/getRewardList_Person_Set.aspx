...
<%
    ...
    If Trim(Request("sUnitID")) <> "" Then
        Dim strMem = "select * from MemberData where UnitID=" & Trim(Request("sUnitID")) & " and RoleID=501 order by CHName"
