...
<%
    ...
    Dim strMem, strLaw, strScore, strScore2, strIll, strDeatil, MemIDList As String
    ...
    If Trim(Request("MemLoginID")) <> "" Then
        If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
            ...
            strMem = strMem & " and RecordStateID<>-1 order by LoginID"
        Else
    ...
    If rdMem.HasRows Then
        While rdMem.Read()
            ...
            strLaw = strLaw & " and b.BillMemID1 in (" & MemIDList & ") and b.RecordstateID=0 " & strLawRange
            ...
            If rdLaw.HasRows Then
                While rdLaw.Read()
                    ...
                    strScore = strScore & " and a.BillMemID1 in (" & MemIDList & ") and a.BillTypeID='2'"
                    ...
                    strScore2 = strScore2 & " and a.BillMemID1 in (" & MemIDList & ") and ((a.BillBaseTypeID='0' and a.BillTypeID='1') or (a.BillBaseTypeID='1'))"
                    ...
                    strPoint3 = strPoint3 & ",(select distinct LawVersion,LawItem,BillType1Score,A1Score,A2Score,A3Score,CountyOrNpa,IsUsed from LawScore"
                    strPoint3 = strPoint3 & " where IsUsed=1 and CountyOrNpa=" & Trim(Request("theCountyOrNpa")) & ") b"
                    strPoint3 = strPoint3 & " where b.LawItem='" & Trim(rdLaw("ItemID")) & "' and a.BillMemID1 in (" & MemIDList & ") and a.RuleVer=b.LawVersion"
                    ...
                    strPoint4 = strPoint4 & " where b.LawItem='" & Trim(rdLaw("ItemID")) & "' and a.BillMemID1 in (" & MemIDList & ") and a.RuleVer=b.LawVersion"
                    ...
                    strPoint5 = strPoint5 & " where b.LawItem='" & Trim(rdLaw("ItemID")) & "' and a.BillMemID1 in (" & MemIDList & ") and a.RuleVer=b.LawVersion"
            ...
            If ReportTotalCnt + StopTotalCnt > 0 Then
                ...
                Response.Write("<tr><td align=""center"" height=""35""><strong><span class=""style1"">個 別 員 警 舉 發 件 數 暨 績 分 統 計 明 細 表</span></strong></td></tr>")
                Response.Write("<tr><td>舉發員警：&nbsp;" & rdMem("LoginID") & "&nbsp;" & sys_Mem1 & "&nbsp;" & sys_CreditID & "</td></tr>")
