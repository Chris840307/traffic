...
<body>
    <form id="form1" runat="server">
        <%
            ...
            Dim OverFlag, strCreditID, strDel, strInsert, MemIDList, strUnitPerson As String
            If Trim(Request("sMemID")) = "" Then
                ...
                If rdU.HasRows Then
                    While rdU.Read()
                        ...
                        End If
                        rdUnit.Close()
                        Response.Write("&nbsp; 支&nbsp;領&nbsp;獎&nbsp;勵&nbsp;金&nbsp;核&nbsp;發&nbsp;清&nbsp;冊</strong></span></td>")
                        ...
                        Else
                            strUnitPerson = "select MemberID,LoginID,CHName,Money,CreditID from MemberData where UnitID='" & Trim(rdU("UnitID")) & "' order by LoginID"
                        End If
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
                                    strPer = "select Money,ChName,MemberID,CreditID from MemberData where RecordStateID=0 and LoginID='" & Trim(rdUnitPerson("LoginID")) & "'"
                                Else
            ...
            Else
                ...
                Dim MemMoney As Decimal
                MemIDList = ""
                strUnitPerson = "select MemberID,LoginID,CHName,Money,CreditID from MemberData where UnitID=" & Trim(Request("sUnitID")) & " and MemberID=" & Trim(Request("sMemID")) & " order by LoginID"
                Dim CmdUnitPerson As New Data.OracleClient.OracleCommand(strUnitPerson, conn)
                Dim rdUnitPerson As Data.OracleClient.OracleDataReader = CmdUnitPerson.ExecuteReader()
                If rdUnitPerson.HasRows Then
                    While rdUnitPerson.Read()
