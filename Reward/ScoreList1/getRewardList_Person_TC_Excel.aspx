        ...
        <%
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                If PersonMoney > 0 Then
                                    ...
                                    Response.Write("<tr>")
                                    Response.Write("<td style=""height: 45px"" ALIGN=""center"">" & rdU("UnitID") & "&nbsp;</td>")
                                    Response.Write("<td ALIGN=""center"">")
                                    If Trim(rdUnitPerson("LoginID")) <> "" Then
                                        Response.Write(Trim(rdUnitPerson("LoginID")))
                                    Else
                                        Response.Write("&nbsp;")
                                    End If
                                    Response.Write("</td>")
                                    ...
                                    If sys_City <> "台中縣" And sys_City <> "台中市" Then
                                        Response.Write("<table width=""680"" border=""0"" cellpadding=""3"" cellspacing=""0"" align=""center"">")
                                        Response.Write("<tr><td colspan=""6""><span class=""style1""><strong>承辦單位：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                        Response.Write("秘書室：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                        Response.Write("會計室：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                        Response.Write("局長：</strong></span></td>")
                                ...
                                If (UnitCnt = UnitCntTmp - 1 Or UnitCnt = UnitCntTmp) And BillCntTotal > 0 Then
                                    ...
                                    Response.Write("<tr>")
                                    If sys_City = "台中縣" Or sys_City = "台中市" Then
                                        Response.Write("<td style=""height:45px"" colspan=""4"" ALIGN=""center"">總計</td>")
                                        Response.Write("<td ALIGN=""center"">" & BillCntTotal & "</td>")
                                        Response.Write("<td ALIGN=""center"">" & PointTotal & "</td>")
                                        Response.Write("<td colspan=""2"" ALIGN=""center"">實領總金額&nbsp;" & MoneyTotal & "</td>")
                                    Else
            ...
            Else
                ...
                If sys_City = "台中縣" Or sys_City = "台中市" Then
                    Response.Write("<td style=""width: 8%;height:45px"" ALIGN=""center"">單位</td>")
                    Response.Write("<td style=""width: 12%"" ALIGN=""center"">臂章號碼</td>")
                    Response.Write("<td style=""width: 13%"" ALIGN=""center"">職位</td>")
                    Response.Write("<td style=""width: 12%"" ALIGN=""center"">姓名</td>")
                    Response.Write("<td style=""width: 10%"" ALIGN=""center"">件數</td>")
                    Response.Write("<td style=""width: 10%"" ALIGN=""center"">點數</td>")
                    Response.Write("<td style=""width: 12%"" ALIGN=""center"">實領獎金</td>")
                    Response.Write("<td style=""width: 23%"" ALIGN=""center"">郵局帳號</td>")
                Else
                    Response.Write("<td style=""width: 8%;height:35px"" ALIGN=""center"">單位</td>")
                    Response.Write("<td style=""width: 15%"" ALIGN=""center"">職位</td>")
                    Response.Write("<td style=""width: 15%"" ALIGN=""center"">姓名</td>")
                ...
                If MemIDList <> "" Then
                    ...
                    If PersonMoney > 0 Then
                        ...
                        PageSum = PageSum + PersonMoney
                        Response.Write("<tr>")
                        Response.Write("<td style=""height: 45px"" ALIGN=""center"">" & Replace(Trim(Request("sUnitID")), "'", "") & "&nbsp;</td>")
                        Response.Write("<td ALIGN=""center"">")
                        If LoginIDTmp <> "" Then
