...
.style1 {font-family:新細明體; font-size: 13pt}
-->
</style>
<style media=print>
...
<body>
    <form id="form1" runat="server">
        <%
            ...
            End If
            'Response.Write(PointMoney & "===" & getPointTotal & "===" & getMoneyTotal)
            'Response.End()
            '=================列出清冊內容=========================
            '----------------單位所有人----------------------
            'Dim PersonPay As String
            Dim strPer, MemChName, strMemID1, LoginIDTmp, UnitIDtmp, JobIDtmp As String
            Dim MemMoney As Decimal
            Dim PersonMoney, PersonPay, BillCnt, BillCntTotal, PageSum As Decimal
            Dim PersonTotal As Integer = 0
            Dim MaxMoney As Integer = 0
            Dim MinMoney As Integer = 999999
            Dim OverFlag, strCreditID, strDel, strInsert, strBank, MemIDList As String
            Dim PageCount, i, PageNo, UnitCnt, UnitCntTmp As Integer
            ...
            If Trim(Request("sMemID")) = "" Then
                ...
                If rdU.HasRows Then
                    While rdU.Read()
                        ...
                        strCnt = "select Count(distinct(LoginID)) as cnt from MemberData where unitid in (select UnitID from UnitInfo where UnitID='" & Trim(rdU("UnitID")) & "' or (UnitTypeID='" & Trim(rdU("UnitID")) & "' and ShowOrder=2)) " & JobIDPlus
                        ...
                        If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
                            strUnitPerson = "select a.loginID,a.UnitID from MemberData a,(select LoginID,Max(MemberID) MemberID from MemberData where unitid in (select UnitID from UnitInfo where UnitID='" & Trim(rdU("UnitID")) & "' or (UnitTypeID='" & Trim(rdU("UnitID")) & "' and ShowOrder=2)) " & JobIDPlus & " group by LoginID) b"
                            strUnitPerson = strUnitPerson & " where a.MemberID=b.MemberID order by UnitID,loginID"
                        Else
                            strUnitPerson = "select MemberID,LoginID,CHName,Money,CreditID,UnitID,JobID,BankName,BankID,BankAccount from MemberData where UnitID in (select UnitID from UnitInfo where UnitID='" & Trim(rdU("UnitID")) & "' or (UnitTypeID='" & Trim(rdU("UnitID")) & "' and ShowOrder=2)) " & JobIDPlus & " order by UnitID"
                        End If
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                MemMoney = 0
                                If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
                                    strPer = "select Money,ChName,UnitID,LoginID,MemberID,CreditID,JobID,BankName,BankID,BankAccount from MemberData where LoginID='" & Trim(rdUnitPerson("LoginID")) & "' and UnitID in (select UnitID from UnitInfo where UnitID='" & Trim(rdU("UnitID")) & "' or (UnitTypeID='" & Trim(rdU("UnitID")) & "' and ShowOrder=2)) order by RecordDate Desc"
                                Else
                                ...
                                If PersonMoney > 0 Then
                                    ...
                                    If sys_City = "台中縣" Or sys_City = "台中市" Then
                                        Response.Write("<td align=""center"" colspan=""8""><span class=""style1""><strong>")
                                    Else
                                        Response.Write("<td align=""center"" colspan=""6""><span class=""style1""><strong>")
                                    End If
                                    '統計單位
                                    ...
                                    Response.Write("<tr>")
                                    If sys_City = "台中縣" Or sys_City = "台中市" Then
                                        Response.Write("<td style=""width: 8%;height:45px"" ALIGN=""center"">單位</td>")
                                        Response.Write("<td style=""width: 12%"" ALIGN=""center"">臂章號碼</td>")
                                        ...
                                        Response.Write("<td style=""width: 24%"" ALIGN=""center"">郵局帳號</td>")
                                    Else
                                    ...
                                    Response.Write("<tr>")
                                    Response.Write("<td style=""height: 45px"" ALIGN=""center"">" & UnitIDtmp & "&nbsp;</td>")
                                    Response.Write("<td ALIGN=""center"">")
                                    If LoginIDTmp <> "" Then
                                        Response.Write(LoginIDTmp)
                                    Else
                                        Response.Write("&nbsp;")
                                    End If
                                    Response.Write("&nbsp;</td>")
                                    Response.Write("<td ALIGN=""center"">")
                                    Dim strJob As String = "select * from code where typeid=4 and id=" & JobIDtmp
                                    ...
                                    For i = 1 To PageCount
                                        ...
                                        If rdUnitPerson.Read() = True Then
                                            ...
                                            MemMoney = 0
                                            If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
                                                strPer = "select UnitID,Money,ChName,LoginID,MemberID,CreditID,JobID,BankName,BankID,BankAccount from MemberData where LoginID='" & Trim(rdUnitPerson("LoginID")) & "' and UnitID in (select UnitID from UnitInfo where UnitID='" & Trim(rdU("UnitID")) & "' or (UnitTypeID='" & Trim(rdU("UnitID")) & "' and ShowOrder=2)) order by RecordDate Desc"
                                            Else
                                                strPer = "select UnitID,Money,ChName,LoginID,MemberID,CreditID,JobID,BankName,BankID,BankAccount from MemberData where MemberID=" & Trim(rdUnitPerson("MemberID"))
                                            End If
                                            Dim CmdPer2 As New Data.OracleClient.OracleCommand(strPer, conn)
                                            ...
                                            If rdPer2.HasRows Then
                                                ...
                                                LoginIDTmp = Trim(rdPer2("LoginID"))
                                                JobIDtmp = Trim(rdPer2("JobID"))
                                                UnitIDtmp = Trim(rdPer2("UnitID"))
                                            ...
                                            If PersonMoney > 0 Then
                                                ...
                                                Response.Write("&nbsp;</td>")
                                                Response.Write("<td ALIGN=""center"">")
                                                Dim strJob1 As String = "select * from code where typeid=4 and id=" & JobIDtmp
                                                Dim CmdJob1 As New Data.OracleClient.OracleCommand(strJob1, conn)
                                                Dim rdJob1 As Data.OracleClient.OracleDataReader = CmdJob1.ExecuteReader()
                                                If rdJob1.HasRows Then
                                                    rdJob1.Read()
                                                    Response.Write(rdJob1("Content"))
                                                Else
                                                    Response.Write("&nbsp;")
                                                End If
                                                rdJob1.Close()
                                    ...
                                    Response.Write("<tr>")
                                    If sys_City = "台中縣" Or sys_City = "台中市" Then
                                        Response.Write("<td align=""center"" height=""45"">小計</td>")
                                    ...
                                    End If
                                    Response.Write("</tr>")
                                    If UnitCnt = UnitCntTmp - 1 Or UnitCnt = UnitCntTmp Then
                                        Response.Write("<tr>")
                                        Response.Write("<td style=""width: 30%;height:45px"" ALIGN=""center"">總計</td>")
                                        Response.Write("<td style=""width: 12%"" ALIGN=""center"" colspan=""3"">&nbsp;</td>")
                                        Response.Write("<td ALIGN=""center"">" & BillCntTotal & "</td>")
                                        Response.Write("<td ALIGN=""center"">" & PointTotal & "</td>")
                                        Response.Write("<td style=""width: 70%"" ALIGN=""center"" colspan=""2"">實領總金額&nbsp;" & MoneyTotal & "</td>")
                                        Response.Write("</tr>")
                                    End If
                                    Response.Write("</table>")
                                    If UnitCnt = UnitCntTmp - 1 Or UnitCnt = UnitCntTmp Then
                                        If sys_City = "台中縣" Or sys_City = "台中市" Then
                                            Response.Write("<table width=""680"" border=""0"" cellpadding=""3"" cellspacing=""0"" align=""center"">")
                                            Response.Write("<tr><td colspan=""8""><span class=""style1""><strong>承辦單位：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                            Response.Write("人事：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                            Response.Write("出納：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                            Response.Write("會計：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ")
                                            Response.Write("機關主官：</strong></span></td>")
                ...
                'If sys_City = "台中縣" Or sys_City = "台中市" Then
                '    Response.Write("<td style=""height:45px"" colspan=""2"" ALIGN=""center"">&nbsp;</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">件數</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">點數</td>")
                '    Response.Write("<td style=""width: 12%"" ALIGN=""center"">實領獎金</td>")
                '    Response.Write("<td style=""width: 12%"" ALIGN=""center"">備註</td>")
                'Else
                '    Response.Write("<td style=""height:45px"" colspan=""2"" ALIGN=""center"">&nbsp;</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">實領獎金</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">備註</td>")
                'End If
                'Response.Write("</tr>")
                'Response.Write("<tr>")
                                    
                'If sys_City = "台中縣" Or sys_City = "台中市" Then
                '    Response.Write("<td style=""height:45px"" colspan=""2"" ALIGN=""center"">總計</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">" & BillCntTotal & "</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">" & PointTotal & "</td>")
                '    Response.Write("<td style=""width: 12%"" ALIGN=""center"">" & MoneyTotal & "</td>")
                '    Response.Write("<td style=""width: 12%"" ALIGN=""center"">&nbsp;</td>")
                'Else
                '    Response.Write("<td style=""height:45px"" colspan=""2"" ALIGN=""center"">總計</td>")
                '    Response.Write("<td colspan=""2"" ALIGN=""center"">" & MoneyTotal & "</td>")
