    ...
    <form id="form1" runat="server">
        <%
            ...
            If sys_City = "台中縣" Or sys_City = "台中市" Then
                ...
                End If
            End If
            'Response.Write(DBReward28 & " " & getPointTotal & "," & getPointTota2)
            '******************列出清冊內容********************
            '===================1.先跑交通隊==============
            Dim PageCount, PageNo, i As Integer
            Dim Type1Money, Type2Money, Type3Money, Type4Money, MemMoney, PersonMoney, ShouldGetMoney, MoneyTotal As Decimal
            ...
            If InStr(Trim(Request("sUnitID")), AnalyzeUnitID) > 0 Then
                ...
                If rdType1.HasRows Then
                    While rdType1.Read()
                        ...
                        Response.Write("<tr>")
                        Response.Write("<td align=""center"" colspan=""2""><span class=""style1"">" & CityUnitName & UnitName & "</span></td>")
                        Response.Write("</tr>")
                        Response.Write("<tr>")
                        Response.Write("<td align=""right"" colspan=""2""><span class=""style1"">" & gOutDT2(Trim(Request("Date1"))) & "~" & gOutDT2(Trim(Request("Date2"))) & "&nbsp; &nbsp;共同人員交通績效獎金印領清冊</span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 頁次：" & PageNo & "</td>")
                        Response.Write("</tr>")
                        Response.Write("<tr>")
                        Response.Write("<td>列印日期：" & Year(Now) & "/" & Month(Now) & "/" & Day(Now) & "</td>")
                        Response.Write("<td align=""right"">列印人員：" & UserName & "</td>")
                        Response.Write("</tr>")
                        ...
                        Response.Write("<td align=""center"" width=""15%"">職位</td>")
                        Response.Write("<td align=""center"" width=""15%"">姓名</td>")
                        ...
                        Response.Write("<td align=""center"" width=""25%"">郵局帳號</td>")
                        ...
                        If sys_City <> "台中縣" And sys_City <> "台中市" Then
                            ...
                            '    Response.Write("<tr><td style=""width: 20%""><strong>承辦單位：</strong></td>")
                            '    Response.Write("<td style=""width: 20%""><strong>人事：</strong></td>")
                            '    Response.Write("<td style=""width: 20%""><strong>出納：</strong></td>")
                            '    Response.Write("<td style=""width: 20%""><strong>會計：</strong></td>")
                            '    Response.Write("<td style=""width: 20%""><strong>機關主官：</strong></td>")
