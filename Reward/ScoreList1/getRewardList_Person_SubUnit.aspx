...
<body>
    <form id="form1" runat="server">
        <%
            ...
            Dim OverFlag, strCreditID, strDel, strInsert, MemIDList, strPer, strMemID1, LoginIDTmp As String
            If Trim(Request("sMemID")) = "" Then
                ...
                If rdU.HasRows Then
                    While rdU.Read()
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                If PersonPoint > 0 Then
                                    ...
                                    End If
                                    Response.Write("<tr>")
                                    Response.Write("<td style=""width: 20%"">" & LoginIDTmp & "&nbsp; " & MemChName & "</td>")
                                    ...
                                    Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(PersonMoney, "##,##0.00") & "</td>")
                        ...
                        Response.Write("<td style=""width: 20%"" ALIGN=""right"">" & Format(MoneyTotal, "##,##0.00") & "</td>")
