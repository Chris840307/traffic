...
<body>
    <form id="form1" runat="server">
        <%
            ...
            Dim OverFlag, strDel, strInsert, strCreditID, MemIDList, strUnitPerson As String
            If Trim(Request("sMemID")) = "" Then
                    ...
                    While rdU.Read()
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
                                    strPer = "select Money,ChName,MemberID,CreditID from MemberData where LoginID='" & Trim(rdUnitPerson("LoginID")) & "' order by RecordDate Desc"
                                Else
