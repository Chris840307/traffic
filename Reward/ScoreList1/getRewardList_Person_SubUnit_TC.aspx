...
<body>
    <form id="form1" runat="server">
        <%
            ...
            'A1點數
            Dim strPointT3 As String = "select count(*) cnt from BillBase a,UnitInfo c"
            ...
            'A2點數
            Dim strPointT4 As String = "select count(*) cnt from BillBase a,UnitInfo c"
            ...
            'A3點數
            Dim strPointT5 As String = "select count(*) cnt from BillBase a,UnitInfo c"
            ...
            Dim strPer, MemChName, strMemID1, LoginIDTmp, JobIDtmp, UnitIDtmp As String
            ...
            If Trim(Request("sMemID")) = "" Then
                    ...
                    While rdU.Read()
                        ...
                        If rdUnitPerson.HasRows Then
                            While rdUnitPerson.Read()
                                ...
                                MemMoney = 0
                                If sys_City = "台中縣" Or sys_City = "南投縣" Or sys_City = "彰化縣" Or sys_City = "台中市" Then
                                    strPer = "select UnitID,Money,ChName,LoginID,MemberID,CreditID,JobID,BankName,BankID,BankAccount from MemberData where LoginID='" & Trim(rdUnitPerson("LoginID")) & "' order by RecordDate Desc"
                                Else
                                ...
                                If PersonMoney > 0 Then
                                    ...
                                    Response.Write("<tr>")
                                    Response.Write("<td style=""height: 33px"" ALIGN=""center"">" & UnitIDtmp & "</td>")
                                    ...
                                    For i = 1 To PageCount
                                        ...
                                        If rdUnitPerson.Read() = True Then
                                            ...
                                            'A1點數
                                            Dim strPoint3b As String = "select count(*) cnt from BillBase a"
                                            ...
                                            'A2點數
                                            Dim strPoint4b As String = "select count(*) cnt from BillBase a"
                                            ...
                                            'A3點數
                                            Dim strPoint5b As String = "select count(*) cnt from BillBase a"
                                    ...
                                    If UnitCnt = UnitCntTmp - 1 Or UnitCnt = UnitCntTmp Then
                                        Response.Write("<tr>")
                                        Response.Write("<td style=""height:35px"" ALIGN=""center"">總計</td>")
                                        ...
                                        Response.Write("<td ALIGN=""center"" colspan=""2"">實領總金額&nbsp;" & MoneyTotal & "</td>")
                                        Response.Write("</tr>")
                                    ...
                                    If UnitCnt = UnitCntTmp - 1 Or UnitCnt = UnitCntTmp Then
                                        'Response.Write("<table width=""680"" border=""1"" cellpadding=""3"" cellspacing=""0"" align=""center"">")
                                        'Response.Write("<tr>")
                                        ''    Response.Write("<td style=""width: 8%;height:35px"" ALIGN=""center"">總計</td>")
                                        ...
                                        'Response.Write("<td style=""width: 30%;height:35px"" ALIGN=""center"">總計</td>")
                                        'Response.Write("<td style=""width: 70%"" ALIGN=""center"">實領總金額&nbsp;" & MoneyTotal & "</td>")
                ...
                'If sys_City = "台中縣" Or sys_City = "台中市" Then
                '    Response.Write("<td style=""width: 8%;height:35px"" ALIGN=""center"">&nbsp;</td>")
                '    Response.Write("<td style=""width: 10%"" ALIGN=""center"">件數</td>")
                '    Response.Write("<td style=""width: 10%"" ALIGN=""center"">點數</td>")
                '    Response.Write("<td style=""width: 12%"" ALIGN=""center"">實領獎金</td>")
                '    Response.Write("<td style=""width: 12%"" ALIGN=""center"">備註</td>")
