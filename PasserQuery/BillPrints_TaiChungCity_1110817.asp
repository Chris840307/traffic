...
.style7 {font-family:"標楷體";font-size: 18px}
...
DelphiASPObj.GenBillPrintBarCode PBillSN(i),Sys_BillNo,Sys_Rule1,Sys_CarNo,Sys_MailNumber,"220073",Sys_OwnerZip,right(Sys_DealLineDate(0),2)&Sys_DealLineDate(1)&Sys_DealLineDate(2),Sys_StationID,"台北市交通事件裁決所",0,Sum_Level,0,True,False,Sys_MailDate,400,295,36,1
...
<div id="Layer43" class="style4" style="position:absolute; left:<%=(30+leftpx)%>px; top:<%=275+toptpx%>px; width:270px; height:36px; z-index:5">
...
<div id="Layer46" style="position:absolute; left:<%=(50+leftpx)%>px; top:<%=335+toptpx%>px; width:750px; height:70px; z-index:5">
<hr style="border: 100px solid black;" size=30/>
</div>
...
<div id="Layer1" style="position:absolute; left:<%=(50+leftpx)%>px; top:<%=710+toptpx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<!--
<div id="Layer2" style="position:absolute; left:<%=(50+leftpx)%>px; top:<%=740+toptpx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
-->
...
<div id="Layer34" style="position:absolute; left:<%=(450+leftpx)%>px; top:<%=1075+toptpx-uppx%>px; width:200px; height:80px; z-index:28"><span class="style2"><%
