...
.style15 {font-family:"標楷體"; font-size: 10px; color:#ff0000; }
-->
</style>
</head>
...
If cdbl(rsSend("cnt")) = 0 Then
	...
	elseif UnitID="05FG" then
		'竹山
		'UnitNum="540022"&Mail_Cnt 54601516
		UnitNum="54302217"
	
	elseif UnitID="05IL" then
		'信義分局
		UnitNum="54601517"
...
strSql="select a.LoginID,a.ChName,b.UnitLevelID,b.UnitID,b.UnitTypeID,b.UnitName,a.ImageFilename as MemberFileName,b.ImageFilename,b.Tel,c.Content from MemberData a,UnitInfo b,(select ID,Content from Code where TypeID=4 ) c where a.UnitID=b.UnitID and a.jobid=c.id(+) and MemberID="&Sys_BillFillerMemberID
...
<div id="Layer41" class="style3" style="position:absolute; left:90px; top:7px; width:200px; height:12px; z-index:36"><font color="red"><%=title_Unit%></font></div>
<div id="Layer41" class="style2" style="position:absolute; left:355px; top:7px; width:200px; height:12px; z-index:36"><%=title_UnitAddress%></div>
<div id="Layer41" class="style3" style="position:absolute; left:505px; top:7px; width:200px; height:12px; z-index:36"><%="(微)"&Sys_RecLoginID%></div>

<div id="Layer05" class="style3" style="position:absolute; left:570px; top:7px; z-index:5">
	<%If Sys_MailNumber<>0 Then Response.Write "　<b>第"&Sys_MailNumber&"號</b>"%>
</div>

<div id="Layer01" class="style3" style="position:absolute; left:125px; top:24px; z-index:3"><B><%
...
<div id="Layer02" class="style3" style="position:absolute; left:125px; top:70px; z-index:2"><%
...
<div id="Layer03" class="style3" style="position:absolute; left:145px; top:60px; z-index:1"><%
	Response.Write "<img src=""../BarCodeImage/"&Sys_BillNo&"_4.jpg"">"%>
</div>

<div id="Layer46" class="style1" style="position:absolute; left:370px; top:70px; z-index:2"><%
	Response.Write "<B>"&Sys_BillNo&"</B>"
	%>
</div>
...
<div id="Layer04" class="style3" style="position:absolute; left:125px; top:300px; z-index:1"><b><%
	response.write funcCheckFont(Sys_Owner,16,1)
	%>　台啟</b>
</div>

<div id="Layer06" class="style3" style="position:absolute; left:105px; top:320px; width:330px; z-index:1"><b><%
	'--------------------------------------如果是抓 戶籍補正的資料-----------------------------------------------------------------------------------------------------------
...
<!---------------------------------- 寄件人------------------------------------>
<div id="Layer72" class="style3" style="position:absolute; left:145px; top:340px; width:300px; height:36px; z-index:1"><%
	Response.Write thenPasserCity&title_Unit&"<br>"
		
	
%></div>

<div id="Layer73" class="style3" style="position:absolute; left:90px; top:360px; width:300px; height:36px; z-index:5"><%
...
<div id="Layer05" class="style3" style="position:absolute; left:470px; top:305px; z-index:5">
	　<%
...
<div id="Layer07" class="style3" style="position:absolute; left:123px; top:400px; z-index:2"><%
...
<div id="Layer12" style="position:absolute; left:120px; top:925px; width:250px; height:11px; z-index:6"><span class="style7">逕行舉發</span></div>

<div id="Layer13" style="position:absolute; left:260px; top:920px; width:28px; height:11px; z-index:3"><%'=Sys_Sex%></div>
<div id="Layer14" class="style15" style="position:absolute; left:390px; top:915px; width:340px; height:10px; z-index:4"><%
...
<div id="Layer16" style="position:absolute; left:455px; top:955px; width:106px; height:13px; z-index:9"><%'=Sys_DriverID%></div>
<div id="Layer17" style="position:absolute; left:620px; top:955px; width:99px; height:12px; z-index:10"><%'=fastring%></div>
<div id="Layer18" style="position:absolute; left:125px; top:980px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer19" style="position:absolute; left:325px; top:980px; width:250px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer20" style="position:absolute; left:580px; top:980px; width:300px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,16,1)%></div>
<div id="Layer21" style="position:absolute; left:190px; top:1010px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&funcCheckFont(Sys_OwnerZipName&Sys_OwnerAddress,16,1)%></div>
<!---------------------------------- 違規時間------------------------------------>
<div id="Layer22" style="position:absolute; left:120px; top:1040px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%></div>
<div id="Layer23" style="position:absolute; left:170px; top:1040px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%></div>
<div id="Layer24" style="position:absolute; left:220px; top:1040px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%></div>
<div id="Layer25" style="position:absolute; left:270px; top:1040px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%></div>
<div id="Layer26" style="position:absolute; left:320px; top:1040px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%></div>
<div id="Layer27" style="position:absolute; left:440px; top:1040px; width:280px; height:31px; z-index:20"><span class="style3"><%
...
%></span></div>
<div id="Layer28" style="position:absolute; left:115px; top:1060px; width:270px; height:15px; z-index:21"><span class="style3"><%=Sys_ILLEGALADDRESS%></span></div>
<div id="Layer29" style="position:absolute; left:120px; top:1085px; width:50px; height:11px; z-index:22"><b><font color="red"><%=Sys_DealLineDate(0)%></font></b></div>
<div id="Layer30" style="position:absolute; left:200px; top:1085px; width:35px; height:13px; z-index:23"><b><font color="red"><%=Sys_DealLineDate(1)%></font></b></div>
<div id="Layer31" style="position:absolute; left:280px; top:1085px; width:32px; height:15px; z-index:24"><b><font color="red"><%=Sys_DealLineDate(2)%></font></b></div>
<div id="Layer32" class="style3" style="position:absolute; left:537px; top:1125px; width:400px; height:49px; z-index:29"><%
...
<div id="Layer33" style="position:absolute; left:450px; top:1170px; width:300px; height:60px; z-index:28"><span class="style2"><%
...
<div id="Layer35" style="position:absolute; left:450px; top:1220px; width:130px; height:49px; z-index:29"><%
	response.write "<span class=""style10"">南投縣政府警察局"&Sys_UnitName&"</font></span><br><span class=""style10"">"&Sys_UnitTEL&"</span>"
%></div>

<div id="Layer37" style="position:absolute; left:635px; top:1225px; width:200px; height:46px; z-index:31"><%
	if trim(Sys_MemberFilename)<>"" then
		...
		response.write "<tr><td style=""border-color:#ff0000;border-style:solid;"" height=25 align=""center"" nowrap><span class=""style13"">&nbsp;"&Sys_BillFillerJobName&"&nbsp;"&Sys_ChName&"</span></td></tr>"
		response.write "</table><font size=2>　　"&Sys_BillFillerMemberID&"</font>"
	end if%></div>

<div id="Layer38" style="position:absolute; left:120px; top:1265px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%></div>
<div id="Layer39" style="position:absolute; left:188px; top:1265px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%></div>
<div id="Layer40" style="position:absolute; left:251px; top:1265px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%></div>

<div id="Layer43" style="position:absolute; left:300px; top:1280px; width:250px; height:12px; z-index:36"><%=Sys_DCIRETURNCARTYPE%></div>
</div>
