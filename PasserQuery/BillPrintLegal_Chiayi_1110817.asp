...
if trim(Sys_ImageFileNameB)<>"" then%>
	<div id="Layer10" style="position:absolute; left:340px; top:475px; z-index:1"><%
...
<div id="Layer12" style="position:absolute; left:110px; top:910px; width:250px; height:11px; z-index:6"><span class="style7">逕行舉發</span></div>
...
<div id="Layer22" style="position:absolute; left:145px; top:1015px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%></div>
<div id="Layer23" style="position:absolute; left:195px; top:1015px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%></div>
<div id="Layer24" style="position:absolute; left:245px; top:1015px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%></div>
<div id="Layer25" style="position:absolute; left:295px; top:1015px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%></div>
<div id="Layer26" style="position:absolute; left:345px; top:1015px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%></div>
<div id="Layer27" style="position:absolute; left:435px; top:1015px; width:320px; z-index:20"><span class="style3"><%
	...
	if (trim(Sys_Rule2)="72000011" or trim(Sys_Rule2)="72000021" or trim(Sys_Rule2)="72000031") then
		...
		if trim(Sys_IllegalSpeed)<>"" and trim(Sys_RuleSpeed)<>"" then
			...
			response.write "<br>限速"&Sys_RuleSpeed&"公里、經測速時速"&Sys_IllegalSpeed&"公里、超速"&Sys_IllegalSpeed-Sys_RuleSpeed&"公里"
			if Sys_IllegalSpeed-Sys_RuleSpeed>=100 then
				response.write "<br>100以上"
			elseif Sys_IllegalSpeed-Sys_RuleSpeed>=80 then
				response.write "<br>80以上未滿100"
...
<div id="Layer29" style="position:absolute; left:150px; top:1060px; width:50px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%></div>
<div id="Layer30" style="position:absolute; left:230px; top:1060px; width:35px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%></div>
<div id="Layer31" style="position:absolute; left:330px; top:1060px; width:32px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%></div>
...
<div id="Layer33" class="style3" style="position:absolute; left:450px; top:1140px; width:200px; height:80px; z-index:28"><%
...
%></div>
<div id="Layer35" class="style10" style="position:absolute; left:450px; top:1190px; width:130px; height:49px; z-index:29"><%="嘉義縣警察局<br>"&Sys_UnitName&"<br>"&Sys_UnitTel%></div>
...
<div id="Layer38" style="position:absolute; left:160px; top:1250px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%></div>
<div id="Layer39" style="position:absolute; left:220px; top:1250px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%></div>
<div id="Layer40" style="position:absolute; left:280px; top:1250px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%></div>
