...
if trim(request("kinds"))="BillToDCILog" then
	...
	strSQL="select count(1) cnt  " & _
		"from PasserBase a where CARSIMPLEID=8 and billstatus <> 6 and (select count(1) cnt from PASSERDCILOG where exchangetypeid='W' and billsn=a.sn)=0 " & _
	...
	If chkcnt > 0 Then
		...
		While not rs.eof
			...
			strInsCaseIn="insert into PASSERDCILOG(" & _
				...
				",sysdate,"&Session("User_ID")&",sysdate,2,'W','"&theBatchTime&"'" &_
				",(" &_
			...
			strInsCaseIn="insert into PasserBaseDciReturn(" & _
				...
				"values(" & DCISN & ","&rs("sn")&",'"&rs("billno")&"','"&rs("carno")&"','W')" 
...
<table width="100%" border="0">
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
				<tr>
					<td>
						...
						<input type="button" name="cancel" value="清除" onClick="location='UploadCaseDCI_Stop.asp';"> 
	...
	<tr>
		<td height="35" bgcolor="#FFDD77" align="center">
			...
			<input type="button" name="Submit4242" value="進行入案" onclick="BillToDCILog();">
