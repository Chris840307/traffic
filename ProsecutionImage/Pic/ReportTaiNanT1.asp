...
<%
	fname="拖吊件數_"&CDbl(year((now))-1911)&Right("0"&Month((now)),2)&Right("0"&Day((now)),2)&".xls"
...
<table border="1" cellspacing="0" cellpadding="0" width="100%">
		<td align="center" colspan="8"><b><font face="標楷體" style="font-size:16pt;">臺南市政府警察局交通警察大隊<%=year(SDate)-1911%>年<%=right("0"&month(SDate),2)%>月<%=right("0"&Day(SDate),2)%>日至<%=right("0"&month(EDate),2)%>月<%=right("0"&Day(EDate),2)%>日<br>拖吊件數</font></b></td>
<tr>
		...
		<td align="center" style="width:90px"><b><font face="標楷體" style="font-size:12pt;">溪南<BR>拖吊場</b></td>
		<td align="center" style="width:90px"><b><font face="標楷體" style="font-size:12pt;">永康<BR>拖吊場</b></td>
		<td align="center" style="width:90px"><b><font face="標楷體" style="font-size:12pt;">新營<BR>拖吊場</b></td>
		<td align="center" style="width:90px"><b><font face="標楷體" style="font-size:12pt;">合計</b></td>
...
AIC1=AIC1+IC1
IC2=cdbl(Getcnt("'1'","'A','D','E','F','G','H','I','J','K'","'07D3'",SDate2,EDate2))
AIC2=AIC2+IC2
IC3=cdbl(Getcnt("'1'","'A','D','E','F','G','H','I','J','K'","'07D4'",SDate2,EDate2))
AIC3=AIC3+IC3
ICT=cdbl(IC1)+cdbl(IC2)+cdbl(IC3)
AICT=AICT+ICT

IB1=cdbl(Getcnt("'1'","'B','C'","'07C1'",SDate2,EDate2))
AIB1=AIB1+IB1
IB2=cdbl(Getcnt("'1'","'B','C'","'07D4'",SDate2,EDate2))
AIB2=AIB2+IB2
IB3=cdbl(Getcnt("'1'","'B','C'","'07D3'",SDate2,EDate2))
AIB3=AIB3+IB3
IBT=cdbl(IB1)+cdbl(IB2)+cdbl(IB3)
AIBT=AIBT+IBT
...
AOC1=AOC1+OC1
OC2=cdbl(Getcnt("'2','3','4','5','6'","'A','D','E','F','G','H','I','J','K'","'07D3'",SDate2,EDate2))
AOC2=AOC2+OC2
OC3=cdbl(Getcnt("'2','3','4','5','6'","'A','D','E','F','G','H','I','J','K'","'07D4'",SDate2,EDate2))
AOC3=AOC3+OC3
OCTT=cdbl(OC1)+cdbl(OC2)+cdbl(OC3)
AOCT=AOCT+OCTT
...
AOB3=AOB3+OB3
OBT=cdbl(OB1)+cdbl(OB2)+cdbl(OB3)
AOBT=AOBT+OBT
...
%>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=IC3%></td></td>
   ...
   <tr>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=IB3%></td></td>
...
<td align="center" ><font face="標楷體" style="font-size:12pt;">汽車</td>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=OC3%></td></td>
...
<td align="center" ><font face="標楷體" style="font-size:12pt;">機車</td>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=OB3%></td></td>
...
<td rowspan="2" align="center"><font face="標楷體" style="font-size:12pt;">違規停車</td>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=AIC3%></td></td>
   ...
   <tr>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=AIB3%></td></td>
...
<td align="center" ><font face="標楷體" style="font-size:12pt;">汽車</td>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=AOC3%></td></td>
...
<td align="center" ><font face="標楷體" style="font-size:12pt;">機車</td>
    ...
    <td align="center" ><font face="標楷體" style="font-size:12pt;"><%=AOB3%></td></td>
