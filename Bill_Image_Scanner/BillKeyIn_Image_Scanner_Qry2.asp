...
<table border='1' align="left" cellpadding="0" height="578" width="993">
		<tr>
		...
		<td height="38" valign="top" width="321" >
						...
						<input name="RuleDateS1" type="text" class="btn1" value="<%
							...
							%>" size="5" maxlength="8" onkeyup="value=value.replace(/[^\d]/g,'')">
						<input type="button" name="datestr5" value="..." onclick="OpenWindow('RuleDateS1');">&nbsp;<br>違規代碼路段 <input type="text" size="7" value="<%=bIllegalAddressID%>" name="IllegalAddressID" onKeyUp="getillStreet();" style=ime-mode:disabled>&nbsp; <input type="text" size="8" value="<%=bIllegalAddress%>" name="IllegalAddress" style=ime-mode:active ">
					...
					<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="開始掃描" name="btnRunScanner" onclick="RunScanner();">
		...
		<td width="321" height="467" valign="top">
...
'	if request("DB_Selt")="Selt" then
			...
			%><tr onMouseOver='this.style.backgroundColor="#CCFFFF"' onMouseOut='this.style.backgroundColor="FFFFFF"'><%
		  	Response.Write("<td height='21' width='141'><span class='style2'>")
			response.write rs2("unitname")
			Response.Write("</span>　</td>")
			Response.Write("<td height='21' width='80'><span class='style2'>")
			response.write rs2("ChName") 
			Response.Write("</span>　</td>")
			Response.Write("<td height='21' width='84'><span class='style2'>")
			response.write rs2("BillNo") & ""
			Response.Write("</span>　</td>")
			Response.Write("<td height='21' width='60' align='center'><span class='style2'>")
			%>
...
document.getElementById("img").parentNode.style.height=530;
	...
	<tr>
		<td height="33" colspan="2" valign="top" width="985">
     	...
     	<table border='0' cellpadding="0" bordercolor="#FFCC33" cellspacing="0" height="33" style="border-collapse: collapse" width="970">
			<tr>
				<td bgcolor="#FFFFCC" height="33" width="129" align="center"> 
...
if request("DB_Selt")="DB_Insert" then
                 ...
                 if request("Type")="Pic" then
                   if request("RuleDateS")="" or request("RuleDateS1")="" or request("IllegalAddress")="" or  request("IllegalAddressID")="" then 
                     %>
                       <script>
                          ...
                          for (i = 1; i <=tcx1.ImageCount ; i++) 
                            {
                              ...
                              tcx1.SaveToFile("//<%=Request.ServerVariables("SERVER_NAME")%>/scan/<%=theRecordMemberID%>/" + ImageNum + ".jpg");
