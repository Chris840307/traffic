...
<%
	...
	strStReport="select distinct(e.DCIReturnStation) from (select a.BillNo,a.CarNo from DCILog a,MemberData b,DCIReturnStatus" &_
		" d,BillBaseDCIReturn e,BillBase f where a.BillSN=f.SN" &_
...
<%		'逕舉 and 攔停
		strSQL="select a.BillSN,a.BillNO,a.CarNO,e.Owner,e.OwnerZip,f.Rule1,f.Rule2,f.Rule3" &_
			" from (select a.BillSN,a.BillNo,a.CarNo,a.BillTypeID from DciLog a where a.BillSN is not null "&strwhere&") a,BillBaseDCIReturn e,BillBase f,BillMailHistory g" &_
			" where a.BillSN=f.SN" &_
			" and f.RecordStateID=0 and f.SN=g.BillSn" &_
			" and a.BillNo=e.BillNO and a.CarNo=e.CarNo" &_
			" and ((a.BillTypeID='2' and e.DCIReturnStation in ('20','21','22','23','24','25','26') and e.ExchangeTypeID='W' and e.Status='Y')" &_
			" or (a.BillTypeID<>'2' and f.MemberStation in ('20','21','22','23','24','25','26') and e.ExchangeTypeID='W' and e.Status in ('Y','S','n')))" &_
...
<%if sys_City<>"嘉義縣" then %>
			<td nowrap><%
			'單退狀態
			strStatus1="select DciReturnStatusID from Dcilog where ExchangeTypeID='N' and ReturnMarkType='5' and BillSn="&trim(rs1("BillSn"))
...
<%		'逕舉and 攔停
		strSQL="select a.BillSN,a.BillNO,a.CarNO,e.Owner,e.OwnerZip,f.Rule1,f.Rule2,f.Rule3" &_
			...
			" and f.RecordStateID=0 and f.SN=g.BillSn" &_
			" and a.BillNo=e.BillNO and a.CarNo=e.CarNo" &_
			" and ((a.BillTypeID='2' and e.DCIReturnStation in ('30','31','32') and e.ExchangeTypeID='W' and e.Status='Y')" &_
			" or (a.BillTypeID<>'2' and f.MemberStation in ('30','31','32') and e.ExchangeTypeID='W' and e.Status in ('Y','S','n')))" &_
			" order by g.UserMarkDate"
...
<%		'逕舉and 攔停
		strSQL="select a.BillSN,a.BillNO,a.CarNO,e.Owner,e.OwnerZip,f.Rule1,f.Rule2,f.Rule3" &_
			...
			" and f.RecordStateID=0 and f.SN=g.BillSn" &_
			" and a.BillNo=e.BillNO and a.CarNo=e.CarNo" &_
			" and ((a.BillTypeID='2' and e.DCIReturnStation='"&trim(StationArray(SA2))&"' and e.ExchangeTypeID='W' and e.Status='Y')" &_
			" or (a.BillTypeID<>'2' and f.MemberStation='"&trim(StationArray(SA2))&"' and e.ExchangeTypeID='W' and e.Status in ('Y','S','n')))" &_
			" order by g.UserMarkDate"
