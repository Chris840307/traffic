		...
		'if fso.fileexists(fp)=true then 
			for i=0 to Ubound(Sys_JpgFile)
				...
				'	response.write Sys_JpgFile(i)
					FileDirAndName="/img/scan/簽收/" & fDir & Sys_BillNo(i) & "_" & replace(Sys_JpgFile(i),Sys_BillNo(i) & "_","")
...
<table border="0" width="100%" bgcolor="#ffffff">
	...
	<tr>
		<td height="26" bgcolor="#FFCC33">收受/送達 紀錄列表&nbsp;<%
		...
		<input type="button" name="btnLoad" value="清除掃描檔" onclick="funClearImg('<%=fp%>');">　
