...
tb_BillbaseDCIReturn="select BillNo,CarNo,DCIReturnStation,Owner from BillbaseDCIReturn where BillNo='"&trim(Ucase(request("BillNo")))&"' and DCIReturnStation is not null"
...
if Not rscnt.eof then
	If sys_City<>"彰化縣" and sys_City<>"苗栗縣" then
		...
		If Not rschk.eof Then
			...
			elseif trim(rscnt("billstatus"))="9" and sys_City<>"基隆市" and sys_City<>"基隆市" and sys_City<>"台中市" Then
