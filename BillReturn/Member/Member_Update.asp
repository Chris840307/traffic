		...
		<td bgcolor="#CCCCCC">
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
				<tr bgcolor="#ffffff">
					...
					<% 	
						if Ucase(rs("CreditID")) <> session("Credit_ID") or isnull(rs("CreditID")) and session("Group_ID") <> 200  then 						 
