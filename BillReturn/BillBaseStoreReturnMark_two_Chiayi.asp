...
<table width="100%" border="0" bgcolor="#ffffff">
	...
	<tr>
		<td height="26" bgcolor="#FFCC33">寄存送達註記列表&nbsp;<input type="button" name="btnLoad" value="掃描匯入" onclick="funScannerImport();"><img src="space.gif" width="12" height="8"> <b>期滿日,掛號碼,郵局 為 非必填 欄位</b>. 其餘為必填欄位<br><%=titleStr%></td>
	</tr>
	<tr>
