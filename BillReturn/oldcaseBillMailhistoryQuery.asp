...
if request("DB_Selt")="Selt" then
	...
	strSQL="select SninDCIFile,BillNo,CarNo,DeCode(ReaSonID,'1','送達','F','寄存郵局','D','公示送達','') ReaSonName,RecordDate,DeCode(Status,'S','成功','N','找不到資料','n','已結案','p','已做其它送達','B','無此車號/證號','E','日期錯誤','k','已送達不可做未送達註記','h','已開裁決書','未處理') StatusName,FileName from OldCaseBillMailHistory"&strwhere&" order by FileName,SninDCIFile"
...
<table width="100%" border="0">
	<tr>
		<td bgcolor="#FFCC33"><span class="style3">DCI 舊資料上傳查詢紀錄</span></td>
	</tr>
	<tr>
		<td bgcolor="#CCCCCC">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				<tr>
					<td>
						...
						<input type="button" name="cancel" value="清除" onClick="location='oldcaseBillMailhistoryQuery.asp'">
					</td>
				</tr>
			</table>
		</td>
...
function funchgExecel(){
	UrlStr="oldcaseBillMailhistoryQuery_Execel.asp";
