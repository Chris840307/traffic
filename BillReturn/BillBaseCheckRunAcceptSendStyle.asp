...
<title>逕舉點收檔案匯入</title>
<!--#include virtual="traffic/Common/css.txt"-->
</head>
<body>
<form name="myForm" method="post" action="BillbaseChkRunUpfile.asp" enctype="multipart/form-data" >
<table width="100%" border="0">
	<tr>
		<td bgcolor="#FFCC33"><font size=4>逕舉點收檔案匯入</font></td>
	</tr>
	<tr>
		<td bgcolor="#CCCCCC">
