...
strSQL = "select MemberID,ChName from MemberData where UnitID='"&request("UnitID")&"'"
	...
	if Not rscnt.eof then
		...
		response.write "document.all['"&request("UnitMem")&"'].options[1]=new Option('½Ð¿ï¨ú','');"& vbcrlf
