...
<table width="100%" border="0" bgcolor="#ffffff">
	<tr>
		<td height="27" bgcolor="#1BF5FF" class="pagetitle"><strong>單退註記-公示送達</strong><br>
	...
	<tr>
		<td height="26" bgcolor="#1BF5FF">單退紀錄列表 <b> <%=titleStr%></b></td>
	</tr>
	<tr>
