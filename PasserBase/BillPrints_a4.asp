...
<div id="Layer27" style="position:absolute; left:445px; top:<%=220+1085*i%>px; width:600px; height:21px; z-index:20"><%
	response.write Sys_IllegalRule
...
<div id="Layer68" style="position:absolute; left:445px; top:<%=750+1085*i%>px; width:600px; height:21px; z-index:20"><%
	response.write Sys_IllegalRule
	if trim(Sys_Note)<>"" then response.write "("&Sys_Note&")"
%></div>
