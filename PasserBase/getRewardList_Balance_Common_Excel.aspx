...
-->
    ...
    <title>共同人員結餘款清冊</title>
</head>
<body>
    <form id="form1" runat="server">
    <table width="680" border="1" cellpadding="3" cellspacing="0" align="center">
        <tr>
        <td align="center" colspan="4"><span class="style1"><strong>年  月                       共同人員結餘款</strong></span></td>
        </tr>
        <tr>
	...
	<td style="width: 20%" align="right">結餘</td>
        ...
        <%
            ...
            SHOULDGETMONEY = 0
            REALGETMONEY = 0
            Dim strUnit = "Select UNITID,LOGINID,CHNAME,SHOULDGETMONEY,REALGETMONEY from REWRDMONTHDATA where DIRECTORTOGETHER='0' AND SHOULDGETMONEY-REALGETMONEY>0 AND RECORDDATE BETWEEN "&&" AND "&&""
            ...
            If rdUnit.HasRows Then
                While rdUnit.Read()
                    ...
                    SHOULDGETMONEY = SHOULDGETMONEY + rdUnit("SHOULDGETMONEY")
                    REALGETMONEY = REALGETMONEY + rdUnit("REALGETMONEY")
                    MoneyTotal = MoneyTotal + (rdUnit("SHOULDGETMONEY")-rdUnit("REALGETMONEY"))
