...
<body>
<form name="myForm2" method="post" action="SendStyle_PasserImage_Upfile.asp" enctype="multipart/form-data" onSubmit="myOpen(this);">
<table width="100%" border="0">
	<tr>
		<td bgcolor="#FFCC33"><font size=4>相關圖片上傳</font></td>
	</tr>
	<tr>
		<td bgcolor="#CCCCCC">
