...
if not rsState.eof then
	...
	Sys_ArrivedDate=split(gArrDT(DateAdd("d",30,rsState("JudeDate"))),"-")
...
<table width="635" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><div align="right" class="style22"><%=BillPageUnit&"交裁字第"&UOpenGovNumber&"號"%></div></td>
  </tr>
</table>
<table width="665" height="90%" border="1" cellspacing=0 cellpadding=3>
  <tr>
    ...
    <td width="140px" nowrap ><div style="position:absolute ;width:150px;;text-align:justify; text-justify:distribute-all-lines; text-align-last:justify;" class="style22">原舉發單位通知單</div>&nbsp;</td>
    <td width="350px"><span class="style22">第<%=trim(rsSql("BillNo"))%>號</span></td>
  </tr>
  <tr>
    ...
    <td width="84" align="center"><span class="style22">
      <%=UAgentSex%>
    &nbsp;</span></td>
    <td height="25" nowrap ><div style="position:absolute ;width:150px;;text-align:justify; text-justify:distribute-all-lines; text-align-last:justify;" class="style22">身分證統一編號</div>&nbsp;</td>
  ...
  <tr>
    ...
    <td height="25" nowrap ><div style="position:absolute ;width:150px;;text-align:justify; text-justify:distribute-all-lines; text-align-last:justify;" class="style22">代保管物件</div>&nbsp;</td>
  ...
  <tr>
    ...
    <td height="25" nowrap class="style22B"><div style="position:absolute ;width:150px;;text-align:justify; text-justify:distribute-all-lines; text-align-last:justify;" class="style22">違規地點</div>&nbsp;</td>
  ...
  <tr>
    ...
    &nbsp;</span></td>
    <td height="25" nowrap class="style22B"><div style="position:absolute ;width:150px;;text-align:justify; text-justify:distribute-all-lines; text-align-last:justify;" class="style22">舉發單位</div>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="5"><span class="style22">道路交通管理處罰條例<%
		...
		if trim(rsSql("Rule2"))<>"" and not isnull(rsSql("Rule2")) then
			...
			Response.Write "<br>"
			response.write left(trim(Sys_Rule2),2)&"條"
  ...
  <tr>
    ...
    <td colspan="5"><span class="style22"><%
		Response.Write replace(UPunishmentMainBody,"@系統帶入裁決日期@",Sys_ArrivedDate(0)&"年"&Sys_ArrivedDate(1)&"月"&Sys_ArrivedDate(2)&"日")

		Response.Write "<br>三、沒入物：無。"
	%></span></td>
  </tr>
  <tr>
    <td height="125" class="style22A">簡要理由</td>
  ...
  <tr>
	...
	一、受處分人不服本裁決者，應以原處分機關（<%=thenPasserCity%><%=theUnitName%>）為<br>
	&nbsp;&nbsp;&nbsp;&nbsp;被告，向原告住、居所、戶籍所在地，違規行為地、或原處分機關所在<br>
	&nbsp;&nbsp;&nbsp;&nbsp;地之地方法院行政訴訟庭提起訴訟；其中撤銷訴訟之提起，應於裁決書<br>
	&nbsp;&nbsp;&nbsp;&nbsp;30日之不變期間內為之。<br>

    二、請依處罰主文所定期限前持本裁決書至應到案處所<%
		If trim(theBankName) <> "" Then
			Response.Write "、郵局繳納罰鍰"
		End if 
	%>。<br>

	<%
		If trim(theBankName) <> "" Then
			Response.Write "三、「郵局劃撥」戶名："&theBankName&"　<br>&nbsp;&nbsp;&nbsp;&nbsp;劃撥帳號："&theBankAccount
		End if 
	%></span></td>
  </tr>
</table>
