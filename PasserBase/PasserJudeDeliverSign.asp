...
<table width="645" border="0">
  <tr>
    <td height="34" colspan="2"><div align="center" class="style7"><%=thenPasserCity%>（<%=thenPasserUnit%>）</div></td>
  </tr>
  <tr valign="bottom">
    <td height="29" colspan="2"><div align="center" class="style2">違反道路交通管理事件裁決書簽辦單</div></td>
  </tr>
  <tr>
    <td width="312" height="25"><span class="style2">交受處分人</span></td>
    <td width="323"><span align="right" class="style2"><%=BillPageUnit&"交裁字第"&UOpenGovNumber&"號"%></span></td>
  </tr>
</table>
<table width="645" border="1" cellpadding="4" cellspacing="1" cellspacing=0 cellpadding=0>
  ...
  <tr>
    ...
    <td> <span class="style2"><%=SysUnitName%> </span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="5"><span class="style2"><%=SysCityName&SysUnitName%>　　　　地址：<%=SysUnitAddress%></span></td>
  </tr>
  <tr>
    <td height="120"><div align="center"><span class="style2">附<br>
    記</span></div></td>
    <td colspan="5" valign="top"><span class="style2">一、受處分人不服本裁決聲明異議者，得於收受裁決書之翌日起三十日內，以司法狀紙提交本分局，轉送管轄地方法院。<br>
      二、聲明異議之書狀應載明本裁決書之日、字號及理由。<br>
    三、上開罰鍰逾30日仍不繳納者，本分局將『道路交通管理處罰條例』第九十條之二移送行政執行處強制執行。</span></td>
  </tr>
  <tr>
    <td height="70" nowrap><span class="style2">擬<br>　<br>辦</span></td>
    <td colspan="3"><span class="style2">
	<font size=1 valign="top">擬：件係 <%=trim(rsSql("DRIVER"))%>　違規設攤裁決書一式二份，<br>謹請　　鈞長用印，牌利送達作。</font>
	<%
	...
	'end if%>&nbsp;</span></td>
    <td nowrap><span class="style2">決<br>　<br>行</span></td>
