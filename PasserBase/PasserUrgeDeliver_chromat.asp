...
%>
<div id="Layer1" class="style25" style="position:absolute; left:395px;; top:45px; z-index:5"><%=replace(thenPasserUnit,"分局","")%></div>

<div id="Layer2" class="style22" style="position:absolute; left:135px;; top:160px; z-index:5"><%=UrgeDate(0)&"&nbsp;&nbsp;"&UrgeDate(1)&"&nbsp;&nbsp;"&UrgeDate(2)%></div>

<div id="Layer3" class="style22" style="position:absolute; left:460px;; top:160px; z-index:5"><%=UOpenGovNumber%></div>

<div id="Layer4" class="style22" style="position:absolute; left:135px;; top:235px; z-index:5"><%=trim(rsSql("DRIVER"))%></div>

<div id="Layer5" class="style22" style="position:absolute; left:135px;; top:305px; z-index:5"><%=trim(rsSql("DriverAddress"))%></div>

<div id="Layer6" class="style22" style="position:absolute; left:420px;; top:360px; z-index:5">1</div>
...
<div id="Layer10" class="style22" style="position:absolute; left:360px;; top:510px; z-index:5"><%=trim(Sys_Tel)%></div>

<div id="Layer11" class="style22" style="position:absolute; left:120px;; top:560px; z-index:5"><%=trim(Sys_BANKACCOUNT)%></div>

<div id="Layer12" class="style25" style="position:absolute; left:460px;; top:555px; z-index:5"><%
...
<div id="Layer13" class="style25" style="position:absolute; left:180px;; top:795px; z-index:5"><%=trim(rsSql("DRIVER"))%></div>

<div id="Layer14" class="style25" style="position:absolute; left:400px;; top:1010px; z-index:5"><%=Sys_now(0)&"　　　"&Sys_now(1)&"　　　"&Sys_now(2)%></div>