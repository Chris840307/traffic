...
if Not rsUnit.eof then 
	...
	If sys_City="高雄市" or sys_City="宜蘭縣" or sys_City="嘉義市" or sys_City="南投縣" or sys_City="雲林縣" then
...
If sys_City="彰化縣" then
	If sys_City="高雄市" or sys_City="彰化縣" or sys_City="金門縣" or sys_City="苗栗縣" or sys_City="保二總隊三大隊一中隊" or sys_City="保二總隊三大隊二中隊" Then
  ...
  <tr>
    ...
    <td><div align="right" class="style22"><%
		If sys_City="澎湖縣" Then
			...
			Response.Write BillPageUnit&UrgeNo&UOpenGovNumber&"號"
		End if		
	%></div></td>
  </tr>
</table>
<table width="665" height="90%" border="1" cellspacing=0 cellpadding=0>
  ...
  <tr>
    ...
    <td colspan="5"><span class="style22"><%
		...
		'Response.Write "<br>三、限於"&Sys_ArrivedDate(0)&"年"&Sys_ArrivedDate(1)&"月"&Sys_ArrivedDate(2)&"日前繳納。"
	%></span></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	三、上開罰鍰送達後逾30日仍不繳納者，本分局將依『行政執行法』<br>
	...
	if sys_City="宜蘭縣" then
		...
		Response.Write "　　　　　　　　　例：宜蘭縣政府警察局"&theUnitName&"<br>"
		Response.Write "　　　　　　　　　"&theUnitAddress&"）<br>"
		Response.Write "　　　　　　　　　郵寄至本分局繳納。"
...
'				Response.Write "&nbsp;&nbsp;&nbsp;&nbsp;如採郵局劃撥，須加收手續費7元。"
'			end If 
		End if 
	...
	<%
	If sys_City="彰化縣" then
		Response.Write "<div style=""position:relative;left:280px;"">"
	...
	<%If sys_City = "台中市" Then%>
		<div style="position:relative;left:250px;">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="center" class="style28"><%=replace(sys_City,"台","臺")%>政府</td>
					<td class="style29" rowspan="2"><%=theUnitName%></td>
				</tr>
				<tr>
					<td align="center" class="style30">警&nbsp;&nbsp;察&nbsp;&nbsp;局</td>
				</tr>
			</table>
		</div>
	<%end if%>
