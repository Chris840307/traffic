...
<%
if trim(request("Jude_BillSN"))<>"" then

	Session("JudeImg_PBillSN")=request("Jude_BillSN")
...
<body>
<form name="myForm2" method="post" action="Passer_Jude_upload_file.asp" enctype="multipart/form-data" onSubmit="myOpen(this);">
<table width="100%" border="0">
	<tr>
		<td bgcolor="#FFCC33"><font size=4>裁決案件相關上傳</font></td>
	</tr>
	<tr>
		<td bgcolor="#CCCCCC">
