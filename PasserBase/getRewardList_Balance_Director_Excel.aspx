...
<body>
    ...
    <table width="680" border="1" cellpadding="3" cellspacing="0" align="center">
        <tr>
        <td align="center" colspan="4"><span class="style1"><strong>年  月                       直接人員結餘款</strong></span></td>
        </tr>
        <tr>
	...
	<td style="width: 20%" align="right">結餘</td>
        ...
        <%
            ...
            SHOULDGETMONEY = 0
            REALGETMONEY = 0
            Dim strUnit = "Select UNITID,LOGINID,CHNAME,SHOULDGETMONEY,REALGETMONEY from REWRDMONTHDATA where DIRECTORTOGETHER='1' AND SHOULDGETMONEY-REALGETMONEY>0 AND RECORDDATE BETWEEN "&&" AND "&&""
