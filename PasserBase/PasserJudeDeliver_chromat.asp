...
%>
<div id="Layer1" class="style22" style="position:absolute; left:150px;; top:120px; z-index:5"><%=Sys_now(0)&"&nbsp;&nbsp;&nbsp;&nbsp;"&Sys_now(1)&"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"&Sys_now(2)%></div>

<div id="Layer2" class="style22" style="position:absolute; left:535px; top:120px; z-index:5"><%=UOpenGovNumber%></div>

<div id="Layer3" class="style22" style="position:absolute; left:145px;; top:200px; z-index:5"><%=trim(rsSql("DRIVER"))%></div>

<div id="Layer4" class="style22" style="position:absolute; left:345px; top:200px; z-index:5"><%=gInitDT(trim(rsSql("DriverBirth")))%></div>

<div id="Layer5" class="style22" style="position:absolute; left:445px; top:200px; z-index:5"><%=UAgentSex%></div>

<div id="Layer6" class="style22" style="position:absolute; left:500px; top:200px; z-index:5"><%=trim(rsSql("DriverID"))%></div>
...
<div id="Layer10" class="style22" style="position:absolute; left:145px;; top:240px; z-index:5"><%=trim(rsSql("DriverAddress"))%></div>

<div id="Layer11" class="style22" style="position:absolute; left:145px;; top:370px; z-index:5"><%=trim(rsSql("CarNo"))%></div>

<div id="Layer12" class="style22" style="position:absolute; left:530px; top:365px; z-index:5"><%=trim(rsSql("BillNo"))%></div>

<div id="Layer13" class="style22" style="position:absolute; left:150px;; top:410px; z-index:5"><%
...
<div id="Layer14" class="style22" style="position:absolute; left:460px; top:410px; z-index:5"><%
...
<div id="Layer15" class="style22" style="position:absolute; left:145px;; top:450px; z-index:5"><%=trim(rsSql("IllegalAddress"))%></div>
...
<div id="Layer18" class="style22" style="position:absolute; left:145px;; top:575px; z-index:5"><%=UJudeDate(0)&"&nbsp;&nbsp;&nbsp;&nbsp;"&UJudeDate(1)&"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"&UJudeDate(2)%></div>

<div id="Layer19" class="style22" style="position:absolute; left:435px; top:575px; z-index:5"><%=DutyUnitName%></div>

<div id="Layer20" class="style22" style="position:absolute; left:610px; top:635px; z-index:5"><%
...
%></div>
<div id="Layer21" class="style22" style="position:absolute; left:150px; top:660px; z-index:5"><%
	Sys_Rule1=trim(rsSql("Rule1"))
	response.write Mid(trim(Sys_Rule1),4,2)
%></div>

<div id="Layer22" class="style22" style="position:absolute; left:185px;; top:895px; z-index:5"><%=trim(rsSql("DRIVER"))%></div>

<div id="Layer23" class="style22" style="position:absolute; left:185px;; top:920px; z-index:5"><%=trim(rsSql("DriverAddress"))%></div>
