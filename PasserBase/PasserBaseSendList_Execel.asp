...
fname=year(now)&fMnoth&fDay&"_催告催繳裁決清冊.xls"
...
response.contenttype="application/x-msexcel; charset=MS950" 
	...
	strSQLTemp="select SN,IllegalDate,BillNo,Driver,DriverID," &_
	"Rule1,BillFillDate,DeallineDate,FORFEIT1," &_	
	"(Select JudeDate from PasserJude where billsn=PasserBase.sn) JUDEDATE," &_	
	"(Select SendDate from PasserSend where billsn=PasserBase.sn) SENDDATE," &_
	...
	" from PasserBase where RecordStateID=0 and Not Exists(select 'N' from PasserUrge where BillSN=PasserBase.SN) and Exists(select 'Y' from PasserJude where BillSN=PasserBase.SN) and Exists(select 'Y' from "&BasSQL&" where SN=PasserBase.SN) order by DriverID"
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=big5">
<title>催告催繳裁決清冊</title>
...
<table width="700" border="1">
	<tr><td>
		<table width="100%" border="0" cellpadding="4" cellspacing="1">
			<tr>
				<td align="center"><strong>催告催繳裁決清冊</strong></td>
			</tr>
			<tr>
