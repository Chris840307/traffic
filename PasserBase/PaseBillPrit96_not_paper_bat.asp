...
<tr><td align="right">
		...
		<table width="95%" height="85%" border="1" cellspacing=0 cellpadding=0>
		  <tr>
			<td colspan="5" align="center" class="style2"><%=thenPasserCity&replace(DB_UnitName,trim(thenPasserCity),"")%>行政執行案件移送書(稿)<br>
...
'				end if
					...
					<tr>
						<td colspan="4" class="style2" align="center"><%
							if sys_City<>"台南市" and sys_City<>"彰化縣" and sys_City<>"彰化縣" and sys_City<>"宜蘭縣" then
								...
								Response.Write "　　　　　　　　　　　　分局長"
								If not ifnull(theSubUnitSecBossName) Then Response.Write left(theSubUnitSecBossName,1)&"ＯＯ"							
							end if
							%>　
						</td>
					</tr>
		...
		<table width="95%" border="1" cellspacing=0 cellpadding=0>
			<tr height="50">
				<td width="25%" class="style2" align="center">承辦人</td>
				<td width="25%" class="style2" align="center">組長</td>
				<td width="25%" class="style2" align="center">副分局長</td>
				<td width="25%" class="style2" align="center">批示</td>
			</tr>
			<tr height="50">
				<td>&nbsp;</td>
				<td>&nbsp;</td>
