...
<div id="Layer6" style="position:absolute; left:40px; top:<%=775+1306*i%>px; width:400px; height:36px; z-index:5"><span class="style7">查詢電話：<%=Sys_UnitTel%>（<%=Sys_UnitName%>）</span></div>
...
<div id="Layer27" style="position:absolute; left:415px; top:<%=1015+1306*i%>px; width:600px; height:21px; z-index:20"><span class="style7"><%=Sys_IllegalRule%></span></div>
