...
<%
if trim(request("SendDetialSN"))<>"" then

	Session("SendImg_PBillSN")=request("PBillSN")	
	Session("SendImg_SendDetialSN")=request("SendDetialSN")
...
<body>
<form name="myForm2" method="post" action="PasserSend_upload_file.asp" enctype="multipart/form-data" onSubmit="myOpen(this);">
<table width="100%" border="0">
	<tr>
		<td bgcolor="#FFCC33"><font size=4>移送案件相關上傳</font></td>
	</tr>
	<tr>
		<td bgcolor="#CCCCCC">
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
				...
				<tr>
					<td>
						檔案2:<input type="file" name="file2" style="width:400" class="btn1" value="" size="50">
					</td>
				</tr>
				<tr>
					<td>
						檔案3:<input type="file" name="file3" style="width:400" class="btn1" value="" size="50">
					</td>
				</tr>
				<tr>
					<td>
						檔案4:<input type="file" name="file4" style="width:400" class="btn1" value="" size="50">
					</td>
				</tr>
			</table>
		</td>
	...
	<tr align="center">
		<td bgcolor="#FFDD77">
			...
			<input type="Hidden" name="SendDetialSN" value="<%=request("SendDetialSN")%>">
