...
<p align="center"><b><font face="標楷體" style="font-size:20pt;">臺南市政府警察局交通警察大隊拖吊場逾期未領車輛清單</font></b>
<center>
...
<table border="1" cellspacing="0" cellpadding="0" width="100%">
		<td align="center" style="border-bottom-style : solid;"><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">紅單單號</font></td>
		<td align="center" style="border-bottom-style : solid;"><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">保管單號</font></td>
		<td align="center" style="border-bottom-style : solid;" NOWRAP><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">車種</font></td>
		<td align="center" style="border-bottom-style : solid;" NOWRAP><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">車牌號碼</font></td>
		...
		<td align="center" style="border-bottom-style : solid;"><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">汽缸</font></td>
		...
		<td align="center" style="border-bottom-style : solid;"><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">舉發單位</font></td>
		<td align="center" style="border-bottom-style : solid;"><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">車主姓名</font></td>
		<td align="center" style="border-bottom-style : solid;"><font face="標楷體" style="font-size:<%=tmpFontSize%>pt;Line-height:<%=tmpLineHeight%>pt">車主地址</font></td>
...
'response.write sql
	...
	End if
	response.write "<tr>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("BillNo")&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("KeepNo")&"</td>"            
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&GetCarTypeToName(rs("CarTypeID"))&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("CarNo")&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("EngineNum")&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("Brand")&"</td>"
            response.write "<td align=""right"" style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("CylinderSize")&"&nbsp;</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("Color")&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&GetCdateTime(rs("InDateTime"))&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("UnitName")&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("OwnerName")&"</td>"
            response.write "<td style=""font-size:"&tmpFontSize&"pt;Line-height:"&tmpLineHeight&"pt""><font face=""標楷體"">&nbsp;"&rs("OwnerAddr")&"</td>"
