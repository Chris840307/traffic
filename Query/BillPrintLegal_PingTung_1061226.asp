...
if trim(Sys_BillTypeID)="1" then
	...
	DelphiASPObj.GenBillPrintBarCode_PT PBillSN(i),Sys_BillNo,Sys_Rule1,Sys_CarNo,Sys_MailNumber,"220073",Sys_DriverHomeZip,right(Sys_DealLineDate(0),2)&Sys_DealLineDate(1)&Sys_DealLineDate(2),Sys_StationID,"台北市交通事件裁決所",0,Sum_Level,0,True,False,Sys_MailDate,"902","018","17"
...
<div id="Layer07" class="style3" style="position:absolute; left:60px; top:370px; z-index:5"><%=Sys_BatchNumber&"　"&"("&cdbl(i+1)&"/"&cdbl(Ubound(PBillSN)+1)&")"%>
</div>
...
<div id="Layer32" style="position:absolute; left:410px; top:1080px; width:400px; height:49px; z-index:29"><%
...
<div id="Layer35" style="position:absolute; left:400px; top:1165px; width:120px; height:49px; z-index:29"><%
