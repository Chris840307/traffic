...
set rsCity=nothing
	...
	strSQL="select distinct a.*,e.DciReturnCarColor,e.Owner,e.DriverHomeAddress,e.DriverHomeZip,e.A_Name,e.OWNERNOTIFYADDRESS from BillBase a,DciLog b,BillBaseDciReturn e where a.CarNo=e.CarNo and e.ExchangeTypeID='A' and e.Status='S' and a.Sn=b.BillSn and a.RecordStateID=0 "&strwhere&" order by a.RecordDate"
