...
fname=year(now)&fMnoth&fDay&"_"&Trim(request("date1"))&"違規日_逕舉_舉發單資料.xls"
...
<%
	...
	" and a.billtypeid = '2' and BillStatus>'1' and billno is not null and RecordStateid=0 order by Illegaldate"
...
<tr><td>告發單號</td><td>車號</td><td>違規日</td><td>違規時間</td><td>違規路段</td><td>違反法條一</td><td>違反法條二</td><td>違規人證號</td><td>違規人姓名</td><td>舉發單位</td><td>舉發人</td><td>入案日</td><td>填單日</td><td>應到案日</td></tr>
<%  
...
<%
					...
					Set rsU=conn.execute(strU)
					If Not rsU.eof Then
						response.write rsU("DciCaseInDate")
					End If 
					rsU.close
					Set rsU=Nothing 
					%></td>
