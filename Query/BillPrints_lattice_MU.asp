...
<%end if%>
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer3" style="position:absolute; left:150px; top:20px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
...
<div id="Layer12" style="position:absolute; left:100px; top:125px; width:150px; height:11px; z-index:3">逕行舉發　<%=Sys_A_Name%><br>附採證照片　<%=Sys_CarColor%></font></div>
<div id="Layer13" style="position:absolute; left:250px; top:120px; width:28px; height:11px; z-index:3"><%=Sys_Sex%></div>
<div id="Layer14" style="position:absolute; left:345px; top:120px; width:324px; height:10px; z-index:4"><%=Sys_DriverZipName&Sys_DriverHomeAddress%></div>
...
<div id="Layer33" style="position:absolute; left:380px; top:325px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>

<div id="Layer34" style="position:absolute; left:625px; top:330px; width:100px; height:30px; z-index:28"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>
