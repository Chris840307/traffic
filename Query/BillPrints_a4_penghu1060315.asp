...
Sys_DCIRETURNCARTYPE="":Sys_DCIRETURNCARTYPEID=""
...
<div id="Layer27" style="position:absolute; left:<%=460+leftpx%>px; top:<%=245+toppx%>px; width:290px; height:31px; z-index:20"><%
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer28" style="position:absolute; left:<%=145+leftpx%>px; top:<%=260+toppx%>px; width:400px; height:15px; z-index:21"><%=Sys_ILLEGALADDRESS%></div>
...
<div id="Layer68" style="position:absolute; left:<%=460+leftpx%>px; top:<%=750+toppx%>px; width:290px; height:31px; z-index:20"><%
	response.write "<font size=2>"
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer69" style="position:absolute; left:<%=145+leftpx%>px; top:<%=770+toppx%>px; width:400px; height:15px; z-index:21"><%
response.write Sys_ILLEGALADDRESS%></div>
<div id="Layer70" style="position:absolute; left:<%=145+leftpx%>px; top:<%=795+toppx%>px; width:40px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer71" style="position:absolute; left:<%=185+leftpx%>px; top:<%=795+toppx%>px; width:40px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer72" style="position:absolute; left:<%=225+leftpx%>px; top:<%=795+toppx%>px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
