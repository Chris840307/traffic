...
<div id="Layer18" class="style4" style="position:absolute; left:600px; top:110px; z-index:1"><%
	DelphiASPObj.CreateBarCode Sys_MailNumber,0,35,260
...
<div id="Layer17" class="style3" style="position:absolute; left:460px; top:1065px; z-index:1"><%
	response.write "<img src=""../BarCodeImage/"&Sys_ImageFileNameB&".jpg"">"
'	response.write "<span class=""style6"">"&Sys_ImageFileNameB&"</span>"
...
<%
if (PageCnt mod 20)=0 then response.flush
next
next%>
</body>
</html>
