...
<body>  
	...
	<table border="1" width="100%" cellpadding="0" cellspacing="0">	
		<tr>
			...
			<td width="150"><B><center>投遞成功日</center></B></td>
		</tr><%
...
<%
			...
			response.write "<td>"&trim(rsfound("MailSdate"))&"&nbsp;</td>"
			response.write "</tr>"
			rsfound.movenext
		Wend%>
	</table>
