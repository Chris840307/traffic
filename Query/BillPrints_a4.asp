...
strSql="select BillTypeID,Driver,DriverID,DriverAddress,DriverZip,ILLEGALADDRESS,IllegalSpeed,RuleSpeed,INSURANCE,RuleVer,Note,BillFillDate from BillBase where SN="&trim(rsbil("BillSN"))
...
if showBarCode then
%>
<div id="Layer1" style="position:absolute; left:<%=60+leftpx%>px; top:<%=5+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
<div id="Layer2" style="position:absolute; left:<%=60+leftpx%>px; top:<%=40+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer3" style="position:absolute; left:<%=180+leftpx%>px; top:<%=5+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
<div id="Layer4" style="position:absolute; left:<%=180+leftpx%>px; top:<%=25+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
...
<%end if%>>-->
<div id="Layer9" style="position:absolute; left:<%=35+leftpx%>px; top:<%=55+toppx%>px; width:233px; height:36px; z-index:5"><%
	if showBarCode then
...
<div id="Layer12" style="position:absolute; left:<%=130+leftpx%>px; top:<%=115+toppx%>px; width:150px; height:11px; z-index:3"><font size=2><%
...
%></font></div>
<div id="Layer13" style="position:absolute; left:<%=285+leftpx%>px; top:<%=115+toppx%>px; width:28px; height:11px; z-index:3"><%=Sys_Sex%></div>
<div id="Layer14" style="position:absolute; left:<%=385+leftpx%>px; top:<%=115+toppx%>px; width:324px; height:10px; z-index:4"><font size=2><%if showBarCode then response.write "*本單可至郵局或委託代收之超商繳納"%></font></div>
<div id="Layer15" style="position:absolute; left:<%=290+leftpx%>px; top:<%=135+toppx%>px; width:100px; height:10px; z-index:8"><%if trim(Sys_DriverBirth(0))<>"" then response.write Sys_DriverBirth(0)&"年"&Sys_DriverBirth(1)&"月"&Sys_DriverBirth(2)&"日"%></div>
<div id="Layer16" style="position:absolute; left:<%=460+leftpx%>px; top:<%=135+toppx%>px; width:106px; height:13px; z-index:9"><%=Sys_DriverID%></div>
<div id="Layer17" style="position:absolute; left:<%=655+leftpx%>px; top:<%=135+toppx%>px; width:99px; height:12px; z-index:10"><%=fastring%></div>
<div id="Layer18" style="position:absolute; left:<%=130+leftpx%>px; top:<%=160+toppx%>px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer19" style="position:absolute; left:<%=290+leftpx%>px; top:<%=160+toppx%>px; width:117px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer20" style="position:absolute; left:<%=465+leftpx%>px; top:<%=155+toppx%>px; width:251px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,22,1)%></div>
<div id="Layer21" style="position:absolute; left:<%=130+leftpx%>px; top:<%=185+toppx%>px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&funcCheckFont(Sys_OwnerZipName&Sys_OwnerAddress,22,1)%></div>

<div id="Layer22" style="position:absolute; left:<%=135+leftpx%>px; top:<%=205+toppx%>px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer23" style="position:absolute; left:<%=175+leftpx%>px; top:<%=205+toppx%>px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer24" style="position:absolute; left:<%=215+leftpx%>px; top:<%=205+toppx%>px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer25" style="position:absolute; left:<%=255+leftpx%>px; top:<%=205+toppx%>px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer26" style="position:absolute; left:<%=295+leftpx%>px; top:<%=205+toppx%>px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
<div id="Layer27" style="position:absolute; left:<%=425+leftpx%>px; top:<%=215+toppx%>px; width:620px; height:31px; z-index:20"><%
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer28" style="position:absolute; left:<%=130+leftpx%>px; top:<%=235+toppx%>px; width:217px; height:15px; z-index:21"><%=Sys_ILLEGALADDRESS%></div>
<div id="Layer29" style="position:absolute; left:<%=135+leftpx%>px; top:<%=270+toppx%>px; width:40px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer30" style="position:absolute; left:<%=175+leftpx%>px; top:<%=270+toppx%>px; width:40px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer31" style="position:absolute; left:<%=215+leftpx%>px; top:<%=270+toppx%>px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
<div id="Layer32" style="position:absolute; left:<%=425+leftpx%>px; top:<%=275+toppx%>px; width:400px; height:49px; z-index:29"><%
...
<div id="Layer34" style="position:absolute; left:<%=425+leftpx%>px; top:<%=320+toppx%>px; width:100px; height:30px; z-index:28"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>

<div id="Layer33" style="position:absolute; left:<%=505+leftpx%>px; top:<%=315+toppx%>px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>

<div id="Layer35" style="position:absolute; font-size:16px; left:<%=425+leftpx%>px; top:<%=370+toppx%>px; width:150px; height:49px; z-index:29"><%if sys_City="嘉義市" then response.write "<font size=3>嘉義市政府警察局<br>交通隊</font>"%></div>
<div id="Layer36" style="position:absolute; font-size:16px; left:<%=625+leftpx%>px; top:<%=420+toppx%>px; width:160px; height:43px; z-index:30"><%
	if sys_City="嘉義市" then 
		response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
		response.write "<tr><td style=""border-color:#ff0000;border-style:solid;"" width=100 height=25 align=""center""><span class=""style1"">舉發單專用章<br>隊長&nbsp;劉木基</span></td></tr>"
		response.write "</table>"
	end if
%></div>
<div id="Layer37" style="position:absolute; font-size:10px; left:<%=625+leftpx%>px; top:<%=370+toppx%>px; width:200px; height:46px; z-index:31"><%
	if sys_City="嘉義市" then
		response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
...
%></div>
<div id="Layer38" style="position:absolute; left:<%=175+leftpx%>px; top:<%=470+toppx%>px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer39" style="position:absolute; left:<%=330+leftpx%>px; top:<%=470+toppx%>px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer40" style="position:absolute; left:<%=480+leftpx%>px; top:<%=470+toppx%>px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer41" style="position:absolute; left:<%=580+leftpx%>px; top:<%=470+toppx%>px; width:120px; height:12px; z-index:36">填單</div>

<div id="Layer42" style="position:absolute; left:<%=60+leftpx%>px; top:<%=540+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<!--<div id="Layer43" style="position:absolute; left:<%=60+leftpx%>px; top:<%=565+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>-->

<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer44" style="position:absolute; left:<%=180+leftpx%>px; top:<%=545+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
	<div id="Layer45" style="position:absolute; left:<%=180+leftpx%>px; top:<%=565+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
...
<div id="Layer50" style="position:absolute; left:<%=35+leftpx%>px; top:<%=590+toppx%>px; width:202px; height:36px; z-index:5"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_3.jpg"""%>></div>
<div id="Layer51" style="position:absolute; left:<%=540+leftpx%>px; top:<%=590+toppx%>px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer52" style="position:absolute; left:<%=540+leftpx%>px; top:<%=630+toppx%>px; width:230px; height:12px; z-index:7"><font size=1>　<%=BillPageUnit%>交字第　　　　　　　　　　　號</font></div>
<div id="Layer53" style="position:absolute; left:<%=130+leftpx%>px; top:<%=650+toppx%>px; width:150px; height:11px; z-index:3"><font size=2><%
	if sys_City="嘉義市" then
		response.write "逕行舉發　"&Sys_A_Name&"<br>"
		if left(trim(Sys_Rule1),2)<>"56" then response.write "附採證照片"
		response.write "　"&Sys_CarColor
...
%></font></div>
<div id="Layer54" style="position:absolute; left:<%=295+leftpx%>px; top:<%=650+toppx%>px; width:28px; height:11px; z-index:3"><%=Sys_Sex%></div>
<div id="Layer55" style="position:absolute; left:<%=390+leftpx%>px; top:<%=650+toppx%>px; width:324px; height:10px; z-index:4"><font size=2><%if showBarCode then response.write "*本單可至郵局或委託代收之超商繳納"%></font></div>
<div id="Layer56" style="position:absolute; left:<%=290+leftpx%>px; top:<%=665+toppx%>px; width:100px; height:10px; z-index:8"><%if trim(Sys_DriverBirth(0))<>"" then response.write Sys_DriverBirth(0)&"年"&Sys_DriverBirth(1)&"月"&Sys_DriverBirth(2)&"日"%></div>
<div id="Layer57" style="position:absolute; left:<%=460+leftpx%>px; top:<%=665+toppx%>px; width:106px; height:13px; z-index:9"><%=Sys_DriverID%></div>
<div id="Layer58" style="position:absolute; left:<%=655+leftpx%>px; top:<%=665+toppx%>px; width:99px; height:12px; z-index:10"><%=fastring%></div>
<div id="Layer59" style="position:absolute; left:<%=130+leftpx%>px; top:<%=695+toppx%>px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer60" style="position:absolute; left:<%=290+leftpx%>px; top:<%=695+toppx%>px; width:117px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer61" style="position:absolute; left:<%=460+leftpx%>px; top:<%=690+toppx%>px; width:251px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,22,1)%></div>
<div id="Layer62" style="position:absolute; left:<%=130+leftpx%>px; top:<%=715+toppx%>px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&funcCheckFont(Sys_OwnerZipName&Sys_OwnerAddress,22,1)%></div>

<div id="Layer63" style="position:absolute; left:<%=135+leftpx%>px; top:<%=745+toppx%>px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer64" style="position:absolute; left:<%=175+leftpx%>px; top:<%=745+toppx%>px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer65" style="position:absolute; left:<%=215+leftpx%>px; top:<%=745+toppx%>px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer66" style="position:absolute; left:<%=255+leftpx%>px; top:<%=745+toppx%>px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer67" style="position:absolute; left:<%=295+leftpx%>px; top:<%=745+toppx%>px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
<div id="Layer68" style="position:absolute; left:<%=425+leftpx%>px; top:<%=750+toppx%>px; width:620px; height:31px; z-index:20"><%
	response.write "<font size=2>"
	if left(trim(Sys_Rule1),2)="40" or (int(Sys_Rule1)>4310200 and int(Sys_Rule1)<4310209) or (int(Sys_Rule1)>3310101 and int(Sys_Rule1)<3310111) then
		if trim(Sys_IllegalSpeed)<>"" and trim(Sys_RuleSpeed)<>"" then
			response.write "限速"&Sys_RuleSpeed&"公里、經測速時速"&Sys_IllegalSpeed&"公里、超速"&Sys_IllegalSpeed-Sys_RuleSpeed&"公里"
			if Sys_IllegalSpeed-Sys_RuleSpeed>=20 then
				response.write "<br>超過20公里"
			else
				response.write "<br>未滿20公里"
			end if
		end if
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer69" style="position:absolute; left:<%=130+leftpx%>px; top:<%=780+toppx%>px; width:217px; height:15px; z-index:21"><%
if sys_City="嘉義市" then response.write "嘉義市"
response.write Sys_ILLEGALADDRESS%></div>
<div id="Layer70" style="position:absolute; left:<%=135+leftpx%>px; top:<%=810+toppx%>px; width:40px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer71" style="position:absolute; left:<%=175+leftpx%>px; top:<%=810+toppx%>px; width:40px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer72" style="position:absolute; left:<%=215+leftpx%>px; top:<%=810+toppx%>px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
<div id="Layer73" style="position:absolute; left:<%=425+leftpx%>px; top:<%=815+toppx%>px; width:400px; height:49px; z-index:29"><%
	response.write "<font size='2'>第"&left(trim(Sys_Rule1),2)&"條"
	if len(trim(Sys_Rule1))>7 then response.write "之"&right(trim(Sys_Rule1),1)
	response.write Mid(trim(Sys_Rule1),3,1)&"項"&Mid(trim(Sys_Rule1),4,2)&"款"&Mid(trim(Sys_Rule1),6,2)&"規定"
	response.write "(期限內自動繳納處新台幣"&Sys_Level1&"元)"
...
<div id="Layer75" style="position:absolute; left:<%=425+leftpx%>px; top:<%=860+toppx%>px; width:100px; height:30px; z-index:28"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>

<div id="Layer74" style="position:absolute; left:<%=505+leftpx%>px; top:<%=855+toppx%>px; width:400px; height:30px; z-index:28"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_5.jpg"""%>></div>
<div id="Layer76" style="position:absolute; font-size:16px; left:<%=410+leftpx%>px; top:<%=910+toppx%>px; width:150px; height:49px; z-index:29"><%if sys_City="嘉義市" then response.write "<font size=3>嘉義市政府警察局<br>交通隊</font>"%></div>
<div id="Layer77" style="position:absolute; font-size:10px; left:<%=625+leftpx%>px; top:<%=915+toppx%>px; width:200px; height:46px; z-index:31"><%
	if billprintuseimage=1 then
		if trim(Sys_MemberFilename)<>"" then
			response.write "<img src=""../Member/Picture/"&Sys_MemberFilename&""" width=""90"" height=""30"">"
		end if
...
%></div>
<div id="Layer78" style="position:absolute; left:<%=175+leftpx%>px; top:<%=1005+toppx%>px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer79" style="position:absolute; left:<%=330+leftpx%>px; top:<%=1005+toppx%>px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer80" style="position:absolute; left:<%=480+leftpx%>px; top:<%=1005+toppx%>px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer81" style="position:absolute; left:<%=580+leftpx%>px; top:<%=1005+toppx%>px; width:120px; height:12px; z-index:36">填單</div>
</div>
<%
