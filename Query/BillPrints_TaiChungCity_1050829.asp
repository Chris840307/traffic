...
-->
<div id="Layer64" class="style4" style="position:absolute; left:<%=(40+leftpx)%>px; top:0px; width:350px; height:36px; z-index:5">
<%=Sys_UnitName%>
</div>

<div id="Layer64" class="style5" style="position:absolute; left:<%=(40+leftpx)%>px; top:<%=60+toptpx%>px; width:350px; height:36px; z-index:5">
	<%=Sys_MailNumber%>
</div>

<div id="Layer68" class="style5" style="position:absolute; left:<%=(80+leftpx)%>px; top:<%=40+toptpx%>px; width:350px; height:36px; z-index:2">
	<img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>>
</div>

<div id="Layer68" class="style3" style="position:absolute; left:<%=(280+leftpx)%>px; top:<%=20+toptpx%>px; width:350px; height:36px; z-index:2">
	<B>臺&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中</B><br>
	<B>民權路郵局</B><br>
	<B><%=replace(gArrDT(Sys_MailDate),"-",".")%></B>
</div>

<div id="Layer42" class="style5" style="position:absolute; left:<%=(130+leftpx)%>px; top:<%=100+toptpx%>px; width:150px; height:36px; z-index:5">
	<%if trim(Sys_BillTypeID)="1" then
...
<div id="Layer72" class="style5" style="position:absolute; left:<%=(130+leftpx)%>px; top:<%=165+toptpx%>px; width:150px; height:36px; z-index:5">
	<%if trim(Sys_BillTypeID)="1" then
...
<div id="Layer43" class="style4" style="position:absolute; left:<%=(30+leftpx)%>px; top:<%=300+toptpx%>px; width:270px; height:36px; z-index:5">
	應到案處所：<%=Sys_STATIONNAME%><br>應到案處所電話：<%=Sys_StationTel%><br><%=Sys_UnitName%>
</div>

<div id="Layer45" class="style4" style="position:absolute; left:<%=(40+leftpx)%>px; top:<%=340+toptpx%>px; width:250px; height:36px; z-index:5">
...
<div id="Layer20" style="position:absolute; left:<%=(550+leftpx)%>px; top:<%=950+toptpx-uppx%>px; width:150px; height:17px; z-index:13"><span class="style5"><%=funcCheckFont(Sys_Owner,14,1)%></span></div>
