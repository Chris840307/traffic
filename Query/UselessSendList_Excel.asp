...
if sys_City="基隆市" then 
	strSQL="select count(*) as cnt from DCILog a,MemberData b" &_
		...
		" and a.DciReturnStatusID=e.Status and (((d.DCIreturnStatus=-1 or (e.DciErrorCarData in ('1','3','9','a','j','A','H','K','L','T'))) and UseTool<>8) or (d.DCIreturnStatus=-1 and UseTool=8))" &_
...
elseif sys_City="台南縣" or sys_City="雲林縣" then 
	strSQL="select count(*) as cnt from DCILog a,MemberData b" &_
		...
		" and a.DCIReturnStatusID=d.DCIReturn(+)" &_
		" and a.BillNO=e.BillNo and a.CarNo=e.CarNO and a.ExchangeTypeID=e.ExchangeTypeID" &_
		" and a.DciReturnStatusID=e.Status and (((d.DCIreturnStatus=-1) and UseTool<>8) or (d.DCIreturnStatus=-1 and UseTool=8))" &_
		" and a.RecordMemberID=b.MemberID(+) "&strwhere&" order by f.RecordMemberID,f.RecordDate"
elseif sys_City="苗栗縣" then 
	strSQL="select count(*) as cnt from DCILog a,MemberData b" &_
		...
		" and a.DCIReturnStatusID=d.DCIReturn(+)" &_
		" and (a.BillNO=e.BillNo or (a.BIllNo is null and e.billNo is NUll and a.ExchangeTypeID='A')) and a.CarNo=e.CarNO and a.ExchangeTypeID=e.ExchangeTypeID" &_
		" and a.DciReturnStatusID=e.Status and (((d.DCIreturnStatus=-1 or (e.DciErrorCarData in ('1','3','9','a','j','A','H','K','T'))) and UseTool<>8) or (d.DCIreturnStatus=-1 and UseTool=8))" &_
		" and a.RecordMemberID=b.MemberID(+) "&strwhere&" order by f.RecordMemberID,f.RecordDate"
		' and f.RecordStateID=0
else
	strSQL="select count(*) as cnt from DCILog a,MemberData b" &_
		",DCIReturnStatus d,BillBaseDciReturn e,BillBase f where a.BillSN=f.SN and a.BillTypeID='2'" &_
		" and f.RecordStateID=0 and a.ExchangeTypeID=d.DCIActionID(+)" &_
	...
	if trim(rs1("cnt"))="0" then
		...
		pagecnt=fix(Cint(rs1("cnt"))/23+0.9999999)
	end if
	rs1.close
	PrintSN=0
if sys_City="基隆市" then 
...
elseif sys_City="苗栗縣" then 
	strSQL="select f.SN,a.BillNO,f.IllegalDate,f.CarNo,f.CarSimpleID,f.Rule1,f.Rule2,f.Rule3" &_
		",f.Rule4,f.BillTypeID,f.Driver,f.BillMem1,a.BillUnitID,f.MemberStation" &_
		",d.StatusContent,a.ExchangeTypeID,a.DCIReturnStatusID,a.FileName,e.DciErrorCarData,f.RecordDate from DCILog a,MemberData b" &_
		",DCIReturnStatus d,BillBaseDciReturn e,BillBase f where a.BillSN=f.SN and a.BillTypeID='2'" &_
		" and a.ExchangeTypeID=d.DCIActionID(+)" &_
		" and a.DCIReturnStatusID=d.DCIReturn(+)" &_
		" and (a.BillNO=e.BillNo or (a.BIllNo is null and e.billNo is NUll and a.ExchangeTypeID='A')) and a.CarNo=e.CarNO and a.ExchangeTypeID=e.ExchangeTypeID" &_
...
%>
	...
	if sys_City="苗栗縣" then
		...
		if trim(rs1("RecordDate"))<>"" then
			...
			%></td>
			<td align="right">Page <%=fix(PrintSN/23)+1%> of <%=pagecnt%></td>
		</tr>
	</table>
...
%>
共計： <%=PrintSN%>  &nbsp;筆<br>
<%If fix(PrintSN/23)+1=pagecnt then%>
<br>
交還舉發人簽章：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 簽收日期：
<br><br><br><br><br>
交還舉發單位主管簽章：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 簽收日期：
...
<%
	...
	if sys_City="苗栗縣" Then
		strState=""
	Else
		strState=" and f.RecordStateID=0"
	End If 
	strSQL="select count(*) as cnt from DCILog a,MemberData b" &_
		",DCIReturnStatus d,BillBaseDciReturn e,BillBase f where a.BillSN=f.SN and a.BillTypeID<>'2'" &_
		" and a.ExchangeTypeID=d.DCIActionID(+)" &_
		...
		" and a.RecordMemberID=b.MemberID(+) " & strwhere & strState & " order by f.RecordMemberID,f.RecordDate"
	set rs1=conn.execute(strSQL)
	if trim(rs1("cnt"))="0" then
		pagecnt=1
	else
	...
	strSQL="select f.SN,a.BillNO,f.IllegalDate,f.CarNo,f.CarSimpleID,f.Rule1,f.Rule2,f.Rule3" &_
		...
		",d.StatusContent,a.ExchangeTypeID,a.DCIReturnStatusID,a.FileName,f.RecordDate from DCILog a,MemberData b" &_
		",DCIReturnStatus d,BillBaseDciReturn e,BillBase f where a.BillSN=f.SN and a.BillTypeID<>'2'" &_
		" and a.ExchangeTypeID=d.DCIActionID(+)" &_
		" and a.DCIReturnStatusID=d.DCIReturn(+)" &_
		" and a.BillNO=e.BillNo and a.CarNo=e.CarNO and a.ExchangeTypeID=e.ExchangeTypeID" &_
