...
<div id="Layer6" style="position:absolute; left:50px; top:400px; z-index:1">
	<table border="0" width="80%" cellspacing=0 cellpadding=0>
		<tr>
			...
			strSQL="select ForFeit1,IllegalDate,IllegalAddress,ImagePathName from BillBase where RecordStateId <> -1 and ImageFileNameB='"&Sys_ImageFileNameB&"' order by IllegalDate"
...
<script language="javascript">
	function funPrint(){
		window.focus();
		if(confirm("是否要列印催繳單?")){
			UrlStr="StopBillPrints_HuaLien_Main.asp";
