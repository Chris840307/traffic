...
if showBarCode then
%>
<div id="Layer1" style="position:absolute; left:65px; top:5px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
<div id="Layer2" style="position:absolute; left:65px; top:40px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer3" style="position:absolute; left:190px; top:5px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
<div id="Layer4" style="position:absolute; left:190px; top:20px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
...
%></div>
<div id="Layer10" style="position:absolute; left:535px; top:55px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer11" style="position:absolute; left:550px; top:95px; width:230px; height:12px; z-index:7"><font size=1>　<%=BillPageUnit%>交字第<%="　　　　　　　　"%>號</font></div>
<div id="Layer12" style="position:absolute; left:120px; top:115px; width:150px; height:11px; z-index:3"><font size=2>逕行舉發　<%=Sys_A_Name%><br><%if int(Sys_Rule1)<>5620001 then response.write "附採證照片"%>　<%=Sys_CarColor%></font></div>
<div id="Layer13" style="position:absolute; left:275px; top:115px; width:28px; height:11px; z-index:3"><%=Sys_Sex%></div>
...
<div id="Layer15" style="position:absolute; left:280px; top:135px; width:100px; height:10px; z-index:8"><%if trim(Sys_DriverBirth(0))<>"" then response.write Sys_DriverBirth(0)&"年"&Sys_DriverBirth(1)&"月"&Sys_DriverBirth(2)&"日"%></div>
<div id="Layer16" style="position:absolute; left:450px; top:135px; width:106px; height:13px; z-index:9"><%=Sys_DriverID%></div>
<div id="Layer17" style="position:absolute; left:645px; top:135px; width:99px; height:12px; z-index:10"><%=fastring%></div>
<div id="Layer18" style="position:absolute; left:120px; top:160px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer19" style="position:absolute; left:285px; top:160px; width:117px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer20" style="position:absolute; left:465px; top:160px; width:251px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,22,1)%></div>
...
<div id="Layer26" style="position:absolute; left:280px; top:205px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
...
<div id="Layer29" style="position:absolute; left:120px; top:270px; width:50px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer30" style="position:absolute; left:160px; top:270px; width:50px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer31" style="position:absolute; left:200px; top:270px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
...
<div id="Layer33" style="position:absolute; left:415px; top:315px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>

<div id="Layer34" style="position:absolute; left:655px; top:320px; width:100px; height:30px; z-index:28"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>

<div id="Layer35" style="position:absolute; left:430px; top:380px; width:110px; height:49px; z-index:29"><%="<font size=3>嘉義縣警察局交通隊<br>05-3620229</font>"%></div>
...
<div id="Layer37" style="position:absolute; left:650px; top:370px; width:200px; height:46px; z-index:31"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
...
%></div>
<div id="Layer38" style="position:absolute; left:165px; top:470px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer39" style="position:absolute; left:320px; top:470px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer40" style="position:absolute; left:470px; top:470px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer41" style="position:absolute; left:570px; top:470px; width:120px; height:12px; z-index:36">填單　<%=Sys_BillFillerMemberID%></div>
...
<%end if%>
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer44" style="position:absolute; left:190px; top:535px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
...
<div id="Layer51" style="position:absolute; left:552px; top:580px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
...
<div id="Layer53" style="position:absolute; left:120px; top:640px; width:150px; height:11px; z-index:3"><font size=2>逕行舉發　<%=Sys_A_Name%><br><%if int(Sys_Rule1)<>5620001 then response.write "附採證照片"%>　<%=Sys_CarColor%></font></div>
<div id="Layer54" style="position:absolute; left:285px; top:640px; width:28px; height:11px; z-index:3"><%=Sys_Sex%></div>
<div id="Layer55" style="position:absolute; left:385px; top:640px; width:324px; height:10px; z-index:4"></div>
<div id="Layer56" style="position:absolute; left:280px; top:665px; width:100px; height:10px; z-index:8"><%if trim(Sys_DriverBirth(0))<>"" then response.write Sys_DriverBirth(0)&"年"&Sys_DriverBirth(1)&"月"&Sys_DriverBirth(2)&"日"%></div>
<div id="Layer57" style="position:absolute; left:450px; top:665px; width:106px; height:13px; z-index:9"><%=Sys_DriverID%></div>
<div id="Layer58" style="position:absolute; left:645px; top:665px; width:99px; height:12px; z-index:10"><%=fastring%></div>
...
<div id="Layer61" style="position:absolute; left:465px; top:685px; width:251px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,22,1)%></div>
<div id="Layer62" style="position:absolute; left:120px; top:710px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,22,1)%></div>

<div id="Layer63" style="position:absolute; left:120px; top:735px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer64" style="position:absolute; left:160px; top:735px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer65" style="position:absolute; left:200px; top:735px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer66" style="position:absolute; left:240px; top:735px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer67" style="position:absolute; left:280px; top:735px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
<div id="Layer68" style="position:absolute; left:425px; top:745px; width:620px; height:31px; z-index:20"><%
	response.write "<font size=2>"
	if left(trim(Sys_Rule1),2)="40" or (int(Sys_Rule1)>4310200 and int(Sys_Rule1)<4310209) or (int(Sys_Rule1)>3310101 and int(Sys_Rule1)<3310111) then
		if trim(Sys_IllegalSpeed)<>"" and trim(Sys_RuleSpeed)<>"" then
			response.write "限速"&Sys_RuleSpeed&"公里、經測速時速"&Sys_IllegalSpeed&"公里、超速"&Sys_IllegalSpeed-Sys_RuleSpeed&"公里"
...
<div id="Layer70" style="position:absolute; left:120px; top:800px; width:50px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer71" style="position:absolute; left:160px; top:800px; width:50px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer72" style="position:absolute; left:200px; top:800px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
...
<div id="Layer74" style="position:absolute; left:415px; top:845px; width:400px; height:30px; z-index:28"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_5.jpg"""%>></div>

<div id="Layer75" style="position:absolute; left:665px; top:850px; width:100px; height:30px; z-index:26"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>

<div id="Layer76" style="position:absolute; left:430px; top:910px; width:110px; height:49px; z-index:29"><%
	response.write "<font size=3>嘉義縣警察局交通隊<br>05-3620229</font>"
%></div>
...
<div id="Layer77" style="position:absolute; left:640px; top:910px; width:200px; height:46px; z-index:31"><%
	...
	response.write "</table><font size=2>　　"&Sys_BillFillerMemberID&"</font>"
%></div>
<div id="Layer78" style="position:absolute; left:165px; top:995px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer79" style="position:absolute; left:320px; top:995px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer80" style="position:absolute; left:470px; top:995px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer81" style="position:absolute; left:570px; top:995px; width:120px; height:12px; z-index:36">填單　<%=Sys_BillFillerMemberID%></div>
</div>
<%
