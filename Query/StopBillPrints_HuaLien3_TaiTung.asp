...
for cmtI=0 to Ubound(PBillNo)
	...
	If Not rsmail.eof Then
		Sys_MailNumber=trim(rsmail("MailNumber"))&"95100017"
		Sys_MailChkNumber=trim(rsmail("MailNumber"))&" 951000 17"
	end if
	rsmail.close
...
<div id="Layer18" class="style4" style="position:absolute; font-size:14px; left:500px; top:<%=160+toppx%>px; z-index:5"><%
...
<div id="Layer5" class="style2" style="position:absolute; left:50px; top:<%=385+toppx%>px; z-index:1"><%="車號："&Sys_CarNo&"　車主地址："&funcCheckFont(Sys_Address,20,1)%></div>

<div id="Layer6" style="position:absolute; left:50px; top:<%=405+toppx%>px; z-index:1">
...
<div id="Layer7" class="style4" style="position:absolute; left:50px; top:<%=565+toppx%>px; z-index:1"><B><%
	response.write "催繳單號："&Sys_ImageFileNameB&"　　　繳費期限"&Sys_DeallIneDate(0)&"/"&Sys_DeallIneDate(1)&"/"&Sys_DeallIneDate(2)&"日止"
%></B>
</div>
<div id="Layer8" class="style4" style="position:absolute; left:50px; top:<%=590+toppx%>px; z-index:1"><B><%
	response.write "共計催繳："&Cntsum&"筆，停車費："&ForFeitSum&"元、工本費34元，總金額："&(ForFeitSum+34)&"元"
%></B>
</div>

<div id="Layer9" class="style3" style="position:absolute; left:50px; top:<%=625+toppx%>px; z-index:1">
...
<div id="Layer10" class="style2" style="position:absolute; left:80px; top:<%=810+toppx%>px; z-index:1"><%
...
<div id="Layer11" class="style2" style="position:absolute; left:80px; top:<%=860+toppx%>px; z-index:1"><%
...
<div id="Layer12" class="style2" style="position:absolute; left:80px; top:<%=910+toppx%>px; z-index:1"><%
...
<div id="Layer13" class="style3" style="position:absolute; left:630px; top:<%=900+toppx%>px; z-index:1"><%
	response.write Sys_CarNo&"<br>"
	response.write "經收人蓋章："
%>
</div>

<div id="Layer070" style="position:absolute; left:430px; top:<%=1015+toppx%>px; z-index:8"><%
	Response.Write "<img src=""../Image/BillNoPage.gif"" width=""80"">"
	%>
</div>

<div id="Layer071" style="position:absolute; left:445px; top:<%=1048+toppx%>px; font-size: 12px; z-index:9"><%
	Response.Write replace(gArrDT(date),"-",".")
	%>
</div>

<div id="Layer14" class="style2" style="position:absolute; left:300px; top:<%=960+toppx%>px; z-index:1"><%="車號："&Sys_CarNo%></div>

<div id="Layer15" class="style3" style="position:absolute; width:200px; left:120px; top:<%=1010+toppx%>px; z-index:1"><%
...
<div id="Layer17" class="style3" style="position:absolute; left:550px; top:<%=1090+toppx%>px; z-index:1"><%
	response.write "<img src=""../BarCodeImage/"&Sys_ImageFileNameB&".jpg"" width=""180"" height=""25"">"
...
<div id="Layer16" class="style3" style="position:absolute; left:110px; top:<%=1060+toppx%>px; z-index:1"><%
