...
<div id="Layer29" style="position:absolute; left:120px; top:270px; width:34px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer30" style="position:absolute; left:160px; top:270px; width:35px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
...
<div id="Layer35" style="position:absolute; left:390px; top:380px; width:120px; height:49px; z-index:29"><%="<font size=3>嘉義縣警察局交通隊<br>05-3620229</font>"%></div>
...
<div id="Layer37" style="position:absolute; left:650px; top:390px; width:200px; height:46px; z-index:31"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
...
<div id="Layer70" style="position:absolute; left:120px; top:800px; width:34px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer71" style="position:absolute; left:160px; top:800px; width:35px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
...
<div id="Layer76" style="position:absolute; left:410px; top:910px; width:120px; height:49px; z-index:29"><%
