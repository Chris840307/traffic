...
<div id="Layer43" class="style4" style="position:absolute; left:<%=(30+leftpx)%>px; top:<%=295+toptpx%>px; width:270px; height:36px; z-index:5">
	應到案處所：<%=Sys_STATIONNAME%><br>應到案處所電話：<%=Sys_StationTel%><br><%=Sys_UnitName%>
</div>

<div id="Layer45" class="style4" style="position:absolute; left:<%=(40+leftpx)%>px; top:<%=335+toptpx%>px; width:250px; height:36px; z-index:5">
...
<%If instr(Request("Sys_Batchnumber"),"WT")>0 then%>
	...
	if showBarCode then%>
	<div id="Layer1" style="position:absolute; left:<%=(55+leftpx)%>px; top:<%=800+toptpx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
	<%else%>
	<div id="Layer2" style="position:absolute; left:<%=(55+leftpx)%>px; top:<%=830+toptpx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
	<%end If 
...
<%if trim(Sys_BillTypeID)="1" then%>
	...
	<%end if%>
<%end if%>
<div id="Layer9" style="position:absolute; left:50px; top:<%=860+toptpx%>px; width:202px; height:36px; z-index:5"><%
	if showBarCode then
...
<div id="Layer10" style="position:absolute; left:500px; top:<%=855+toptpx%>px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
...
<div id="Layer144" class="style4" style="position:absolute; left:<%=(120+leftpx)%>px; top:<%=915+toptpx%>px; width:250px; height:11px; z-index:3"><%
	...
	elseif instr(Sys_BillNo,"G5H")>0 Or instr(Sys_BillNo,"G6H")>0 then
...
<div id="Layer18" style="position:absolute; left:<%=(110+leftpx)%>px; top:<%=960+toptpx-uppx%>px; width:100px; height:14px; z-index:11"><span class="style3"><%=Sys_CarNo%></span></div>
<div id="Layer19" style="position:absolute; left:<%=(260+leftpx)%>px; top:<%=960+toptpx-uppx%>px; width:200px; height:20px; z-index:12"><span class="style3"><%=Sys_DCIRETURNCARTYPE%></span></div>
<div id="Layer20" style="position:absolute; left:<%=(495+leftpx)%>px; top:<%=960+toptpx-uppx%>px; width:201px; height:17px; z-index:13"><span class="style3"><%=funcCheckFont(Sys_Owner,14,1)%></span></div>
<div id="Layer21" style="position:absolute; left:<%=(110+leftpx)%>px; top:<%=985+toptpx-uppx%>px; width:750px; height:13px; z-index:14"><span class="style3"><%
...
<div id="Layer22" style="position:absolute; left:<%=(110+leftpx)%>px; top:<%=1010+toptpx-uppx%>px; width:40px; height:13px; z-index:15"><span class="style5"><%=Sys_IllegalDate(0)%></span></div>

<div id="Layer23" style="position:absolute; left:<%=(160+leftpx)%>px; top:<%=1010+toptpx-uppx%>px; width:40px; height:17px; z-index:16"><span class="style5"><%=Sys_IllegalDate(1)%></span></div>

<div id="Layer24" style="position:absolute; left:<%=(210+leftpx)%>px; top:<%=1010+toptpx-uppx%>px; width:40px; height:16px; z-index:17"><span class="style5"><%=Sys_IllegalDate(2)%></div>

<div id="Layer25" style="position:absolute; left:<%=(260+leftpx)%>px; top:<%=1010+toptpx-uppx%>px; width:40px; height:16px; z-index:18"><span class="style5"><%=right("00"&Sys_IllegalDate_h,2)%></span></div>

<div id="Layer26" style="position:absolute; left:<%=(310+leftpx)%>px; top:<%=1010+toptpx-uppx%>px; width:40px; height:13px; z-index:19"><span class="style5"><%=right("00"&Sys_IllegalDate_m,2)%></span></div>

<div id="Layer27" class="style5" style="position:absolute; left:<%=(390+leftpx)%>px; top:<%=1010+toptpx-uppx%>px; width:325px; height:31px; z-index:20"><%
...
%></div>
<div id="Layer28" style="position:absolute; left:<%=(110+leftpx)%>px; top:<%=1035+toptpx-uppx%>px; width:240px; height:15px; z-index:21"><span class="style5"><%=Sys_ILLEGALADDRESS%></span></div>
<div id="Layer29" style="position:absolute; left:<%=(120+leftpx)%>px; top:<%=1060+toptpx-uppx%>px; width:34px; height:11px; z-index:22"><span class="style3"><%=Sys_DealLineDate(0)%></span></div>
<div id="Layer30" style="position:absolute; left:<%=(190+leftpx)%>px; top:<%=1060+toptpx-uppx%>px; width:35px; height:13px; z-index:23"><span class="style3"><%=Sys_DealLineDate(1)%></span></div>
<div id="Layer31" style="position:absolute; left:<%=(265+leftpx)%>px; top:<%=1060+toptpx-uppx%>px; width:32px; height:15px; z-index:24"><span class="style3"><%=Sys_DealLineDate(2)%></span></div>
...
<div id="Layer32" style="position:absolute; left:<%=(400+leftpx)%>px; top:<%=1071+toptpx-uppx%>px; width:400px; height:49px; z-index:29"><span class="style3"><%
	...
	response.write "</font>"
%></span></div>
<div id="Layer33" style="position:absolute; left:<%=(380+leftpx)%>px; top:<%=1105+toptpx-uppx%>px; width:400px; height:30px; z-index:1"><%
...
%></div>
<div id="Layer34" style="position:absolute; left:<%=(625+leftpx)%>px; top:<%=1115+toptpx-uppx%>px; width:90px; height:30px; z-index:28"><span class="style2"><%=Sys_STATIONNAME%></span></font></div>


<div id="Layer35" style="position:absolute; left:<%=(400+leftpx)%>px; top:<%=1165+toptpx-uppx%>px; width:150px; height:49px; z-index:29"><%
...
%></div>
<div id="Layer36" style="position:absolute; left:<%=(575+leftpx)%>px; top:<%=1200+toptpx-uppx%>px; width:200px; height:43px; z-index:30"><%
...
'	end if
	...
	response.write "</table>"
%></div>
<div id="Layer37" style="position:absolute; left:<%=(575+leftpx)%>px; top:<%=1153+toptpx-uppx%>px; width:200px; height:46px; z-index:31"><%
...
%></div>
<div id="Layer38" style="position:absolute; left:265px; top:<%=1245+toptpx-uppx%>px; width:60px; height:10px; z-index:32"><span class="style3"><%=sys_Date(0)%></span></div>
<div id="Layer39" style="position:absolute; left:400px; top:<%=1245+toptpx-uppx%>px; width:60px; height:13px; z-index:33"><span class="style3"><%=sys_Date(1)%></span></div>
<div id="Layer40" style="position:absolute; left:530px; top:<%=1245+toptpx-uppx%>px; width:60px; height:11px; z-index:34"><span class="style3"><%=sys_Date(2)%></span></div>
<div id="Layer145" style="position:absolute; left:400px; top:<%=1265+toptpx-uppx%>px; width:150px; height:11px; z-index:37"><font size=2><%=Sys_CarColor%></font></div>
</div>
<%
