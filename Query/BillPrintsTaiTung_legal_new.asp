...
<div id="Layer06" class="style3" style="position:absolute; left:110px; top:309px; width:500px; z-index:1"><%
	'--------------------------------------如果是抓 戶籍補正的資料-----------------------------------------------------------------------------------------------------------
			if trim(Sys_BillTypeID)="1" then
...
<div id="Layer22" style="position:absolute; left:120px; top:1010px; width:50px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%></div>
