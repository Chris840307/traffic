...
fname=year(now)&fMnoth&fDay&"填單日_逕舉_舉發單資料.txt"
...
'					end if
				...
				if trim(rsfound("EquipMentID"))<>"-1" then
					...
					%>,<%'簽收/寄存日期
					response.write SingDate
					%>,<%'簽收人
					response.write SingMem
					%>,<%'簽收/寄存原因
