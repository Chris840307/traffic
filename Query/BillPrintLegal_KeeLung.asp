...
Sys_IllegalSpeed="":Sys_RuleSpeed="":Sys_Rule4="":Sys_Jurgeday=""
...
<div id="Layer32" style="position:absolute; left:400px; top:650px; width:400px; height:49px; z-index:29"><span class="style3"><%response.write "第"&left(trim(Sys_Rule1),2)&"條"
			...
			%></span></div>
<div id="Layer33" style="position:absolute; left:400px; top:675px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>
<div id="Layer34" style="position:absolute; left:640px; top:685px; width:90px; height:30px; z-index:28"><span class="style3"><%=Sys_STATIONNAME%></span></font></div>
...
<div id="Layer41" style="position:absolute; left:685px; top:820px; width:80px; height:12px; z-index:36"><span class="style7"><%
