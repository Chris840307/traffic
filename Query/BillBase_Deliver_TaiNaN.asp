...
<table width="650" border="0" cellspacing=0 cellpadding=0>
	<tr><th rowspan=2 valign="bottom" align="center" width="80%">
			...
			<strong><span class="style4">　　<%=thenPasserCity&"<br>　　"&replace(sysunit,trim(thenPasserCity),"")%>送達證書</span></strong>
		</th>
...
<br>應到案處所：<%=Sys_STATIONNAME%>　本證書送回地址：<%
