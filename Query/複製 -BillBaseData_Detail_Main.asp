...
<%	
	...
	strSQL="Select a.BillNo,a.Sn,a.CarNo,a.BillTypeID,a.Rule1,a.Rule2,a.Rule3,a.Rule4,a.MemberStation,a.EquipMentID" &_
		...
		",a.DealLineDate,a.Note,a.CarSimpleID,a.ImageFileName from BillBase a,BillBaseDciReturn b" &_
...
'			end if
			...
			if sys_City="高雄市" and trim(rs1("BillTypeID"))="1" then
...
<form name=myForm method="post">
	...
	<table width='100%' border='0' cellpadding="2">
		<tr>
			...
			if trim(rs1("RecordStateID"))="-1" and sys_City="高雄市" then
		...
		<tr>
			...
			If DciForfeit1<>"" And sys_City="高雄市" Then
...
<%if trim(rs1("Rule2"))<>"" and not isnull(rs1("Rule2")) then%>
		<tr>
			...
			If DciForfeit2<>"" And sys_City="高雄市" Then
...
<%if trim(rs1("Rule3"))<>"" and not isnull(rs1("Rule3")) then%>
		<tr>
			...
			If DciForfeit3<>"" And sys_City="高雄市" Then
...
<%End If %>
		...
		<tr>
			...
			<%if sys_City="高雄市" or sys_City="高雄縣" then%>	
				<tr>
...
<%
	...
	<hr>
<%if sys_City<>"高雄市" or trim(request("IsShow"))="1" then%>
	<table width='100%' border='0' cellpadding="2">
		<tr>
...
<Div id="Layer112" style="width:1041px; height:24px;">
  <div align="center">
  <%if sys_City<>"高雄市" or trim(Session("Credit_ID"))="A000000000" then%>
...
'NoCase=1 
if NoCase=1 and strSQLTemp2<>"" and sys_City="高雄市" then 
...
<table width='100%' border='0' cellpadding="2">
	...
	<table width='100%' border='0' cellpadding="2">
		<tr>
			...
			if trim(rs2("RecordStateID"))="-1" and sys_City="高雄市" then
...
<%if NoCase=0 then%>
  <%if sys_City="高雄市" and trim(request("IsShow"))<>"1" then%>
  <input type="button" value="顯示郵寄歷程" onclick="showMailHistory();">
 <%elseif sys_City="高雄市" and trim(request("IsShow"))="1" then%>
...
function DP(){
<%if sys_City="高雄市" and NoCase=0 then%>
