...
.style2 {font-family:"標楷體"; font-size: 18px; color:#ff0000; }
...
if trim(Sys_BillTypeID)="1" then
	...
	DelphiASPObj.GenBillPrintBarCode PBillSN(i),Sys_BillNo,Sys_Rule1,Sys_CarNo,Sys_MailNumber,"220073",Sys_OwnerZip,right(Sys_DealLineDate(0),2)&Sys_DealLineDate(1)&Sys_DealLineDate(2),Sys_StationID,"台北市交通事件裁決所",0,Sum_Level,0,True,False,Sys_MailDate,501,023,17
end if
...
<%else%>
<div id="Layer2" style="position:absolute; left:65px; top:35px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer3" style="position:absolute; left:185px; top:5px; width:202px; height:36px; z-index:5">V</div>
<%else%>
<div id="Layer4" style="position:absolute; left:185px; top:20px; width:202px; height:36px; z-index:5">V</div>
<%end if%>
...
<%end if%>>-->
<div id="Layer9" style="position:absolute; left:45px; top:50px; width:233px; height:36px; z-index:5"><%
	if showBarCode then
...
%></div>
<div id="Layer10" style="position:absolute; left:525px; top:50px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer11" style="position:absolute; left:485px; top:90px; width:230px; height:12px; z-index:7"><font size=1>　<%=BillPageUnit%>交字第<%=Sys_BillNo%>號</font></div>
<div id="Layer12" style="position:absolute; left:130px; top:125px; width:150px; height:11px; z-index:3"><font size=2>逕行舉發　<%=Sys_A_Name%><br>附採證照片　<%=Sys_CarColor%></font></div>
<div id="Layer13" style="position:absolute; left:285px; top:120px; width:28px; height:11px; z-index:3"><%=Sys_Sex%></div>
<div id="Layer14" style="position:absolute; left:395px; top:120px; width:370px; height:10px; z-index:4"><font size=2><%if showBarCode then response.write "*本單可至郵局或委託代收之超商繳納(7-11,全家,萊爾富,OK)"%></font></div>
<div id="Layer15" style="position:absolute; left:290px; top:155px; width:100px; height:10px; z-index:8"><%if trim(Sys_DriverBirth(0))<>"" then response.write Sys_DriverBirth(0)&"年"&Sys_DriverBirth(1)&"月"&Sys_DriverBirth(2)&"日"%></div>
<div id="Layer16" style="position:absolute; left:460px; top:155px; width:106px; height:13px; z-index:9"><%=Sys_DriverID%></div>
<div id="Layer17" style="position:absolute; left:655px; top:155px; width:99px; height:12px; z-index:10"><%=fastring%></div>
<div id="Layer18" style="position:absolute; left:130px; top:185px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer19" style="position:absolute; left:335px; top:185px; width:160px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer20" style="position:absolute; left:530px; top:185px; width:200px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,20,1)%></div>
<div id="Layer21" style="position:absolute; left:140px; top:215px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,20,1)%></div>

<div id="Layer22" style="position:absolute; left:130px; top:240px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer23" style="position:absolute; left:170px; top:240px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer24" style="position:absolute; left:210px; top:240px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer25" style="position:absolute; left:250px; top:240px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer26" style="position:absolute; left:290px; top:240px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
<div id="Layer27" style="position:absolute; left:450px; top:235px; width:620px; height:31px; z-index:20"><%
	...
	response.write "</font>"
%></div>
<div id="Layer28" style="position:absolute; left:130px; top:265px; width:267px; height:15px; z-index:21"><%=Sys_ILLEGALADDRESS%></div>
<div id="Layer29" style="position:absolute; left:130px; top:285px; width:50px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer30" style="position:absolute; left:170px; top:285px; width:50px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer31" style="position:absolute; left:210px; top:285px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
<div id="Layer32" style="position:absolute; left:450px; top:325px; width:400px; height:49px; z-index:29"><%
...
<div id="Layer34" style="position:absolute; left:440px; top:365px; width:70px; height:30px; z-index:29"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>

<div id="Layer33" style="position:absolute; left:500px; top:360px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>
<%if trim(sys_City)="彰化縣" then%>
<div id="Layer35" style="position:absolute; left:460px; top:420px; height:49px; z-index:28"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid; height:50px;"" border=""1"" cellspacing=0 cellpadding=0>"
	response.write "<tr><td style=""border-color:#ff0000;border-style:solid;"" align=""center""><span class=""style2"">交通警察隊</span><br><span class=""style1"">(04)7228037</span></td></tr>"
...
<div id="Layer36" style="position:absolute; left:580px; top:390px; width:160px; height:43px; z-index:30"><%
	...
	'response.write "</table>"
%></div>
<div id="Layer37" style="position:absolute; left:645px; top:420px; width:400px; height:46px; z-index:31"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid;"" width=""100"" border=""1"" cellspacing=0 cellpadding=0>"
	response.write "<tr><td style=""border-color:#ff0000;border-style:solid;"" height=25 align=""center""><span class=""style2"">警員</span><span class=""style2"">"&Sys_ChName&"</span></td></tr>"
	response.write "</table><font size=2>　　"&Sys_BillFillerMemberID&"</font>"
	'Response.Write Sys_BillFillerMemberID
%></div>
<%end if%>

<div id="Layer38" style="position:absolute; left:75px; top:465px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer39" style="position:absolute; left:115px; top:465px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer40" style="position:absolute; left:155px; top:465px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer41" style="position:absolute; left:195px; top:465px; width:120px; height:12px; z-index:36">填單　<%'=Sys_BillFillerMemberID%></div>


<%if showBarCode then%>
<div id="Layer42" style="position:absolute; left:70px; top:515px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
<div id="Layer43" style="position:absolute; left:70px; top:535px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer44" style="position:absolute; left:185px; top:525px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
	<div id="Layer45" style="position:absolute; left:185px; top:535px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
...
<div id="Layer50" style="position:absolute; left:45px; top:575px; width:202px; height:36px; z-index:5"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_3.jpg"""%>></div>
<div id="Layer51" style="position:absolute; left:525px; top:575px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer52" style="position:absolute; left:485px; top:615px; width:230px; height:12px; z-index:7"><font size=1>　<%=BillPageUnit%>交字第<%=Sys_BillNo%>號</font></div>
...
<div id="Layer59" style="position:absolute; left:130px; top:700px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer60" style="position:absolute; left:335px; top:700px; width:117px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer61" style="position:absolute; left:530px; top:700px; width:220px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,22,1)%></div>
<div id="Layer62" style="position:absolute; left:130px; top:725px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&funcCheckFont(Sys_OwnerZipName&Sys_OwnerAddress,22,1)%></div>

<div id="Layer63" style="position:absolute; left:130px; top:755px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer64" style="position:absolute; left:170px; top:755px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer65" style="position:absolute; left:210px; top:755px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer66" style="position:absolute; left:250px; top:755px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer67" style="position:absolute; left:290px; top:755px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
<div id="Layer68" style="position:absolute; left:450px; top:755px; width:620px; height:31px; z-index:20"><%
	response.write "<font size=2>"
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer69" style="position:absolute; left:130px; top:780px; width:280px; height:15px; z-index:21"><%=Sys_ILLEGALADDRESS%></div>
...
<div id="Layer73" style="position:absolute; left:450px; top:840px; width:400px; height:49px; z-index:29"><%
	Response.Write "<font size='1'>"
	Response.Write "　　　　　道 路 交 通 管 理 處 罰 條 例<br>"
	response.write "第"&left(trim(Sys_Rule1),2)&"條"
	if len(trim(Sys_Rule1))>7 then response.write "之"&right(trim(Sys_Rule1),1)
	...
	response.write "</font>"
%></div>
<div id="Layer75" style="position:absolute; left:440px; top:885px; width:70px; height:30px; z-index:29"><font size=2><%=Sys_STATIONNAME&"<br>"&Sys_StationTel%></font></div>
<div id="Layer74" style="position:absolute; left:500px; top:875px; width:400px; height:30px; z-index:28"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_5.jpg"""%>></div>
<%if trim(sys_City)="彰化縣" then%>
<div id="Layer76" style="position:absolute; left:460px; top:940px; height:49px; z-index:29"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid; height:50px;"" border=""1"" cellspacing=0 cellpadding=0>"
	response.write "<tr><td style=""border-color:#ff0000;border-style:solid;"" align=""center""><span class=""style2"">交通警察隊</span><br><span class=""style1"">(04)7228037</span></td></tr>"
	response.write "</table>"
%></div>
<div id="Layer82" style="position:absolute; left:150px; top:890px; width:250px; height:43px; z-index:30"><%

	If sys_Date(0)&sys_Date(1)&sys_Date(2) > 1080101 Then		
		response.write "<img src=""../Member/Picture/chcgImage1080103_2.jpg"" width=""100"">"
	else
		response.write "<img src=""../Member/Picture/chcgImage1071231.jpg"" width=""100"">"
	End if 
%></div>
<div id="Layer77" style="position:absolute; left:645px; top:940px; width:400px; height:46px; z-index:31"><%
...
%></div>
<%end if%>
<div id="Layer78" style="position:absolute; left:75px; top:980px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer79" style="position:absolute; left:115px; top:980px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer80" style="position:absolute; left:155px; top:980px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer81" style="position:absolute; left:195px; top:980px; width:120px; height:12px; z-index:36">填單　<%'=Sys_BillFillerMemberID%></div>
</div>
<%
