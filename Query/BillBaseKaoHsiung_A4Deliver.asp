...
<table width="650" border="0" cellspacing=0 cellpadding=0>
	...
	<tr><th valign="bottom" align="left" class="style1" nowrap>
			序　　號：<%response.Write Sys_LoginID &" - "& i+1%>
		</th>
	</tr>
</table>
...
<span class="style1"><strong>※請繳回<%=thenPasserCity&sysunit%>　應到案處所：<%=Sys_STATIONNAME%> 　操作人員：<%=Sys_BillFillerMemberID%><br>本證書送回地址：<%=SysUnitAddress%></strong>
