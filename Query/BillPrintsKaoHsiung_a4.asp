...
for y=0 to ubound(Sys_CarColorID)
	...
	rscolor.close
Next
'把註解拿掉 Sys_MailNumber出現的值都是0 20090914 嘉輝
Sys_MailNumber=0
Sys_MailDate=0
...
<div id="Layer12" style="position:absolute; font-size:16px; left:125px; top:110px; width:250px; height:30px; z-index:3"><font size=2>逕行舉發　<%=Sys_A_Name%><br><%if left(Sys_BillNo,2)<>"NR" then response.write "附採證照片"%>　<%=Sys_CarColor%></font></div>
...
<div id="Layer29" style="position:absolute; font-size:16px; left:125px; top:265px; width:50px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer30" style="position:absolute; font-size:16px; left:175px; top:265px; width:50px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
...
<div id="Layer46" style="position:absolute; font-size:14px; left:440px; top:600px; width:507px; height:13px; z-index:14"><font size=3><%=BillPageUnit%>交字第<%=Sys_BillNo%>號</font></div>
...
<div id="Layer50" style="position:absolute; font-size:14px; left:160px; top:770px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&"<br>"&funcCheckFont(Sys_OwnerZipName&Sys_OwnerAddress,22,1)%></div>

<div id="Layer51" style="position:absolute; font-size:14px; left:160px; top:810px; width:251px; height:17px; z-index:13"><%=onderline(funcCheckFont(Sys_Owner,22,1))%></div>

<div id="Layer52" style="position:absolute; font-size:14px; left:480px; top:810px; width:251px; height:17px; z-index:13">收　大宗掛號碼</div>
...
<div id="Layer54" style="position:absolute; font-size:14px; left:400px; top:850px; z-index:13"><%
'If trim(Session("Unit_ID"))="08A7" Or trim(Session("Unit_ID"))="8J00" Then 
'response.write "<img src=""../BarCodeImage/"&Sys_MAILCHKNUMBER&".jpg"">"
'End if
%></div>
