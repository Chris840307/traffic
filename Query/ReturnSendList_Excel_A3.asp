...
%>		
	...
	<td align="center" height="28" colspan="2"><span class="style4"><%
		...
		if trim(StationCnt(SA2))="0" then
			...
			pagecnt=fix(Cint(trim(StationCntTaipei))/40+0.9999999)
		end if
	%></span></td>
	</tr>
	<tr>
	...
	Page <%=fix(PrintSN/40)+1%> of <%=pagecnt%></td></td>
	</tr>
	</table>
...
%>		
	...
	<td align="center" height="28" colspan="2"><span class="style4"><%
		...
		if trim(StationCnt(SA2))="0" then
			...
			pagecnt=fix(Cint(trim(StationCntKS))/40+0.9999999)
		end if
	%></span></td>
	</tr>
	<tr>
...
%>		
	...
	<td align="center" height="28" colspan="2"><span class="style4"><%
		...
		if trim(StationCnt(SA2))="0" then
			...
			pagecnt=fix(Cint(trim(StationCnt(SA2)))/40+0.9999999)
		end if
	%></span></td>
	</tr>
	<tr>
