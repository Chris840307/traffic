...
<div id="Layer20" style="position:absolute; left:385px; top:<%=pagesum+175%>px; width:251px; height:17px; z-index:13"><%=chstr(Sys_Owner)%></div>
<div id="Layer21" style="position:absolute; left:50px; top:<%=pagesum+195%>px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&chstr(Sys_OwnerZipName&Sys_OwnerAddress)%></div>
...
<div id="Layer35" style="position:absolute; left:380px; top:<%=pagesum+405%>px; width:100px; height:49px; z-index:29"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
	response.write "<tr><td style=""border-color:#ff0000;border-style:solid;"" height=40 align=""center"" nowrap><span class=""style10"">"&Sys_UnitName&"</span><br><span class=""style10"">"&Sys_UnitTEL&"</span></td></tr>"
...
<table width="645" height="393" border="0">
  ...
  <tr>
	...
	<%if trim(Sys_BillTypeID)="1" then%>
    <th align="left" colspan="2"><span class="style8"><%=chstr(Sys_Driver)%>　台啟</span></th>
	<%elseif trim(Sys_BillTypeID)="2" then%>
	<th align="left"><span class="style8"><%=chstr(Sys_Owner)%>　台啟</span></th>
	<%end if%>
	<td align="left" valign="top"></td>
  </tr>
  <tr>
...
<div id="Layer43" style="position:absolute; left:310px; top:<%=pagesum+1090%>px; width:200px; height:12px; z-index:36"><%=SysUnit%></div>
<div id="Layer44" style="position:absolute; left:155px; top:<%=pagesum+1107%>px; width:350px; height:12px; z-index:36"><%
...
<div id="Layer45" style="position:absolute; left:210px; top:<%=pagesum+1147%>px; width:280px; height:12px; z-index:36"><%=Sys_BillNo%></div>
<div id="Layer46" style="position:absolute; left:300px; top:<%=pagesum+1137%>px; width:200px; height:32px; z-index:6"><img src=<%="""..\BarCodeImage\"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer47" style="position:absolute; left:65px; top:<%=pagesum+1590%>px; width:500px; height:12px; z-index:36"><%=SysAddress%></div>
<%
