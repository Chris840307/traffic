...
<div id="Layer1" style="position:absolute; left:60px; top:50px; z-index:5">
<%
...
<div id="Layer2" class="style3" style="position:absolute; left:250px; top:50px; width:350px; height:36px; z-index:5"><%
If not ifnull(request("Sys_UnitLabelKind")) Then
	response.write "<b>"&Sys_BillUnitAddress&"<br>"&Sys_BillUnitName&"</b>"
End if%>
</div>

<div id="Layer2" style="position:absolute; left:250px; top:100px; width:350px; height:36px; z-index:5"><%
...
<div id="Layer3" style="position:absolute; left:320px; top:155px; z-index:5"><%
...
<div id="Layer4" style="position:absolute; left:300px; top:185px; z-index:5"><%
	'If trim(Session("UnitLevelID"))="1" Then
	Response.Write "<span class=""style3"">"
...
<div id="Layer5" style="position:absolute; left:60px; top:210px; z-index:5"><%
	Response.Write "<span class=""style3"">"
...
<div id="Layer5" style="position:absolute; left:550px; top:190px; z-index:5"><%
...
<%end if%>
-->
<div id="Layer9" style="position:absolute; left:30px; top:825px; width:202px; height:36px; z-index:5"><%
	if showBarCode then
...
%></div>
<div id="Layer10" style="position:absolute; left:520px; top:820px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
...
<div id="Layer18" style="position:absolute; left:120px; top:950px; width:100px; height:14px; z-index:11"><span class="style7"><%=Sys_CarNo%></span></div>
<div id="Layer19" style="position:absolute; left:310px; top:950px; width:117px; height:20px; z-index:12"><span class="style7"><%=Sys_DCIRETURNCARTYPE%></span></div>
<div id="Layer20" style="position:absolute; left:580px; top:950px; width:201px; height:17px; z-index:13"><span class="style3"><%=funcCheckFont(Sys_Owner,22,1)%></span></div>
<div id="Layer21" style="position:absolute; left:170px; top:980px; width:507px; height:13px; z-index:14"><span class="style7"><%=Sys_OwnerZip&" "&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,22,1)%></span></div>

<div id="Layer22" style="position:absolute; left:125px; top:1005px; width:40px; height:13px; z-index:15"><span class="style7"><%=Sys_IllegalDate(0)%></span></div>
...
<div id="Layer25" style="position:absolute; left:280px; top:1005px; width:40px; height:16px; z-index:18"><span class="style7"><%=right("00"&Sys_IllegalDate_h,2)%></span></div>
<div id="Layer26" style="position:absolute; left:340px; top:1005px; width:40px; height:13px; z-index:19"><span class="style7"><%=right("00"&Sys_IllegalDate_m,2)%></span></div>
<div id="Layer27" style="position:absolute; left:430px; top:1010px; width:300px; height:31px; z-index:20"><span class="style3"><%
...
<div id="Layer29" style="position:absolute; left:130px; top:1050px; width:34px; height:11px; z-index:22"><span class="style7"><%=Sys_DealLineDate(0)%></span></div>
<div id="Layer30" style="position:absolute; left:230px; top:1050px; width:35px; height:13px; z-index:23"><span class="style7"><%=Sys_DealLineDate(1)%></span></div>
<div id="Layer31" style="position:absolute; left:320px; top:1050px; width:32px; height:15px; z-index:24"><span class="style7"><%=Sys_DealLineDate(2)%></span></div>
<div id="Layer32" style="position:absolute; left:425px; top:1085px; width:400px; height:49px; z-index:29"><span class="style4"><%response.write "第"&left(trim(Sys_Rule1),2)&"條"
			...
			%></span></div>
<div id="Layer33" style="position:absolute; left:420px; top:1130px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>
<div id="Layer34" style="position:absolute; left:665px; top:1145px; width:80px; height:30px; z-index:28"><span class="style3"><%=Sys_STATIONNAME%></span></font></div>
...
'			response.write "<img src=""../Member/Picture/"&Sys_MemberFilename&""" width=""90"" height=""30"">"d
'		else
'			response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
...
<div id="Layer38" style="position:absolute; left:135px; top:1242px; width:60px; height:10px; z-index:32"><span class="style7"><%=sys_Date(0)%></span></div>
<div id="Layer39" style="position:absolute; left:195px; top:1242px; width:60px; height:13px; z-index:33"><span class="style7"><%=sys_Date(1)%></span></div>
<div id="Layer40" style="position:absolute; left:255px; top:1242px; width:60px; height:11px; z-index:34"><span class="style7"><%=sys_Date(2)%></span></div>
<div id="Layer41" style="position:absolute; left:300px; top:1242px; width:80px; height:12px; z-index:36"><span class="style7"><%
