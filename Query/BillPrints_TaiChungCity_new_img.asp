...
<%end if%>
<%if showBarCode then%>
<div id="Layer1" style="position:absolute; left:50px; top:790px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
<div id="Layer2" style="position:absolute; left:50px; top:820px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>
<!--
<%if trim(Sys_BillTypeID)="1" then%>
...
%></div>
<div id="Layer10" style="position:absolute; left:500px; top:845px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
...
<div id="Layer144" style="position:absolute; left:130px; top:910px; width:150px; height:11px; z-index:3"><%
...
<div id="Layer18" style="position:absolute; left:115px; top:950px; width:100px; height:14px; z-index:11"><span class="style7"><%=Sys_CarNo%></span></div>
<div id="Layer19" style="position:absolute; left:265px; top:950px; width:117px; height:20px; z-index:12"><span class="style7"><%=Sys_DCIRETURNCARTYPE%></span></div>
<div id="Layer20" style="position:absolute; left:500px; top:950px; width:201px; height:17px; z-index:13"><span class="style3"><%=funcCheckFont(Sys_Owner,22,1)%></span></div>
<div id="Layer21" style="position:absolute; left:115px; top:975px; width:507px; height:13px; z-index:14"><span class="style7"><%=Sys_OwnerZip&" "&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,22,1)%></span></div>

<div id="Layer22" style="position:absolute; left:125px; top:995px; width:40px; height:13px; z-index:15"><span class="style7"><%=Sys_IllegalDate(0)%></span></div>
<div id="Layer23" style="position:absolute; left:175px; top:995px; width:40px; height:17px; z-index:16"><span class="style7"><%=Sys_IllegalDate(1)%></span></div>
<div id="Layer24" style="position:absolute; left:215px; top:995px; width:40px; height:16px; z-index:17"><span class="style7"><%=Sys_IllegalDate(2)%></div>
<div id="Layer25" style="position:absolute; left:265px; top:995px; width:40px; height:16px; z-index:18"><span class="style7"><%=right("00"&Sys_IllegalDate_h,2)%></span></div>
<div id="Layer26" style="position:absolute; left:315px; top:995px; width:40px; height:13px; z-index:19"><span class="style7"><%=right("00"&Sys_IllegalDate_m,2)%></span></div>
<div id="Layer27" style="position:absolute; left:395px; top:1000px; width:600px; height:31px; z-index:20"><span class="style3"><%
...
%></span></div>
<div id="Layer28" style="position:absolute; left:115px; top:1020px; width:217px; height:15px; z-index:21"><span class="style3"><%=Sys_ILLEGALADDRESS%></span></div>
<div id="Layer29" style="position:absolute; left:145px; top:1050px; width:34px; height:11px; z-index:22"><span class="style7"><%=Sys_DealLineDate(0)%></span></div>
<div id="Layer30" style="position:absolute; left:225px; top:1050px; width:35px; height:13px; z-index:23"><span class="style7"><%=Sys_DealLineDate(1)%></span></div>
<div id="Layer31" style="position:absolute; left:295px; top:1050px; width:32px; height:15px; z-index:24"><span class="style7"><%=Sys_DealLineDate(2)%></span></div>
<div id="Layer32" style="position:absolute; left:410px; top:1060px; width:400px; height:49px; z-index:29"><span class="style7"><%
...
<div id="Layer35" style="position:absolute; left:405px; top:1165px; width:150px; height:49px; z-index:29"><%
...
%></div>
<div id="Layer36" style="position:absolute; left:600px; top:1190px; width:150px; height:43px; z-index:30"><%
	response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
	...
	response.write "</table>"
%></div>
<div id="Layer37" style="position:absolute; left:600px; top:1140px; width:200px; height:46px; z-index:31"><%
...
%></div>
<div id="Layer38" style="position:absolute; left:265px; top:1232px; width:60px; height:10px; z-index:32"><span class="style7"><%=sys_Date(0)%></span></div>
<div id="Layer39" style="position:absolute; left:400px; top:1232px; width:60px; height:13px; z-index:33"><span class="style7"><%=sys_Date(1)%></span></div>
<div id="Layer40" style="position:absolute; left:530px; top:1232px; width:60px; height:11px; z-index:34"><span class="style7"><%=sys_Date(2)%></span></div>
<div id="Layer41" style="position:absolute; left:660px; top:1232px; width:80px; height:12px; z-index:36"><span class="style7"></span></div>
<div id="Layer145" style="position:absolute; left:400px; top:1260px; width:150px; height:11px; z-index:37"><font size=2><%=Sys_CarColor%></font></div>
</div>
<%
