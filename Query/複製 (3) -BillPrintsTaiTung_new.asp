...
<div id="Layer05" class="style3" style="position:absolute; left:505px; top:287px; z-index:1">
...
<div id="Layer14" style="position:absolute; left:370px; top:915px; width:324px; height:10px; z-index:4"><%response.write "*本單可至郵局或委託代收之超商繳納"%></div>
...
<div id="Layer25" style="position:absolute; left:270px; top:1010px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%></div>
<div id="Layer26" style="position:absolute; left:320px; top:1010px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%></div>
...
<div id="Layer32" style="position:absolute; left:415px; top:1075px; width:400px; height:49px; z-index:29"><%
