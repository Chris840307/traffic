...
if Not rsfound.eof then
	...
	if ifnull(Sys_OwnerAddress) then
		strSql="select DriverHomeAddress,DriverHomeZip from BillbaseDCIReturn where Carno in(select carno from dcilog where BillSN="&trim(rsbil("BillSN"))&" and ExchangetypeID='A' and dcireturnstatusid='S') and ExchangetypeID='A' and DCIReturnCarStatus<>'1301'"
...
<div id="Layer04" class="style3" style="position:absolute; left:125px; top:290px; z-index:1"><%
	if trim(Sys_BillTypeID)="1" then
...
<div id="Layer06" class="style3" style="position:absolute; left:105px; top:310px; width:370px; z-index:1"><%
	'--------------------------------------如果是抓 戶籍補正的資料-----------------------------------------------------------------------------------------------------------
			if trim(Sys_BillTypeID)="1" then
...
<div id="Layer45" class="style3" style="position:absolute; left:105px; top:315px; width:330px; z-index:1"><b><%
	
Response.Write "<br>南投縣政府警察局"&title_unit
	%></b>
</div>

<div id="Layer47" class="style3" style="position:absolute; left:65px; top:355px; width:330px; z-index:1"><b><%
...
<div id="Layer07" class="style3" style="position:absolute; left:90px; top:390px; z-index:1"><%
