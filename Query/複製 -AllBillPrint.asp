...
'		end if
		...
		if Instr(request("Sys_BatchNumber"),"N")>0 then
			...
			If sys_City<>"基隆市" and sys_City<>"高雄縣" and sys_City<>"宜蘭縣" then
...
<table width="100%" border="0">
	<tr height="30">
		...
		<%If sys_City = "宜蘭縣" or sys_City = "台東縣" Then%>
			<a href="../PrintLegal.exe.txt"><span class="pagetitle">舉發單下載</span></a>
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
				<tr>
					<td nowrap>
						...
						<br>
						舉發單號
						<input name="Sys_BillNo1" id="Sys_BillNo1" type="text" class="btn1" value="<%=UCase(request("Sys_BillNo1"))%>" size="14" maxlength="9">
						~
	...
	<tr>
		...
		<br><!-- titan測試用 -->
			<%if sys_City<>"高雄市" and sys_City<>"保二總隊四大隊二中隊" then %>
			...
			<%elseif sys_City="高雄市" and Session("UnitLevelID") =1 then %>
				...
				<br>
				<input type="button" name="btnprint" value="測試 違規通知單(新版)" onclick="funBillNoPrint(29);"  style="width: 207px; height: 27px;">
				<br>
				<input type="button" name="btnprint" value="測試 違規通知單(新版不含照片)" onclick="funBillNoPrint(31);"  style="width: 207px; height: 27px;">
				<!--
				<br>
...
<!--
		...
		<%If sys_City<>"高雄市" and sys_City<>"高港局" and sys_City <> "保二總隊四大隊二中隊" then%>
