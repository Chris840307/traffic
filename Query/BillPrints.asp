...
<table width="645" height="393" border="0">
  ...
  <tr>
    <td rowspan=2 height="41" align="left" valign="top"><%
		...
		End if%>　　　　<img src=<%="""../BarCodeImage/"&Sys_BillNo&"_1.jpg"""%> hspace="0" vspace="0" align="top"><br>　　　　<span class="style7"><%=Sys_FirstBarCode%></span>
	</td>
	<%if trim(Sys_BillTypeID)="1" then%>
...
<div id="Layer6" style="position:absolute; left:30px; top:765px; width:400px; height:36px; z-index:5"><span class="style7">查詢電話：<%=Sys_BillUnitTel%><%'=Sys_UnitTel%>（<%=DB_UnitName%><%'=Sys_UnitName%>）</span></div>
...
%></div>
<div id="Layer10" style="position:absolute; left:520px; top:860px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
...
<%end if%>
<div id="Layer18" style="position:absolute; left:120px; top:960px; width:100px; height:14px; z-index:11"><span class="style7"><%=Sys_CarNo%></span></div>
<div id="Layer19" style="position:absolute; left:270px; top:960px; width:117px; height:20px; z-index:12"><span class="style7"><%=Sys_DCIRETURNCARTYPE%></span></div>
...
<div id="Layer21" style="position:absolute; left:120px; top:985px; width:507px; height:13px; z-index:14"><span class="style7"><%=Sys_OwnerZip&" "&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,22,1)%></span></div>

<div id="Layer22" style="position:absolute; left:110px; top:1005px; width:40px; height:13px; z-index:15"><span class="style7"><%=Sys_IllegalDate(0)%></span></div>
<div id="Layer23" style="position:absolute; left:160px; top:1005px; width:40px; height:17px; z-index:16"><span class="style7"><%=Sys_IllegalDate(1)%></span></div>
...
<div id="Layer25" style="position:absolute; left:255px; top:1005px; width:40px; height:16px; z-index:18"><span class="style7"><%=right("00"&Sys_IllegalDate_h,2)%></span></div>
<div id="Layer26" style="position:absolute; left:305px; top:1005px; width:40px; height:13px; z-index:19"><span class="style7"><%=right("00"&Sys_IllegalDate_m,2)%></span></div>
<div id="Layer27" style="position:absolute; left:390px; top:1015px; width:600px; height:31px; z-index:20"><span class="<%
...
%></span></div>
<div id="Layer28" style="position:absolute; left:110px; top:1030px; width:217px; height:15px; z-index:21"><span class="style3"><%=Sys_ILLEGALADDRESS%></span></div>
<div id="Layer29" style="position:absolute; left:130px; top:1060px; width:34px; height:11px; z-index:22"><span class="style7"><%=Sys_DealLineDate(0)%></span></div>
...
<div id="Layer32" style="position:absolute; left:385px; top:1080px; width:400px; height:49px; z-index:29"><span class="style3"><%response.write "第"&left(trim(Sys_Rule1),2)&"條"
			...
			%></span></div>
<div id="Layer33" style="position:absolute; left:375px; top:1110px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>
<div id="Layer34" style="position:absolute; left:620px; top:1110px; width:80px; height:30px; z-index:28"><span class="style3"><%=Sys_STATIONNAME%></span></font></div>
...
'	response.write "<table style=""border-color:#ff0000;border-style:solid;"" border=""1"" cellspacing=0 cellpadding=0>"
'	if Session("Unit_ID") <>"0207" and Session("Unit_ID") <>"0230" then 
...
'	response.write "</table>"
%></div>
<div id="Layer37" style="position:absolute; left:600px; top:1190px; width:200px; height:46px; z-index:31"><%
'	if Session("Unit_ID") <>"0207" and Session("Unit_ID") <>"0230" then 
