...
<div class="Noprint">
<Center>
<input type="button" name="btnSelt" value="舉發單列印" onClick='funPrint();'>
</center>
</div>
<%
...
<script language="javascript">
	function funPrint(){
		window.focus();
		//ButprintWindow(true,5.08,5.08,5.08,5.08);
		if(confirm("是否要列印舉發單?")){
			UrlStr="BillPrintsKaoHsiung_a4_Main.asp";
