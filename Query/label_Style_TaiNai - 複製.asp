...
%>
	...
	<table border="0" width="80%" id="table1" cellspacing="0" cellpadding="0">
		<tr>
			<td height="100" width="60%"><p align="center">&nbsp;</td>
			<tr>
    ...
    <td>
	    	...
	    	<tr>
			<td height="120" align="left" valign="top" colspan="2"><%=SpaceInt(10)%>
				<font face="標楷體" size="5"><%
...
'-------------------------------------------------------------------------------------
	%>
		...
		<table border="0" width="80%" id="table1" cellspacing="0" cellpadding="0">
		<tr>
					<td height="100" width="60%" colspan="2"><p align="center">&nbsp;</td>
			<tr>
					<td height="100" width="60%" colspan="2"><br><br><p align="center">--------------------------------------------------------------------------------------------------------------</td>
			<tr>
					<td height="100" width="60%"colspan="2"><p align="center">&nbsp;</td>
			<tr>
					<td height="100" colspan="2"><p align="center">&nbsp;</td>
			<tr>
