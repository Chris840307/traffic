...
if trim(request("kinds"))="SafeKeeping" then
	...
	strSafe="select a.SN,a.IllegalDate,a.BillTypeID,a.BillNo,a.CarNo,a.BillUnitID,a.BillStatus,a.RecordStateID,a.RecordDate,a.RecordMemberID,c.UserMarkResonID,c.StoreAndSendReturnResonID,c.UserMarkDate,c.StoreAndSendMailReturnDate from BillBase a,MemberData b,BillMailHistory c where a.RecordMemberID=b.MemberID and c.BillSN=a.SN and c.UserMarkResonID in ('5','6','7','T')"&strwhere&" order by c.UserMarkDate"
		...
		<td bgcolor="#E0E0E0">
			<table width="100%" border="0" cellpadding="4" cellspacing="1">
				<tr bgcolor="#EBFBE3" align="center">
					...
					<th width="10%">法條</th>
					<!-- <th width="8%">DCI</th> -->
					<th width="20%"><%if sys_City="高雄縣" or sys_City="高雄市" Or sys_City=ApconfigureCityName then%>送達日期，<%end if%>送達原因，註記日期</th>
				</tr>
