...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<form name="myForm" method="post">  
		<table width='400' border='1' align="center" cellpadding="1">
			<tr bgcolor="#FFCC33">
				<td colspan="2" height="27"><strong>舉發單綜合查詢</strong></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="IllegalDate" type="text" value="" size="8" maxlength="7" >
					<input type="button" name="datestr" value="..." onclick="OpenWindow('IllegalDate');">
					~
					<input name="IllegalDate1" type="text" value="" size="8" maxlength="7" >
					<input type="button" name="datestr" value="..." onclick="OpenWindow('IllegalDate1');">
				</td>
			</tr>
			<tr>
				<td bgcolor="#FFFFCC" align="right">掛號碼查詢</td>
				<td>
					<input type="text" name="MailNo" size="12" value="">
				</td>
			</tr>
			<tr>
...
function SelectBillData(){
	if (myForm.BillNo.value=="" && myForm.CarNo.value=="" && myForm.illFID.value=="" && myForm.illName.value=="" && myForm.IllegalDate.value=="" && myForm.IllegalDate1.value=="" && myForm.MailNo.value==""){
		alert("請至少輸入任一項查詢條件！");
	}else{
...
function ChangeBillType(){
	if (myForm.BillType.value=="B"){
		...
		myForm.CarNo.value="※※※※※※";
		myForm.MailNo.disabled=true;
		myForm.MailNo.value="※※※※※※";
	}else{
		myForm.CarNo.disabled=false;
		myForm.CarNo.value="";
		myForm.MailNo.disabled=false;
		myForm.MailNo.value="";
	}
}
</script>
