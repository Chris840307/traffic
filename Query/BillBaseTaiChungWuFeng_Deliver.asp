...
<div id="Layer1" style="position:absolute; left:460px; top:0px; width:150px; height:36px; z-index:5"><img src=<%="""../BarCodeImage/"&Sys_BillNo_BarCode&".jpg"""%>>
</div>
...
<div id="Layer4" class="style4" style="position:absolute; left:100px; top:70px; width:320px; height:36px; z-index:5"><%
...
<div id="Layer5" class="style4" style="position:absolute; left:200px; top:125px; width:150px; height:36px; z-index:5"><%=Sys_BillNo%>
</div>
<div id="Layer6" class="style4" style="position:absolute; left:215px; top:140px; width:60px; height:36px; z-index:5"><%
	response.write left(trim(Sys_Rule1),2)'條
	if len(trim(Sys_Rule1))>7 then response.write "之"&right(trim(Sys_Rule1),1)%>
</div>
<div id="Layer7" class="style4" style="position:absolute; left:265px; top:140px; width:20px; height:36px; z-index:5"><%response.write Mid(trim(Sys_Rule1),3,1)'項%>
</div>
<div id="Layer8" class="style4" style="position:absolute; left:310px; top:140px; width:20px; height:36px; z-index:5"><%response.write Mid(trim(Sys_Rule1),4,2)'款%>
</div>
<!--
<div id="Layer9" class="style4" style="position:absolute; left:360px; top:140px; width:20px; height:36px; z-index:5"><%response.write Mid(trim(Sys_Rule2),6,2)%>
-->
</div><%
if trim(Sys_Rule2)<>"0" then
	response.write "<div id=""Layer10"" class=""style4"" style=""position:absolute; left:215px; top:"& 160+490*(i) &"px; width:60px; height:36px; z-index:5"">"&left(trim(Sys_Rule2),2)'條
	if len(trim(Sys_Rule2))>7 then response.write "之"&right(trim(Sys_Rule2),1)
	response.write "a</div>"

	response.write "<div id=""Layer11"" class=""style4"" style=""position:absolute; left:265px; top:"& 160+490*(i) &"px; width:20px; height:36px; z-index:5"">"&Mid(trim(Sys_Rule2),3,1)&"b</div>"'項"

	response.write "<div id=""Layer12"" class=""style4"" style=""position:absolute; left:310px; top:"& 160+490*(i) &"px; width:20px; height:36px; z-index:5"">"&Mid(trim(Sys_Rule2),4,2)&"c</div>"'款"

	response.write "<div id=""Layer13"" class=""style4"" style=""position:absolute; left:350px; top:"& 160+490*(i) &"px; width:20px; height:36px; z-index:5"">"&Mid(trim(Sys_Rule2),6,2)&"d</div>"
end if%>
