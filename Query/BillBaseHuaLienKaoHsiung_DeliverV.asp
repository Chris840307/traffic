...
<br><br><%response.write wordporss2(chstr(tempdd),chstr(i+1))%>
 <%response.Write "<br>：：<br>期號 <br>日&nbsp;&nbsp;&nbsp;&nbsp;<br>單&nbsp;&nbsp;&nbsp;&nbsp;<br>填序"%>
      <br>&nbsp;
      <br>&nbsp;
	  <br>&nbsp;
	  <br>&nbsp;
      <br><span class="style5"><%=wordporss(chstr(thenPasserCity&replace(sysunit,trim(thenPasserCity),"")))%></span></th>
	  </table>
</table>
...
<th align="center" valign="bottom" bordercolor="#FFFFFF" class="style5">
    ...
    <td align="center" valign="bottom" bordercolor="#FFFFFF" class="style4">
	  <%=wordporss(chstr(SysUnitAddress))%><br>
      ：
      <br>地 <br>
        址 <br>
        回 <br>
