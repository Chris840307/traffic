        ...
        <table width="100%"   border='1' cellpadding="2" style="border-top-style: groove; border-right-style: groove; border-left-style: groove; border-bottom-style: groove" >
           ...
           <tr>
			...
			<tr>
			   ...
			   <td style="width: 15%" colspan="9">
			        <%=ReplaceSpace(SetchinaDate(trim(returnrs("rin_dt"))))%>
			   </td>
			   <td  style="width: 10%" colspan="6" bgcolor="#FFFF99" align="center"  height="35">
			        <b>操&nbsp;作&nbsp;人&nbsp;員</b>     
			   </td>
...
'response.end
strTmp="select * from PEO_Rec where tkt_no=" & QuotedStr(request("BillNo"))
...
%>            
		...
		<table border="1">
			<tr>
				<td  style="bgcolor="#FFFF99" align="left"  height="20">
					<b>違規影像</b>
				</td>
			</tr>
			<tr>
				<td>
					<%
					   ...
					   if len(trim(rs1("vil_dt")))=6 then					
					
						for i=1 to 2		
								
							'imageurl = imageserver+mid(rs1("vil_dt"),1,2) &"/"& mid(rs1("vil_dt"),3,2)&"/"& mid(rs1("vil_dt"),5,2)+"/"+ReplaceSpace(rs1("tkt_no")) & i & "V.jpg"
							imageurlb = "F:\vil_recnew\"+mid(rs1("vil_dt"),1,2) &"\"& mid(rs1("vil_dt"),3,2)&"\"& mid(rs1("vil_dt"),5,2)+"\"+ReplaceSpace(rs1("tkt_no")) & i & "V.jpg"
							'imageurlb = Server.MapPath(imageurl)
							'response.write imageurlb 
							imageurl="http://10.133.2.169/oldimage1/"+mid(rs1("vil_dt"),1,2) &"\"& mid(rs1("vil_dt"),3,2)&"\"& mid(rs1("vil_dt"),5,2)+"\"+ReplaceSpace(rs1("tkt_no")) & i & "V.jpg"
							if HaveFile(imageurlb)="1" then			
			...
			<tr>
				<td  style="width: 10%" colspan="50" bgcolor="#FFFF99" align="center"  height="20">
					<b>送達證書</b>
				</td>
			</tr>
			<tr>
				<td  style="width: 10%" colspan="50" bgcolor="#FFFF99" align="center">
					<%
					if len(trim(rs1("vil_dt")))=6 then
						
						
						for i=1 to 1
							imageurlc = "F:\ret_recnew\"+mid(rs1("vil_dt"),1,2) &"\"& mid(rs1("vil_dt"),3,2)&"\"& mid(rs1("vil_dt"),5,2)+"\"+ReplaceSpace(rs1("tkt_no")) & i & "S.bmp"
							'imageurlb = Server.MapPath(imageurl)

							if HaveFile(imageurlc)="1" then
								imageurl="http://10.133.2.169/oldimage2/"+mid(rs1("vil_dt"),1,2) &"\"& mid(rs1("vil_dt"),3,2)&"\"& mid(rs1("vil_dt"),5,2)+"\"+ReplaceSpace(rs1("tkt_no")) & i & "S.bmp"							
