...
<%if (sys_City<>"台南市" and sys_City<>"南投縣") or (sys_City="南投縣" and (trim(Session("Unit_ID"))="05CB" or trim(Session("Unit_ID"))="05FG")) then %>
	<center><font size="3">舉發違反道路交通事件通知單退件(公示已結案)移送清冊</font></center>
	<%
...
<%		'逕舉and攔停
		...
		",f.Rule1,f.Rule2,f.Rule3,f.Rule4,f.BillUnitID,f.BillMem1,f.BillMem2,f.BillTypeID,e.billcloseid" &_
...
%>		
	...
	<td align="center" height="28" colspan="2"><span class="style4"><%
		...
		response.write TitleValue&"&nbsp退件(公示已結案)資料"
