...
fname=year(now)&fMnoth&fDay&"_逕舉點收匯出檔.xls"
...
<table border=0 cellpadding=0 cellspacing=0 width=738 style='border-collapse: collapse;table-layout:fixed;width:554pt'>
 ...
 <tr class=xl6817813 height=34 style='mso-height-source:userset;height:25.5pt'>
  ...
  <td class=xl6617813 width=90 style='border-left:none;width:68pt'>車號</td>
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>車種</td>
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>違反條例</td>
  ...
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>測速</td>
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>限速</td>
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>圖</td>
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>相</td>
  <td class=xl6617813 width=72 style='border-left:none;width:54pt'>資</td>
 </tr>
 <%
 ...
 " where vl_bil_no is null and convert(datetime,created_time) between '" & gOutDT(request("RecordDate1")) & " 00:00:00' and '" & gOutDT(request("RecordDate2")) & " 23:59:59'" & _
 ...
 While not rs.eof
	...
	Response.Write "<td class=xl7117813 style='border-top:none'>"
	Response.Write rs("fact_spd")
	Response.Write "</td>"

	Response.Write "<td class=xl7117813 style='border-top:none'>"
	Response.Write rs("limt_spd")
	Response.Write "</td>"
