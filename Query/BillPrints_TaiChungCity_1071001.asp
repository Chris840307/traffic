...
<div id="Layer42" class="style3" style="position:absolute; left:<%=(280+leftpx)%>px; top:<%=70+toptpx%>px; width:320px; height:36px; z-index:5">
	<%if trim(Sys_BillTypeID)="1" then
...
<div id="Layer45" class="style4" style="position:absolute; left:<%=(40+leftpx)%>px; top:<%=70+toptpx%>px; width:250px; height:36px; z-index:5">
...
<%if trim(Sys_ImageFileNameA)<>"" then%>
<div style="position:absolute; left:30px; top:485px;"><img src="<%=Sys_IisImagePath&Sys_ImageFileNameA%>" width="365" height="265"></DIV>
<%end if%>
<%if trim(Sys_ImageFileNameB)<>"" then%>
<div style="position:absolute; left:395px; top:485px;"><img src="<%=Sys_IisImagePath&Sys_ImageFileNameB%>" width="330" height="240"></DIV>
<%end if%>
...
<div id="Layer145" style="position:absolute; left:400px; top:<%=1270+toptpx-uppx%>px; width:150px; height:11px; z-index:37"><font size=2><%=Sys_CarColor&"&nbsp;&nbsp;&nbsp;"&Sys_A_Name%></font></div>
</div>
<%
