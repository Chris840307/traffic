			...
			<table width="100%" border="1" cellpadding="4" cellspacing="1">
				...
				<%
					while not rsfound.eof 
						...
						response.write "<td width='6%'>" & SetDate(QueryCol("cin_dt","peo_rec","tkt_no=" & QuotedStr(trim(rsfound("tkt_no"))))) & "</td>"

						response.write "<td width='6%'>" & trim(SetDate(QueryCol("out_dt","peo_rec","tkt_no=" & QuotedStr(trim(rsfound("tkt_no")))))) & "</td>"
