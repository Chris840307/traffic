...
<%
	...
	strStReport="select distinct(DCIReturnStation) from (select f.SN,a.BillNo,a.CarNo from DCILog a,MemberData b," &_
		...
		" ,BillBaseDCIReturn e,BillMailHistory g where a.BillNo=e.BillNO and a.SN=g.BillSn and a.CarNo=e.CarNo and e.ExchangeTypeID='W' and e.Status in ('Y','S','n','L') and g.UserMarkResonID in ('1','2','3','4','8','M','K','L','O','P','Q')"
	...
	strStStop="select distinct(f.MemberStation) from DCILog a,MemberData b" &_
		...
		" and a.DCIReturnStatusID=d.DCIReturn(+) and a.RecordMemberID=b.MemberID(+) and a.ReturnMarkType='3' and g.UserMarkResonID in ('1','2','3','4','8','M','K','L','O','P','Q') "&strwhere
