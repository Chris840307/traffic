...
<center><span class="style2">舉發違反道路交通事件通知單攔停舉發移送清冊</span></center>
...
%>
	<table width="100%" border="0" cellpadding="1" cellspacing="0">
		<tr>
			<td align="center"><span class="style2"><%=TitleUnitName%>&nbsp;攔停舉發移送清冊</span></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			if trim(rs1("Driver"))<>"" and not isnull(rs1("Driver")) then
				response.write funcCheckFont(rs1("Driver"),16,1)
			else
				response.write "&nbsp;"
			end if	
			%></span></td>
...
%>
	<table width="100%" border="0" cellpadding="1" cellspacing="0">
		...
		<tr>
			<td align="left"><span class="style3">站所：<%
		response.write "<strong><font class=""style6"">"&DciStationName&"</strong></font>"
	%>&nbsp; &nbsp; &nbsp; &nbsp;移送日期：<%=Right("000"&year(now)-1911,3)&Right("00"&month(now),2)&Right("00"&day(now),2)%>&nbsp; &nbsp; &nbsp;(本批案件已透過中華電信數據分公司作入案管制)&nbsp; &nbsp; &nbsp;Page <%=fix(PrintSN/16)+1%> of <%=pagecnt%></span></td>
		</tr>
	</table>
	<table width="100%" border="<%
...
%>
	<table width="100%" border="0" cellpadding="1" cellspacing="0">
		<tr>
			<td align="center"><span class="style3"><%=TitleUnitName%>&nbsp;攔停舉發移送清冊</span></td>
		</tr>
		<tr>
			<td align="left"><span class="style3">站所：<%
		response.write "<strong><font class=""style6"">"&trim(StationArray(SA))&" "&DciStationName&"</font></strong>"
	%>&nbsp; &nbsp; &nbsp; &nbsp;移送日期：<%=Right("000"&year(now)-1911,3)&Right("00"&month(now),2)&Right("00"&day(now),2)%>&nbsp; &nbsp; &nbsp;(本批案件已透過中華電信數據分公司作入案管制)&nbsp; &nbsp; &nbsp;Page <%=fix(PrintSN/16)+1%> of <%=pagecnt%></span></td>
		</tr>
	</table>
	<table width="100%" border="<%
