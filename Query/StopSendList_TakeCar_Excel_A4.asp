...
<style type="text/css">
<!--
.style2 {font-family:新細明體; color=0044ff; line-height:18px; font-size: 16px}
.style3 {font-family:標楷體; color=0044ff; line-height:14px; font-size: 14px}
.style4 {font-family:標楷體; color=0044ff; line-height:12px; font-size: 12px}
.style5 {font-family:新細明體; color=0044ff; line-height:15px; font-size: 12px}
.style6 {font-family:標楷體; color=0044ff; line-height:16px; font-size: 16px}
-->
</style>
<style media=print>
...
<tr>
	...
	<tr>
		<td colspan=17><span class="style4">=================================================================================================================================================================================</span></td>
		<tr>
			<td width="35" align=left><span class="style3">序號</td>
			<td width="80" align=left><span class="style3">告發單單號</td>
			<td width="35" align=left><span class="style3">車號</td>
			<td width="35" align=left><span class="style3">車別</td>
			<td width="70" align=right><span class="style3">違規日期</td>
			<td width="35" align=center><span class="style3">時間</td>
			<td width="180" align=left><span class="style3">違規地點</td>
			<td width="70" align=left><span class="style3">違規條款</td>
			<td width="35" align=left><span class="style3">入案</td>
			<td width="80" align=left><span class="style3">舉發員警</td>
			<td width="70" align=left><span class="style3">違規金額</td>
			<td width="70" align=left><span class="style3">建檔日期</td>
		<tr>
		<td colspan=17><span class="style4">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</span></td>
		</tr>
	</tr>
