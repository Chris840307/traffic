...
fname=year(now)&fMnoth&fDay&"(基隆)裁罰資料69-84.txt"
...
<%  
	strSQL="select sn,MemberStation,DeallineDate,DriverID,Rule1,BillNO,Illegaldate,BillStatus from passerbase where RecordStateID=0 and recorddate between to_date('"&date1&" 0:0:0"&"','YYYY/MM/DD/HH24/MI/SS') and to_date('"&date2&" 23:59:59"&"','YYYY/MM/DD/HH24/MI/SS')	"
