...
<%		'=======================攔停===============================
	if sys_City="台南市" then
		...
		" or (a.ExchangeTypeID='N' and a.DciReturnStatusID not in ('S','N')))" &_
	...
	elseif sys_City="台中市" then
		...
		" and ((a.ExchangeTypeID='E' and a.DCIReturnStatusID='n')" &_
		" or (a.ExchangeTypeID='W' and a.DCIReturnStatusID in ('S','d','e'))" &_
		" or (a.ExchangeTypeID='N' and a.DCIReturnStatusID='n' and Exists(" &_
		"select Billno from billbaseDciReturn where BillNo=a.BillNo and CarNo=a.CarNo and ExchangeTypeID='N' and billcloseid<>'j'" &_
		")))" &_
		" and a.RecordMemberID=b.MemberID(+) "&strwhere
	elseif sys_City="南投縣" then
		...
		" and ((a.ExchangeTypeID='E' and a.DCIReturnStatusID='n')" &_
		" or (a.ExchangeTypeID='W' and a.DCIReturnStatusID in ('S','d','e'))" &_
		" or (a.ExchangeTypeID='N' and (a.DCIReturnStatusID='n' or a.DCIReturnStatusID='h')))" &_
		" and a.RecordMemberID=b.MemberID(+) "&strwhere
	end if
	...
	if sys_City="台南市" then
		...
		",f.Rule4,f.BillTypeID,f.Driver,f.BillMem1,a.BillUnitID,f.MemberStation,a.ExchangeTypeID,a.DciReturnStatusID,a.FileName" &_
	...
	elseif sys_City="南投縣" Then
		strOrder=" order by f.RecordMemberID,f.RecordDate"
		...
		" or (a.ExchangeTypeID='N' and a.DCIReturnStatusID='n'))" &_
		" and f.Sn=g.BillSn " &_
		" and a.RecordMemberID=b.MemberID(+) "&strwhere & strOrder
	elseif sys_City="台中市" Then
		strOrder=" order by g.UserMarkDate,f.BillNo"
...
%>
	<table width="710" border="0" cellpadding="2" cellspacing="0">
		<tr>
			<td align="center" colspan="2">
				<font size="3"><%=Sys_UnitName%>結案清冊</font>
			</td>
		</tr>
		<tr>
	...
	<table width="710" border="1" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td width="10%" align="center">無效原因<br>代保管物</td>
			<td width="10%" align="center">結案註記<br>到案處所</td>
		</tr>
<%		for i=1 to 20
...
<%		'==========================逕舉=========================
	...
	elseif sys_City="台中市" then
		...
		")))" &_
		" and f.sn=g.billsn " &_
		" and a.RecordMemberID=b.MemberID(+) "&strwhere&" order by g.UserMarkDate,f.BillNo"
	elseif sys_City="南投縣" then
		strSQL="select f.SN,a.BillNO,f.IllegalDate,f.CarNo,f.CarSimpleID,f.Rule1,f.Rule2,f.Rule3" &_
		",f.Rule4,f.BillTypeID,f.Driver,f.BillMem1,a.BillUnitID,f.MemberStation,a.ExchangeTypeID,a.DciReturnStatusID,a.FileName" &_
		",d.StatusContent,a.DCIReturnStatusID from DCILog a,MemberData b,DCIReturnStatus d" &_
