...
if trim(Sys_BillTypeID)="1" then
	...
	DelphiASPObj.GenBillPrintBarCode PBillSN(i),Sys_BillNo,Sys_Rule1,Sys_CarNo,Sys_MailNumber&"95000017","220073",Sys_DriverHomeZip,Sys_DealLineDate(0)&Sys_DealLineDate(1)&Sys_DealLineDate(2),Sys_StationID,"台北市交通事件裁決所",0,Sum_Level,0,True,False,Sys_MailDate
	...
	DelphiASPObj.GenBillPrintBarCode PBillSN(i),Sys_BillNo,Sys_Rule1,Sys_CarNo,Sys_MailNumber&"95000017","220073",Sys_OwnerZip,Sys_DealLineDate(0)&Sys_DealLineDate(1)&Sys_DealLineDate(2),Sys_StationID,"台北市交通事件裁決所",0,Sum_Level,0,True,False,Sys_MailDate
end if
...
<div id="Layer05" class="style3" style="position:absolute; left:420px; top:130px; z-index:1">
	　　　第<%=Sys_MailNumber%>號<br>
...
<div id="Layer05" class="style3" style="position:absolute; left:470px; top:275px; z-index:1"><%
	Response.Write "<img  src=""..\BarCodeImage\"&Sys_BillNo&"_1.jpg"">"%>
</div>

<div id="Layer06" class="style3" style="position:absolute; left:110px; top:309px; z-index:1"><%
	'--------------------------------------如果是抓 戶籍補正的資料-----------------------------------------------------------------------------------------------------------
			if trim(Sys_BillTypeID)="1" then
...
<div id="Layer29" style="position:absolute; left:130px; top:1060px; width:34px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%></div>
