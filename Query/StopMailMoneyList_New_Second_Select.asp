...
%></title>
<%
Sys_SendMarkDate1=Trim(request("Sys_SendMarkDate1"))
Sys_SendMarkDate2=Trim(request("Sys_SendMarkDate2"))
		...
		<table width='100%' border='1' align="left" cellpadding="1">
			...
			<tr>
				<td bgcolor="#EBFBE3" align="center">
					...
					<input type="hidden" name="Sys_SendMarkDate1" value="<%=Sys_SendMarkDate1%>">
					<input type="hidden" name="Sys_SendMarkDate2" value="<%=Sys_SendMarkDate2%>">
				</td>
			</tr>
		</table>		
	</form>
...
function funMailListCity(){
	...
	UrlStr="StopMailReportList_New_Second_TD.asp";
	<%else%>
	UrlStr="StopMailReportList_New_Second.asp";
	<%end if%>
