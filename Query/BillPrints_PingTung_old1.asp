...
<!--<div id="Layer60" style="position:absolute; left:200px; top:50px; width:10px; height:20px; z-index:5">test</div>--><%
if showBarCode then
%>
...
<div style="position:absolute; left:60px; top:85px;">
...
<div id="Layer43" style="position:absolute; left:310px; top:520px; width:200px; height:12px; z-index:36"><%=SysUnit%></div>
<div id="Layer44" style="position:absolute; left:155px; top:540px; width:350px; height:12px; z-index:36"><%
...
<div id="Layer45" style="position:absolute; left:210px; top:575px; width:280px; height:12px; z-index:36"><%=Sys_BillNo%></div>
<div id="Layer46" style="position:absolute; left:300px; top:570px; width:200px; height:32px; z-index:6"><img src=<%="""..\BarCodeImage\"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer47" style="position:absolute; left:65px; top:1005px; width:500px; height:12px; z-index:36"><%=SysAddress%></div>
</div>
<%
