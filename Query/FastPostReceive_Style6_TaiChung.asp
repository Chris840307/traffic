...
<div style="position: absolute; width: 424px; height: 326px; z-index: 9; left: 157px; top: 0px" id="layer14">
	<table border="0" width="100%" id="table1" cellspacing="0" height="100%" cellpadding="0">
		<tr>
			...
			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 130px; top: 200px" id="layer33">
				<font face="標楷體"><%="42047 豐原市中山路225號"%></font></div>
			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 130px; top: 240px" id="layer33">
				<font face="標楷體"><%="台中縣警察局交隊"%></font></div>
			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 130px; top: 260px" id="layer33">
				<font face="標楷體"><%=TEL%>&nbsp;&nbsp;&nbsp;&nbsp;
				<%If Instr(request("Sys_BatchNumber"),"WT")>0 Then 
					response.write "<b>[拖吊已結]</b>"
				  End if%>
				</font></div>
			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 130px; top: 280px" id="layer33">
			...
			<div style="position: absolute; width: 225px; height: 35px; z-index: 6; left: 20px; top: 108px" id="layer30">
				<font face="標楷體"><%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>"" Then
					...
					%>&nbsp;<%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>""   then  
						...
						End if
						%></div>
			<div style="position: absolute; width: 303px; height: 31px; z-index: -1; left: 23px; top: 60px" id="layer31">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../BarCodeImage/<%=Sys_BillNo_BarCode%>.jpg">
</div>



			<div style="position: absolute; width: 130px; height: 17px; z-index: 16; left: 175px; top: 12px" id="layer32">
