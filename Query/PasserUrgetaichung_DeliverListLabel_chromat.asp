...
.style7 {font-family: "標楷體";font-size: 15px}
...
for i=0 to Ubound(strBillSN)
  if trim(strBillSN(i))<>"" then
	 ...
	 %>
	<!--#include virtual="traffic/Query/BillBase_DeliverHLabel_TaiChungCity_chromat.asp"-->
