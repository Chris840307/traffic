...
<div style="position: absolute; width: 424px; height: 326px; z-index: 9; left: 157px; top: 0px" id="layer14">
	<table border="0" width="100%" id="table1" cellspacing="0" height="100%" cellpadding="0">
		<tr>
			<td height="58">
			<div style="position: absolute; width: 344px; height: 20px; z-index: 5; left: 50px; top: 42px" id="layer29">
				<font face="標楷體"><%if Sys_BillTypeID="1"  and trim(Sys_Driver)<>"" then response.write Sys_Driver else response.write Owner%></font></div>



			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 60px; top: 283px" id="layer33">
				<font face="標楷體"><%=UnitName%></font></div>
			　</td>
		</tr>
		<tr>
			<td height="103">
			<div style="position: absolute; width: 225px; height: 35px; z-index: 6; left: 50px; top: 63px" id="layer30">
				<font face="標楷體"><%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>"" Then
					...
					%>&nbsp;<%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>""   then  
						...
						End if
						%></div>
			<div style="position: absolute; width: 303px; height: 31px; z-index: -1; left: 80px; top: 16px" id="layer31">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../BarCodeImage/<%=Sys_BillNo_BarCode%>.jpg">
</div>



			<div style="position: absolute; width: 130px; height: 17px; z-index: 16; left: 209px; top: 0px" id="layer32">
