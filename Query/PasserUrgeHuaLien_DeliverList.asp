...
.style4 {font-family: "@新細明體"; font-size: 12px;}
.style6 {font-family: "@新細明體"; font-size: 16px;}
-->
</style>
...
for i=0 to Ubound(strBillSN)
	...
	<!--#include virtual="traffic/Query/BillBaseHuaLien_Deliver.asp"-->
	</Div><%
Next
%>
<div id=idDiv></div>
...
<script language="javascript">
	...
	window.focus();
	printWindow(true,10.28,4.28,4.28,4.28);
</script>