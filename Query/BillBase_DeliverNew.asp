	...
	<tr><th rowspan=2 valign="bottom" align="center" width="80%">
		...
		<th valign="bottom" align="left" class="style1" nowrap><%
			If sys_City="台南縣" then
				If trim(Sys_LoginID)="A043" or trim(Sys_LoginID)="A139" or trim(Sys_LoginID)="A141" or trim(Sys_LoginID)="A007" Then
  ...
  <tr>
    ...
    <td colspan="3" Valign="top"><span class="style1"><br><%
		If sys_City<>"基隆市" Then 
			response.write funcCheckFont(Sys_Owner,25,1)&"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;車號："&Sys_CarNo
		else
		...
		If not ifnull(Sys_OwnerAddress) Then
			response.write funcCheckFont(replace(Sys_OwnerAddress,Sys_OwnerZipName,""),25,1)
		else
...
<%
if sys_City<>"台南縣" and sys_City<>"基隆市" then
