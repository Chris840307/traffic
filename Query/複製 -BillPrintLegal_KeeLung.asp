...
<div id="Layer2" style="position:absolute; left:250px; top:70px; width:350px; height:36px; z-index:5"><%
	...
	if trim(Sys_BillTypeID)="1" then
		...
		Response.Write Sys_DriverZipName&funcCheckFont(Sys_DriverHomeAddress,20,1)&"<br>"
		Response.Write funcCheckFont(Sys_Driver,20,1)&"　台啟"
	elseif trim(Sys_BillTypeID)="2" then
		Response.Write Sys_OwnerZip&"<br>"
		Response.Write Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,20,1)&"<br>"
		Response.Write funcCheckFont(Sys_Owner,20,1)&"　台啟"
	end if
	Response.Write "</span>"%>
</div>
<div id="Layer3" style="position:absolute; left:320px; top:135px; z-index:5"><%
...
<div id="Layer4" style="position:absolute; left:300px; top:165px; z-index:5"><%
	If trim(Session("UnitLevelID"))="1" Then
		Response.Write "<span class=""style3"">"
...
<div id="Layer5" style="position:absolute; left:60px; top:190px; z-index:5"><%
	Response.Write "<span class=""style3"">"
...
<div id="Layer5" style="position:absolute; left:550px; top:170px; z-index:5"><%
...
<%if trim(Sys_BillTypeID)="1" then%>
	...
	<%end if%>
<%end if%>
<div id="Layer9" style="position:absolute; left:20px; top:430px; width:202px; height:36px; z-index:5"><%
	if showBarCode then
...
%></div>
<div id="Layer10" style="position:absolute; left:500px; top:425px; width:233px; height:32px; z-index:6"><img src=<%="""..\BarCodeImage\"&Sys_BillNo&"_4.jpg"""%>></div>
...
<%end if%>
<div id="Layer18" style="position:absolute; left:125px; top:535px; width:100px; height:14px; z-index:11"><span class="style7"><%=Sys_CarNo%></span></div>
<div id="Layer19" style="position:absolute; left:275px; top:535px; width:117px; height:20px; z-index:12"><span class="style7"><%=Sys_DCIRETURNCARTYPE%></span></div>
<div id="Layer20" style="position:absolute; left:510px; top:535px; width:201px; height:17px; z-index:13"><span class="style3"><%=funcCheckFont(Sys_Owner,22,1)%></span></div>
<div id="Layer21" style="position:absolute; left:125px; top:560px; width:507px; height:13px; z-index:14"><span class="style7"><%=Sys_OwnerZip&" "&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,22,1)%></span></div>

<div id="Layer22" style="position:absolute; left:130px; top:580px; width:40px; height:13px; z-index:15"><span class="style7"><%=Sys_IllegalDate(0)%></span></div>
<div id="Layer23" style="position:absolute; left:170px; top:580px; width:40px; height:17px; z-index:16"><span class="style7"><%=Sys_IllegalDate(1)%></span></div>
<div id="Layer24" style="position:absolute; left:220px; top:580px; width:40px; height:16px; z-index:17"><span class="style7"><%=Sys_IllegalDate(2)%></div>
<div id="Layer25" style="position:absolute; left:265px; top:580px; width:40px; height:16px; z-index:18"><span class="style7"><%=right("00"&Sys_IllegalDate_h,2)%></span></div>
<div id="Layer26" style="position:absolute; left:315px; top:580px; width:40px; height:13px; z-index:19"><span class="style7"><%=right("00"&Sys_IllegalDate_m,2)%></span></div>
<div id="Layer27" style="position:absolute; left:395px; top:590px; width:600px; height:31px; z-index:20"><span class="style3"><%
...
%></span></div>
<div id="Layer28" style="position:absolute; left:125px; top:610px; width:217px; height:15px; z-index:21"><span class="style3"><%=Sys_ILLEGALADDRESS%></span></div>
<div id="Layer29" style="position:absolute; left:140px; top:630px; width:34px; height:11px; z-index:22"><span class="style7"><%=Sys_DealLineDate(0)%></span></div>
<div id="Layer30" style="position:absolute; left:210px; top:630px; width:35px; height:13px; z-index:23"><span class="style7"><%=Sys_DealLineDate(1)%></span></div>
<div id="Layer31" style="position:absolute; left:290px; top:630px; width:32px; height:15px; z-index:24"><span class="style7"><%=Sys_DealLineDate(2)%></span></div>
<div id="Layer32" style="position:absolute; left:395px; top:650px; width:400px; height:49px; z-index:29"><span class="style3"><%response.write "第"&left(trim(Sys_Rule1),2)&"條"
			...
			%></span></div>
<div id="Layer33" style="position:absolute; left:390px; top:675px; width:400px; height:30px; z-index:28"><%
	if showBarCode then	response.write "<img src=""..\BarCodeImage\"&Sys_BillNo&"_5.jpg"">"
%></div>
<div id="Layer34" style="position:absolute; left:635px; top:685px; width:90px; height:30px; z-index:28"><span class="style3"><%=Sys_STATIONNAME%></span></font></div>

<div id="Layer35" style="position:absolute; left:360px; top:745px; width:100px; height:49px; z-index:29"><%
...
'	end if
%></div>
<div id="Layer38" style="position:absolute; left:230px; top:820px; width:60px; height:10px; z-index:32"><span class="style7"><%=sys_Date(0)%></span></div>
<div id="Layer39" style="position:absolute; left:375px; top:820px; width:60px; height:13px; z-index:33"><span class="style7"><%=sys_Date(1)%></span></div>
<div id="Layer40" style="position:absolute; left:525px; top:820px; width:60px; height:11px; z-index:34"><span class="style7"><%=sys_Date(2)%></span></div>
<div id="Layer41" style="position:absolute; left:685px; top:820px; width:80px; height:12px; z-index:36"><span class="style7"><%=Sys_BillFillerMemberID%></span></div>


<div id="Layer45" style="position:absolute; left:180px; top:1010px; width:100px; height:12px; z-index:36"><span class="style3"><%
	Response.Write Sys_BillNo
%></span></div>

<div id="Layer43" style="position:absolute; left:210px; top:1030px; width:350px; height:12px; z-index:36"><span class="style3"><%=Sys_MAILCHKNUMBER%></span></div>

<div id="Layer44" style="position:absolute; left:370px; top:1045px; width:350px; height:12px; z-index:10"><img src=<%="""..\BarCodeImage\"&Sys_BillNo&".jpg"""%>></div>
...
If not ifnull(request("Sys_UnitLabelKind")) Then
	response.write "<font color=""red"">請繳回："&Sys_BillUnitAddress&"　　"&Sys_BillUnitName&"</font>"
End if
%></span></div>
