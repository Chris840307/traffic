...
'	end if
	...
	strSQL="Select a.SignType,a.BillNo,a.Sn,a.CarNo,a.BillTypeID,a.Rule1,a.Rule2,a.Rule3,a.Rule4" &_
		...
		",a.DealLineDate,a.Note,a.CarSimpleID,a.Owner,a.OwnerAddress,a.OwnerZip,a.ImageFileName,a.ImageFileNameB from BillBase a" &_
...
'-----------------------DciLog公示--------------------------------
	...
	if sys_City="花蓮縣" then
		  MailStationReturnDate=""
			strQuery="select ReturnDate from mailstationreturn where billno='"&trim(rs1("BillNo"))&"'"			
