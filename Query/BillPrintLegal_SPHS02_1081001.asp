...
If Sys_BillJobName = "" Then Sys_BillJobName="警員"
...
<div id="Layer41" class="style3" style="position:absolute; left:550px; top:0px; width:200px; height:12px; z-index:36"><%=Sys_MailNumber%></div>

<div id="Layer01" class="style2" style="position:absolute; left:290px; top:15px; z-index:3"><%
...
<div id="Layer02" class="style2" style="position:absolute; left:300px; top:40px; z-index:2"><%
	response.write Sys_BillNo%>
</div>

<div id="Layer03" class="style3" style="position:absolute; left:450px; top:125px; z-index:1"><%
	Response.Write "<img src=""../BarCodeImage/"&Sys_BillNo&"_4.jpg"" height=""40"">"%>
</div>
...
<div id="Layer30" style="position:absolute; left:200px; top:1060px; width:35px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%></div>
<div id="Layer31" style="position:absolute; left:280px; top:1060px; width:32px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%></div>
<div id="Layer32" style="position:absolute; left:405px; top:1075px; width:400px; height:49px; z-index:29"><%
...
<div id="Layer34" style="position:absolute; left:390px; top:1110px; width:400px; height:30px; z-index:28"><%
...
<div id="Layer35" style="position:absolute; left:400px; top:1165px; width:130px; height:49px; z-index:29"><%
	...
	Response.Write "<span class=""style10"">&nbsp;保二總隊第三大隊<br>&nbsp;&nbsp;&nbsp;&nbsp;第二中隊"
...
<div id="Layer37" style="position:absolute; left:600px; top:1195px; width:200px; height:46px; z-index:31"><%
	if trim(Sys_MemberFilename)<>"" then
		...
		Response.Write "<td style=""border-color:#ff0000;border-style:solid;border-width:1px;"" width=""50%"" height=25 align=""center"" nowrap><span class=""style13"">"&Sys_BillJobName&"</span><br><span class=""style13"">"&Sys_ChName&"</span></td>"
