...
.style3 {font-family: "@新細明體"; font-size: 14px; line-height:9pt;}
.style4 {font-family: "@新細明體"; font-size: 11px; letter-spacing:0px;}
.style5 {font-family: "@新細明體"; font-size: 14px;}
-->
</style>
...
for i=0 to Ubound(strBillSN)%>
	<!--#include virtual="traffic/Query/BillBaseKaoHsiung_Deliver.asp"--><%
	if (cint(i+1) mod 2 =0) and i<Ubound(strBillSN) then
		response.write "<div class=""PageNext""></div>"
	elseif i<Ubound(strBillSN) then
