...
<div id="Layer1" style="position:absolute; left:60px; top:10px; z-index:5">
...
<div id="Layer2" style="position:absolute; left:250px; top:10px; width:400px; height:36px; z-index:5"><%
...
<div id="Layer3" style="position:absolute; left:320px; top:90px; z-index:5"><%
...
<div id="Layer4" style="position:absolute; left:300px; top:120px; z-index:5"><%
	Response.Write "<span class=""style3"">"
...
<div id="Layer5" style="position:absolute; left:60px; top:160px; z-index:5"><%
	Response.Write "<span class=""style3"">"
...
<div id="Layer5" style="position:absolute; left:510px; top:110px; z-index:5"><%
	Response.Write "<span class=""style8"">"
	Response.Write "<center><b>更正<br>通知書</b></center>"
	Response.Write "</span>"
%>
</div>
...
<div id="Layer52" style="position:absolute; left:500px; top:1010px; width:100px; height:12px; z-index:36"><span class="style3"><%
	Response.Write "<b>(更正通知書)</b>"
%></span></div>

<div id="Layer43" style="position:absolute; left:210px; top:1025px; width:350px; height:12px; z-index:36"><span class="style3"><%=Sys_MAILCHKNUMBER%></span></div>
