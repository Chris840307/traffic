...
if showBarCode then
%>
	<div id="Layer1" style="position:absolute; left:<%=65+leftpx%>px; top:<%=0+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%else%>
	<div id="Layer2" style="position:absolute; left:<%=65+leftpx%>px; top:<%=30+toppx%>px; width:202px; height:36px; z-index:5">Ｖ</div>
<%end if%>

<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer3" style="position:absolute; left:<%=185+leftpx%>px; top:<%=0+toppx%>px; width:202px; height:36px; z-index:5">v</div>
<%else%>
	<div id="Layer4" style="position:absolute; left:<%=185+leftpx%>px; top:<%=20+toppx%>px; width:202px; height:36px; z-index:5">v</div>
<%end if%>
...
<%end if%>>-->
<div id="Layer9" style="position:absolute; left:<%=50+leftpx%>px; top:<%=60+toppx%>px; width:233px; height:36px; z-index:5"><%
	if showBarCode then
...
%></div>
<div id="Layer10" style="position:absolute; left:<%=520+leftpx%>px; top:<%=60+toppx%>px; width:233px; height:32px; z-index:6"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_4.jpg"""%>></div>
<div id="Layer11" style="position:absolute; left:<%=520+leftpx%>px; top:<%=100+toppx%>px; width:230px; height:12px; z-index:7"><font size=1>　<%=BillPageUnit%>交字第　　　　　　　　　　　號</font></div>
<div id="Layer12" style="position:absolute; left:<%=130+leftpx%>px; top:<%=130+toppx%>px; width:150px; height:11px; z-index:3"><font size=2><%
		response.write "逕行舉發　"&Sys_A_Name&"<br>"
		response.write "附採證照片"
		response.write "　"&Sys_CarColor
%></font></div>
<div id="Layer14" style="position:absolute; left:<%=400+leftpx%>px; top:<%=125+toppx%>px; width:324px; height:10px; z-index:4"><font size=2><%if showBarCode then response.write "*本單可至郵局或委託代收之超商繳納"%></font></div>
<div id="Layer17" style="position:absolute; left:<%=650+leftpx%>px; top:<%=140+toppx%>px; width:99px; height:12px; z-index:10"><%=fastring%></div>
<div id="Layer18" style="position:absolute; left:<%=135+leftpx%>px; top:<%=185+toppx%>px; width:100px; height:14px; z-index:11"><%=Sys_CarNo%></div>
<div id="Layer19" style="position:absolute; left:<%=330+leftpx%>px; top:<%=185+toppx%>px; width:117px; height:20px; z-index:12"><%=Sys_DCIRETURNCARTYPE%></div>
<div id="Layer20" style="position:absolute; left:<%=570+leftpx%>px; top:<%=185+toppx%>px; width:150px; height:17px; z-index:13"><%=funcCheckFont(Sys_Owner,22,1)%></div>
...
<div id="Layer22" style="position:absolute; left:<%=135+leftpx%>px; top:<%=240+toppx%>px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer23" style="position:absolute; left:<%=175+leftpx%>px; top:<%=240+toppx%>px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer24" style="position:absolute; left:<%=215+leftpx%>px; top:<%=240+toppx%>px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer25" style="position:absolute; left:<%=255+leftpx%>px; top:<%=240+toppx%>px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer26" style="position:absolute; left:<%=295+leftpx%>px; top:<%=240+toppx%>px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
<div id="Layer27" style="position:absolute; left:<%=460+leftpx%>px; top:<%=245+toppx%>px; width:280px; height:31px; z-index:20"><%
	...
	if trim(Sys_Rule2)<>"" and Sys_Rule2<>0 then
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer28" style="position:absolute; left:<%=135+leftpx%>px; top:<%=260+toppx%>px; width:500px; height:15px; z-index:21"><%=Sys_ILLEGALADDRESS%></div>
<div id="Layer29" style="position:absolute; left:<%=135+leftpx%>px; top:<%=285+toppx%>px; width:40px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer30" style="position:absolute; left:<%=175+leftpx%>px; top:<%=285+toppx%>px; width:40px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer31" style="position:absolute; left:<%=215+leftpx%>px; top:<%=285+toppx%>px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
<div id="Layer32" style="position:absolute; left:<%=525+leftpx%>px; top:<%=330+toppx%>px; width:400px; height:49px; z-index:29"><%
...
<div id="Layer34" style="position:absolute; left:<%=445+leftpx%>px; top:<%=370+toppx%>px; width:70px; height:30px; z-index:28"><font size=2><%=Sys_STATIONNAME%></font></div>

<div id="Layer33" style="position:absolute; left:<%=510+leftpx%>px; top:<%=360+toppx%>px; width:400px; height:30px; z-index:20"><%
	if showBarCode then	response.write "<img src=""../BarCodeImage/"&Sys_BillNo&"_5.jpg"">"
%></div>

<div id="Layer35" style="position:absolute; font-size:16px; left:<%=415+leftpx%>px; top:<%=370+toppx%>px; width:150px; height:49px; z-index:29"><%%></div>
<div id="Layer36" style="position:absolute; font-size:16px; left:<%=660+leftpx%>px; top:<%=450+toppx%>px; width:160px; height:43px; z-index:30"><%

%></div>
<div id="Layer37" style="position:absolute; font-size:10px; left:<%=670+leftpx%>px; top:<%=425+toppx%>px; width:200px; height:46px; z-index:31"><%
...
<%if trim(Sys_BillTypeID)="1" then%>
	<div id="Layer44" style="position:absolute; left:<%=185+leftpx%>px; top:<%=510+toppx%>px; width:202px; height:36px; z-index:5">v</div>
<%else%>
...
<div id="Layer52" style="position:absolute; left:<%=520+leftpx%>px; top:<%=605+toppx%>px; width:230px; height:12px; z-index:7"><font size=1>　<%=BillPageUnit%>交字第　　　　　　　　　　　號</font></div>
<div id="Layer53" style="position:absolute; left:<%=130+leftpx%>px; top:<%=635+toppx%>px; width:150px; height:11px; z-index:3"><font size=2><%
		response.write "逕行舉發　"&Sys_A_Name&"<br>"
		response.write "附採證照片"
		response.write "　"&Sys_CarColor
%></font></div>
<div id="Layer55" style="position:absolute; left:<%=400+leftpx%>px; top:<%=635+toppx%>px; width:324px; height:10px; z-index:4"><font size=2><%if showBarCode then response.write "*本單可至郵局或委託代收之超商繳納"%></font></div>

<div id="Layer58" style="position:absolute; left:<%=650+leftpx%>px; top:<%=615+toppx%>px; width:99px; height:12px; z-index:10"><%=fastring%></div>
...
<div id="Layer62" style="position:absolute; left:<%=210+leftpx%>px; top:<%=725+toppx%>px; width:507px; height:13px; z-index:14"><%=Sys_OwnerZip&" "&funcCheckFont(Sys_OwnerZipName&Sys_OwnerAddress,22,1)%></div>

<div id="Layer63" style="position:absolute; left:<%=135+leftpx%>px; top:<%=750+toppx%>px; width:40px; height:13px; z-index:15"><%=Sys_IllegalDate(0)%>年</div>
<div id="Layer64" style="position:absolute; left:<%=175+leftpx%>px; top:<%=750+toppx%>px; width:40px; height:17px; z-index:16"><%=Sys_IllegalDate(1)%>月</div>
<div id="Layer65" style="position:absolute; left:<%=215+leftpx%>px; top:<%=750+toppx%>px; width:40px; height:16px; z-index:17"><%=Sys_IllegalDate(2)%>日</div>
<div id="Layer66" style="position:absolute; left:<%=255+leftpx%>px; top:<%=750+toppx%>px; width:40px; height:16px; z-index:18"><%=right("00"&Sys_IllegalDate_h,2)%>時</div>
<div id="Layer67" style="position:absolute; left:<%=295+leftpx%>px; top:<%=750+toppx%>px; width:40px; height:13px; z-index:19"><%=right("00"&Sys_IllegalDate_m,2)%>分</div>
...
'	if trim(Sys_Note)<>"" then response.write "<br>("&Sys_Note&")"
	response.write "</font>"
%></div>
<div id="Layer69" style="position:absolute; left:<%=135+leftpx%>px; top:<%=770+toppx%>px; width:500px; height:15px; z-index:21"><%
response.write Sys_ILLEGALADDRESS%></div>
<div id="Layer70" style="position:absolute; left:<%=135+leftpx%>px; top:<%=795+toppx%>px; width:40px; height:11px; z-index:22"><%=Sys_DealLineDate(0)%>年</div>
<div id="Layer71" style="position:absolute; left:<%=175+leftpx%>px; top:<%=795+toppx%>px; width:40px; height:13px; z-index:23"><%=Sys_DealLineDate(1)%>月</div>
<div id="Layer72" style="position:absolute; left:<%=215+leftpx%>px; top:<%=795+toppx%>px; width:50px; height:15px; z-index:24"><%=Sys_DealLineDate(2)%>日前</div>
...
<div id="Layer75" style="position:absolute; left:<%=445+leftpx%>px; top:<%=875+toppx%>px; width:70px; z-index:28"><font size=2><%=Sys_STATIONNAME%></font></div>

<div id="Layer74" style="position:absolute; left:<%=510+leftpx%>px; top:<%=870+toppx%>px; width:400px;  z-index:20"><img src=<%="""../BarCodeImage/"&Sys_BillNo&"_5.jpg"""%>></div>
<div id="Layer76" style="position:absolute; font-size:16px; left:<%=410+leftpx%>px; top:<%=950+toppx%>px; width:150px; height:49px; z-index:29"></div>
<div id="Layer77" style="position:absolute; font-size:10px; left:<%=670+leftpx%>px; top:<%=930+toppx%>px; width:200px; height:46px; z-index:31"><%
	if billprintuseimage=1 then
		if trim(Sys_MemberFilename)<>"" then
			response.write "<img src=""../Member/Picture/"&Sys_MemberFilename&""" width=""90"" height=""30"">"
		end if
	...
	If not ifnull(Sys_BillFillerMemberID2) Then response.write " / "&Sys_BillFillerMemberID2
%></div>
<div id="Layer82" style="position:absolute; font-size:16px; left:<%=625+leftpx%>px; top:950px; width:160px; height:43px; z-index:30"><%
%></div>
<div id="Layer78" style="position:absolute; left:<%=110+leftpx%>px; top:<%=975+toppx%>px; width:60px; height:10px; z-index:32"><%=sys_Date(0)%>年</div>
<div id="Layer79" style="position:absolute; left:<%=160+leftpx%>px; top:<%=975+toppx%>px; width:60px; height:13px; z-index:33"><%=sys_Date(1)%>月</div>
<div id="Layer80" style="position:absolute; left:<%=200+leftpx%>px; top:<%=975+toppx%>px; width:60px; height:11px; z-index:34"><%=sys_Date(2)%>日</div>
<div id="Layer81" style="position:absolute; left:<%=250+leftpx%>px; top:<%=975+toppx%>px; width:120px; height:12px; z-index:36">填單</div>
</div>
<%
