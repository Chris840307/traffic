...
　</td>
		...
		<tr>
			...
			<div style="position: absolute; width: 225px; height: 35px; z-index: 6; left: 73px; top: 89px" id="layer30">
				<font face="標楷體"><%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>"" then response.write DriverHomeZip else response.write OwnerZip  %>&nbsp;<%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>""   then  response.write Sys_DriverHomeAddress else response.write GetMailAddress %></font></div>
...
%> 
<div style="position: absolute; width: 225px; height: 35px; z-index: 7; left: 250px; top: 140px" id="layer30">
