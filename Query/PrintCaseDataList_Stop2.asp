...
RecordDate=split(gInitDT(date),"-")
	if trim(request("CallType"))="1" then
		strwhere=" and a.papercheck=0 and a.BillStatus in ('0') and a.RecordStateID=0 and a.RecordMemberID="&session("User_ID")
	else
