...
<div id="Layer1" class="style4" style="position:absolute; left:60px; top:110px; z-index:1"><%=funcCheckFont(Sys_Address,25,1)%></div>
...
<div id="Layer10" class="style2" style="position:absolute; left:80px; top:770px; z-index:1"><%
	...
	response.write "　　&nbsp;&nbsp;"
	DelphiASPObj.CreateBarCode right(Sys_DealLineDate(0),2)&Sys_DeallIneDate(1)&Sys_DeallIneDate(2)&"241",0,35,160
	response.write "<img src=""../BarCodeImage/"&right(Sys_DealLineDate(0),2)&Sys_DeallIneDate(1)&Sys_DeallIneDate(2)&"241.jpg"">"
...
<div id="Layer15" class="style3" style="position:absolute; left:130px; top:980px; z-index:1"><%
	...
	response.write funcCheckFont(Sys_Address,25,1)
%>
</div>
