...
If Sys_UnitLevelID=1 Then
	strSQL="select UnitName,UnitID,Tel,ManageMemberName,ManageMemberName,SecondManagerName,BankAccount from UnitInfo where UnitName like '%交通隊' and (UnitTypeID='"&Sys_UnitID&"' or UnitTYpeID='"&Sys_UnitTypeID&"' or UnitID='"&Sys_UnitID&"'or UnitID='"&Sys_UnitTypeID&"')"
else
	strSQL="select UnitName,UnitID,Tel,ManageMemberName,ManageMemberName,SecondManagerName,BankAccount from UnitInfo where UnitName like '%分局' and (UnitTypeID='"&Sys_UnitID&"' or UnitTYpeID='"&Sys_UnitTypeID&"' or UnitID='"&Sys_UnitID&"'or UnitID='"&Sys_UnitTypeID&"')"
end if
'strSQL="select * from UnitInfo where UnitLevelID=1 and UnitName like '%交通隊'"
set rsUnit=conn.Execute(strSQL)
...
strSQL="select * from UnitInfo where UnitName like '%交通隊' and UnitLevelID=1"
...
<table width="100%" border="0">
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
				...
				<tr>
					...
					<td colspan="5">
						...
						義務人經限期履行而逾期能不履行之證明文件及送達證明文件<br>
	...
	<tr align="center">
		<td bgcolor="#FFDD77">
			<input name="btnadd" type="button" value="移送書套印" onclick="funAdd();"> 
...
set rsfound=conn.execute(strSql)%>
	<tr>
		...
		<td><input name="Sys_OpenGovNumber" class="btn1" type="text" size="8" maxlength="12" value="<%=rsfound("BillNo")%>"></td>
		<td align="right" nowrap bgcolor="#FFFF99">移送案號</td>
		<td><input name="Sys_SendNumber" value="<%=rsfound("BillNo")%>" class="btn1" type="text" size="8" maxlength="12"></td>
...
<input type="Hidden" name="PBillSN" value="<%=Sys_SendBillSN%>">
