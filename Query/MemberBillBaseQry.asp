		...
		<td bgcolor="#CCCCCC">
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
				...
				<%End If %>
						...
						<input type="button" name="btnSelt" value="查詢" onclick="funSelt();" <% 'if CheckPermission(234,1)=false then	response.write "disabled" end if %>>
						<input type="button" name="cancel" value="清除" onClick="location='MemberBillBaseQry.asp'">
