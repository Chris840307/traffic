...
<%
	...
	strToDCI="select a.Sn,a.CarNo,a.IllegalDate,a.Rule1,a.Rule2,e.Owner from BillBase a,MemberData b,BillBaseDCIReturn e where a.RecordStateID<>-1 and a.RecordMemberID=b.MemberID(+) and a.CarNo=e.CarNo and e.ExchangeTypeID='A' and e.Status='S' "&tmpSQL&" order by a.RecordDate"
