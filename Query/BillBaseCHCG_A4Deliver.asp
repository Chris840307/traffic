...
<table width="645" border="0" cellspacing=0 cellpadding=0>
	<tr><th rowspan=2 valign="bottom" align="center" width="80%">
			<strong><span class="style4"><%=thenPasserCity&sysunit%>送達證書</span></strong>
		</th>
		<th valign="bottom" align="left" class="style1">
			郵寄日期：
		</th>
	</tr>
	<tr><th valign="bottom" align="left" class="style1">
			序　　號：
		</th>
	</tr>
</table>
<table width="645" border="1" cellspacing=0 cellpadding=0>
  <tr>
    ...
    <td colspan="3" height="80" Valign="top"><span class="style1"><br><%
		response.write funcCheckFont(Sys_Owner,20,1)&"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;車號：＊＊"&mid(Sys_CarNo,3)
		response.write "<br>"&Sys_OwnerZip&"&nbsp;&nbsp;"&Sys_OwnerZipName&funcCheckFont(Sys_OwnerAddress,20,1)%>&nbsp;</span></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><span class="style2">文　　　　　　　　　號</span></td>
    <td colspan="3"><span class="style2"><%=theBillNumber%>交字第<img src=<%="""../BarCodeImage/"&Sys_BillNo&".jpg"""%>>號</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td rowspan="2" width="20%" align="center"><span class="style2">送達人簽章<br><br></span></td>
  </tr>
  <tr>
    <td colspan="2">
		<table border=0>
  ...
  <tr>
    ...
    <td rowspan="2">&nbsp;</td>
    <td colspan="2"><span class="style3">送達時間（由送達人填記）</span></td>
  ...
  <tr>
    <td colspan="5" align="center">
		<span class="style1">由　　　送　　　人　　　在　　　□　　　上　　　劃　　　選　　　記</span>
	</td>
  </tr>
  <tr>
    <td colspan="2">
  ...
  <tr>
    <td colspan="2">
		<table border=0>
			<tr><td valign="top">□</td>
			<td><span class="style3">應受送達之本人、同居人、受雇人或應受送達處所接收郵件人員無正當理由拒絕領經送達人
				將文書留置於送達處所，以為送達</span></td>
			</tr>
		</table>
	</td>
    <td colspan="3">
...
<span class="style1"><strong>※請繳回<%=thenPasserCity&Sys_UnitName%>　 　操作人員：<%=Sys_BillFillerMemberID%><br>本證書送回地址：<%=Sys_UnitAddress%></strong>
<br>寄存送達之文書，應保存3個月，如未經領取，請退還交送達機關。
</span>