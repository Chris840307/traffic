...
<div id="Layer1" class="style7" style="position:absolute; left:60px; top:<%=250+toppx%>px; width:400px; z-index:1"><% Response.Write "寄件人：臺東縣警察局交通隊"%></div>

<div id="Layer2" class="style7" style="position:absolute; left:60px; top:<%=270+toppx%>px; z-index:1">收件人：<%=funcCheckFont(Sys_Owner,20,1)%></div>

<div id="Layer1" class="style7" style="position:absolute; left:60px; top:<%=290+toppx%>px; width:400px; z-index:1">地址：<%=funcCheckFont(Sys_Address,20,1)%></div>

<div id="Layer13" class="style3" style="position:absolute; left:200px; top:<%=350+toppx%>px; z-index:1"><%
...
<div id="Layer8" class="style4" style="position:absolute; left:50px; top:<%=1075+toppx%>px; z-index:1"><B><%
	response.write "共計催繳："&Cntsum&"筆，停車費："&ForFeitSum&"元、郵資雙掛號費43元，總金額："&(ForFeitSum+43)&"元"
%></B>
</div>
