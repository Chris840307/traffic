...
%></div>
<div id="Layer36" style="position:absolute; left:580px; top:1205px; width:140px; height:43px; z-index:30"><%
	If Sys_UnitID="0807" Then
		response.write "<table style=""border-bottom:0; border-top:0 ;border-left:0 ; border-right:0 ;border-color:#ff0000;border-style:solid;"" border=""0"" cellspacing=0 cellpadding=0 width=""140"">"

		response.write "<tr><td style=""border-color:#ff0000;border-style:solid;border-width:1px;"" align=""center"" width=""50%"" height=25><span class=""style13"">組長</span><br><span class=""style13"">黃禮文</span></td>"
	...
	End if
%></div>
<div id="Layer37" style="position:absolute; left:580px; top:1165px; width:200px; height:46px; z-index:31"><%
	if trim(Sys_MemberFilename)<>"" then
		...
		If not ifnull(Sys_BillMemName2) Then
			Response.Write "<td style=""border-color:#ff0000;border-style:solid;border-width:1px;"" width=""50%"" height=25 align=""center"" nowrap><span class=""style13"">"&Sys_BillJobName2&"</span><br><span class=""style13"">"&Sys_BillMemName2&"</span></td>"
		End if	
