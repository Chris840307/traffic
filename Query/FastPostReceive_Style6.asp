...
'--------------------------------------------------------------------------------------------------------------------
'登入者、單位地址
	strUNit="select UnitName,Address,TEL from UnitInfo where UnitID='"&Session("Unit_ID")&"'"
...
<div style="position: absolute; width: 424px; height: 326px; z-index: 9; left: 157px; top: 0px" id="layer14">
	<table border="0" width="100%" id="table1" cellspacing="0" height="100%" cellpadding="0">
		<tr>
			<td height="58">
			<div style="position: absolute; width: 344px; height: 20px; z-index: 5; left: 20px; top: 147px" id="layer29">
				<font face="標楷體"><%if Sys_BillTypeID="1"  and trim(Sys_Driver)<>"" then response.write Sys_Driver else response.write Owner%></font></div>



			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 128px; top: 200px" id="layer33">
				<font face="標楷體"><%="407 臺中市西屯區文心路二段五八八號"%></font></div>
			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 128px; top: 240px" id="layer33">
				<font face="標楷體"><%="臺中市政府警察局交通警察大隊"%></font></div>
			<div style="position: absolute; width: 228px; height: 17px; z-index: 6; left: 128px; top: 260px" id="layer33">
				<font face="標楷體"><%=TEL%>&nbsp;&nbsp;&nbsp;&nbsp;
				<%If Instr(request("Sys_BatchNumber"),"WT")>0 Then 
					response.write "<b>[拖吊已結]</b>"
				  End if%>
				</font></div>
			<div style="position: absolute; width: 310px; height: 17px; z-index: 6; left: 128px; top: 280px" id="layer33">
				<font face="標楷體"><%=UnitName%>
				<% 

				If sys_City="台中市" Then
					response.write "<br>本回執請退臺中市政府警察局交通警察大隊"
				End If
				%>
				</font></div>
			　</td>
		...
		<tr>
			<td height="103">
			<div style="position: absolute; width: 225px; height: 35px; z-index: 6; left: 20px; top: 108px" id="layer30">
				<font face="標楷體"><%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>"" Then
					...
					%>&nbsp;<%if Sys_BillTypeID="1"  and trim(Sys_DriverHomeAddress)<>""   then  
						...
						End if
						%></div>
			<div style="position: absolute; width: 303px; height: 31px; z-index: -1; left: 13px; top: 60px" id="layer31">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../BarCodeImage/<%=Sys_BillNo_BarCode%>.jpg">
		...
		<tr>
			...
			<div style="position: absolute; width: 130px; height: 17px; z-index: 16; left: 10px; top: 5px" id="layer32">
...
printWindow(true,5,5.08,5.08,0);
</script></p>