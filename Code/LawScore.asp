      ...
      <tr>
        <td><span class="style3">      法條代碼
          ...
          <select name="CarSimpleID">
		   <option value=""></option>
            <option value="1">自用汽車</option>
            <option value="2">營業車</option>
            <option value="3">機車</option>
            <option value="4">汽車</option>
            <option value="5">小型車</option>
            <option value="6">大型車</option>
            <option value="7">大客車</option>
            <option value="8">營大客</option>
			<%
...
<input name="Level4" type="text" value="<%=Request("Level4")%>" size="6" maxlength="5"  class="btn1"> 
          ...
          <select name="Target">
			...
			%>               
            <option value="V" <%=iselect1%>>車主</option>
            <option value="0" <%=iselect2%>>駕駛人</option>
            </select>
          版本
<%
...
%>
          <select name="version" id="version">
            ...
            <%if not iadoRS.eof then
            	...
            	%>
              <option value='<%=iadoRS("Version")%>' <%=iselected%>><%=iadoRS("Version")%></option>
  ...
  <tr>
    <td height="25" bgcolor="#E0E0E0"><table width="100%" height="100%" border="0" cellpadding="4" cellspacing="1">
      <tr bgcolor="#EBFBE3">
        ...
        <th width="5%" nowrap><span class="style3">攔停配分</span></th>
        <th width="4%" nowrap><span class="style3">逕舉配分</span></th>
